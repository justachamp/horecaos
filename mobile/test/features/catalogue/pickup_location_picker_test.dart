...
import 'package:horecaos_mobile/src/features/catalogue/data/pickup_location_repository.dart';
import 'package:horecaos_mobile/src/features/catalogue/pickup_location_controller.dart';
import 'package:horecaos_mobile/src/features/catalogue/ui/pickup_location_picker.dart';
...
void main() {
  ...
  testWidgets('shows the nearest branch and opens it on tap', (
    ...
    expect(find.text('HorecaOS Cafe — Central kitchen'), findsOneWidget);
