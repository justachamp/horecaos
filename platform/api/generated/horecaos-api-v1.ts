...
export interface Operations {
  ...
  "unbindCourierFromBranch": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/couriers/{courierId}/branch-bindings/{locationId}/removal"; request: { parameters: { path: { courierId: string; locationId: string; tenantId: string } }; body: CourierRosterReasonRequest }; responses: { "200": unknown } };
