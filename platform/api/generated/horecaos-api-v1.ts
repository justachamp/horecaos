...
export interface Operations {
  ...
  "acceptOperations": { method: "POST"; path: "/api/v1/operations/auth/password-resets/accept"; request: { parameters: Record<string, never>; body: PasswordResetAcceptRequest }; responses: { "200": unknown } };
