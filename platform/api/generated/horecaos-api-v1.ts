...
export interface AbcCurveListResponse {
  abcThresholdAPercent?: number;
  abcThresholdBPercent?: number;
  maybeMore?: boolean;
  provenance?: ProvenanceResponse;
  rows?: Array<AbcCurveRowResponse>;
}
...
export interface AccessCheckResponse {
  ...
  verdict?: "ALLOWED" | "INSUFFICIENT_CAPABILITY" | "ENTITLEMENT_REQUIRED";
}
...
export interface AggregatorOrderLineRequest {
...
export interface AggregatorOrderRequest {
  ...
  feeMinor?: number;
  lines: Array<AggregatorOrderLineRequest>;
...
export interface ArchiveCourierTypeRequest {
  reason: string;
}
...
export interface AttributionLinkResponse {
  channel?: string;
  clickCount?: number;
  createdAt?: string;
  createdBy?: string;
...
export interface BoardResponse {
  counts?: KitchenBoardControllerCountsResponse;
...
export interface BoundaryChangeResponse {
  approvalRequestId?: string;
  status?: string;
}
...
export interface BulkAddByFilterResponse {
  added?: number;
}

export interface BulkAutoMatchRequest {
  bindingId: string;
  entityType: "PRODUCT" | "PAYMENT_TYPE" | "DISCOUNT" | "COURIER" | "CANCELLATION_REASON" | "CHANNEL_POS_CODE" | "VARIANT" | "MODIFIER";
}

export interface BulkAutoMatchResponse {
  conflicts?: Array<MappingConflictView>;
  detail?: string;
  matchedCount?: number;
  sourced?: boolean;
}
...
export interface BulkAvailabilityResponse {
  appliedCount?: number;
  failedCount?: number;
  items?: Array<BulkAvailabilityOutcome>;
  requestedCount?: number;
}
...
export interface BulkClassifyOutcomeResponse {
  nodeId?: string;
  nodeType?: "VARIANT" | "MODIFIER_OPTION" | "FEE";
  status?: string;
}
...
export interface BulkClassifyResponse {
  outcomes?: Array<BulkClassifyOutcomeResponse>;
}
...
export interface BulkServiceStateItemResponse {
  applied?: boolean;
  locationId?: string;
  problemCode?: string;
}
...
export interface BulkServiceStateResponse {
  appliedCount?: number;
  failedCount?: number;
  items?: Array<BulkServiceStateItemResponse>;
  requestedCount?: number;
}
...
export interface CalendarResponse {
  ...
  holidays?: Array<HolidayResponse>;
  recutCompletedThrough?: string;
  timezone?: string;
...
export interface CatalogImportRowResponse {
  errorReason?: string;
  outcome?: string;
  productId?: string;
  rowNumber?: number;
...
export interface CatalogImportSubmitResponse {
  rowsTotal?: number;
  runId?: string;
  status?: string;
}
...
export interface ChannelSetupControllerPresentationView {
...
export interface ChannelView {
  ...
  code?: string;
  displayName?: string;
  enabledFulfillmentModes?: Array<string>;
...
export interface ClassificationRowResponse {
  abcClass?: string;
  categoryId?: string;
  coefficientOfVariationBasisPoints?: number;
  cumulativeShareBasisPoints?: number;
  meanQuantityPerBucket?: number;
  productName?: string;
  quantityTotal?: number;
  revenueGrossSom?: number;
  revenueShareBasisPoints?: number;
  stddevQuantityPerBucket?: number;
  variantId?: string;
  xyzClass?: string;
}
...
export interface ClassificationRunResponse {
  abcThresholdABasisPoints?: number;
  abcThresholdBBasisPoints?: number;
  bucketCount?: number;
  bucketDays?: number;
  computedAt?: string;
  from?: string;
  ...
  metricCode?: string;
  provenance?: ProvenanceResponse;
  rows?: Array<ClassificationRowResponse>;
  runId?: string;
  to?: string;
  xyzThresholdXBasisPoints?: number;
  xyzThresholdYBasisPoints?: number;
}
...
export interface ConsentTypeResponse {
  active?: boolean;
...
export interface CourierBroadcastResponse {
  broadcastId?: string;
  channel?: string;
  createdAt?: string;
  createdBy?: string;
...
export interface CourierPolicyResponse {
  ...
  gpsAcceptRadiusMeters?: number;
  gpsStatusChangeRadiusMeters?: number;
  gpsVerificationEnabled?: boolean;
  graceSeconds?: number;
  kitchenReadyOnly?: boolean;
  penaltyApprovalThresholdMinor?: number;
  policyId?: string;
  policyVersion?: number;
  postDeliveryPaymentCheckRequired?: boolean;
  revealCustomerLocationTiming?: string;
...
export interface CourierPolicyWriteRequest {
  cashCeilingMinor?: number;
  confirmationPointRetentionDays?: number;
  gpsAcceptRadiusMeters?: number;
  gpsStatusChangeRadiusMeters?: number;
...
export interface CreateTemplateRequest {
  ...
  channelSource?: "WEB" | "IOS" | "ANDROID" | "TELEGRAM" | "KIOSK" | "QR_TABLE" | "CALL_CENTRE" | "AGGREGATOR" | "POS";
  consentPurpose?: string;
  fulfillmentMode?: "DELIVERY" | "PICKUP" | "DINE_IN";
...
export interface CustomerControllerCreateCustomerRequest {
  brandId: string;
  displayName?: string;
  phone: string;
}
...
export interface DecidedApprovalResponse {
  actionCode?: string;
  decidedAt?: string;
  decidedBy?: string;
  id?: string;
...
export interface DeleteStationCapacityRequest {
  expectedVersion: number;
}
...
export interface DescribeLocationRequest {
  ...
  landmark?: string;
  latitude?: number;
  locales?: Array<LocationLocaleRequest>;
  longitude?: number;
  seats?: number;
  sortOrder?: number;
...
export interface DistanceBucketSetResponse {
  buckets?: Array<DistanceBucketDefinitionResponse>;
  version?: number;
}

export interface DistanceBucketsResponse {
  buckets?: Array<DistanceBucketResponse>;
  provenance?: ProvenanceResponse;
}
...
export interface ExternalCourierRequest {
  bindingId: string;
  decision?: "ACCEPT" | "ABANDON";
  quoteId?: string;
  reasonCode?: string;
...
export interface HolidayAddedResponse {
  holidayId?: string;
}
...
export interface ItemSaleScheduleRequest {
  windows: Array<ItemSaleWindowRequest>;
}

export interface ItemSaleScheduleResponse {
  windows?: Array<ItemSaleWindowResponse>;
}

export interface ItemSaleWindowRequest {
  closesAt: string;
  dayOfWeek?: number;
  opensAt: string;
}

export interface ItemSaleWindowResponse {
  closesAt?: string;
  dayOfWeek?: number;
  opensAt?: string;
}
...
export interface KitchenBoardControllerCountsResponse {
  aggregator?: number;
  delivery?: number;
  dineIn?: number;
  pickup?: number;
...
export interface LocalizedNamesRequest {
  byLocale: { [key: string]: string };
}

export interface LocationChannelsResponse {
  channelCodes?: Array<string>;
  locationId?: string;
}
...
export interface LocationLegalEntityResponse {
...
export interface LocationView {
  ...
  landmark?: string;
  latitude?: number;
  locales?: Array<LocationLocaleView>;
  longitude?: number;
  seats?: number;
  slug?: string;
  sortOrder?: number;
...
export interface MappingConflictView {
  externalIds?: Array<string>;
  horecaosEntityIds?: Array<string>;
  name?: string;
}

export interface MappingCreated {
  mappingId?: string;
  status?: string;
}

export interface MappingRetired {
  mappingId?: string;
  status?: string;
}
...
export interface OperationsCustomerControllerCreateCustomerRequest {
  displayName?: string;
  phone: string;
}
...
export interface OperationsMarketingControllerRescheduleRequest {
  scheduledAt: string;
}
...
export interface PageApplyItemView {
  items?: Array<ApplyItemView>;
  nextCursor?: string;
}
...
export interface PageDecidedApprovalResponse {
  items?: Array<DecidedApprovalResponse>;
  nextCursor?: string;
}
...
export interface PageMappingView {
  items?: Array<MappingView>;
  nextCursor?: string;
}
...
export interface PageRunSummaryView {
  items?: Array<RunSummaryView>;
  nextCursor?: string;
}
...
export interface PageVersionSummaryView {
  id?: string;
...
export interface RecipientCountsResponse {
  ...
  queued?: number;
  refused?: number;
  refusedByReason?: { [key: string]: number };
  total?: number;
}
...
export interface RecommendationListResponse {
  items?: Array<RecommendationResponse>;
}
...
export interface RetireMappingRequest {
  expectedVersion: number;
}
...
export interface RotatePartnerClientRequest {
  reason: string;
}
...
export interface RotatedClientResponse {
  id?: string;
  secretExpiresAt?: string;
  secretValue?: string;
  version?: number;
...
export interface SetWeekendRequest {
  reason: string;
  weekendDays: Array<number>;
}
...
export interface StopInAllBranchesResponse {
...
export interface TenantErasureRequestResponse {
  cancelledAt?: string;
  cancelledByActorId?: string;
  completedAt?: string;
  completedByActorId?: string;
...
export interface VariableCatalogueEntry {
  notificationClass?: string;
  variables?: Array<VariableCatalogueVariable>;
}

export interface VariableCatalogueVariable {
  description?: string;
  name?: string;
}
...
export interface WordingResponse {
  ...
  locale?: string;
  providerReview?: string;
  providerReviewNote?: string;
  providerReviewReference?: string;
  providerReviewUpdatedAt?: string;
  status?: string;
  subject?: string;
  variablesSchema?: { [key: string]: string };
  versionNumber?: number;
...
export interface Operations {
  ...
  "list_46": { method: "GET"; path: "/api/v1/control-plane/capabilities"; request: { parameters: Record<string, never> }; responses: { "200": Array<CapabilityDescriptor> } };
  ...
  "list_45": { method: "GET"; path: "/api/v1/control-plane/event-contracts"; request: { parameters: Record<string, never> }; responses: { "200": Array<EventContractResponse> } };
  ...
  "list_33": { method: "GET"; path: "/api/v1/control-plane/grants"; request: { parameters: Record<string, never> }; responses: { "200": Array<PlatformGrantView> } };
  ...
  "list_44": { method: "GET"; path: "/api/v1/control-plane/incidents"; request: { parameters: { query: { includeResolved?: boolean; limit?: number } } }; responses: { "200": Array<IncidentView> } };
  ...
  "inboxFailures_1": { method: "GET"; path: "/api/v1/control-plane/integration/failures/inbox/{consumerName}"; request: { parameters: { path: { consumerName: string }; query: { limit?: number; status?: string; tenantId?: string } } }; responses: { "200": PageFailureSummary } };
  ...
  "list_43": { method: "GET"; path: "/api/v1/control-plane/onboarding-templates"; request: { parameters: Record<string, never> }; responses: { "200": Array<TemplateView> } };
  ...
  "list_42": { method: "GET"; path: "/api/v1/control-plane/template-reviews"; request: { parameters: { query: { limit?: number; state?: string } } }; responses: { "200": Array<TemplateReviewView> } };
  ...
  "list_32": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/approval-policies"; request: { parameters: { path: { tenantId: string }; query: { actionCode?: string; includeEnded?: boolean; limit?: number } } }; responses: { "200": PagePolicyResponse } };
  ...
  "search_1": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/audit-events"; request: { parameters: { path: { tenantId: string }; query: { actionCode?: string; actorSubject?: string; auditClass?: string; correlationId?: string; cursor?: string; from?: string; limit?: number; outcome?: string; scopeId?: string; scopeType?: string; targetId?: string; to?: string } } }; responses: { "200": PageAuditEventView } };
  "detail_7": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/audit-events/{eventId}"; request: { parameters: { path: { eventId: string; tenantId: string } } }; responses: { "200": AuditEventDetail } };
  ...
  "mxikReference": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/fiscal-reference/mxik"; request: { parameters: { path: { brandId: string; tenantId: string }; query: { limit?: number; query?: string } } }; responses: { "200": PageMxikReferenceRow } };
  "history_1": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/imports"; request: { parameters: { path: { brandId: string; tenantId: string }; query: { limit?: number } } }; responses: { "200": Array<CatalogImportStatusResponse> } };
  "submit_3": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/imports"; request: { parameters: { path: { brandId: string; tenantId: string }; query: { dryRun?: boolean } }; body: CatalogImportSubmitRequest }; responses: { "200": CatalogImportSubmitResponse } };
  "template": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/imports/template"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": string } };
  "templateWorkbook": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/imports/template.xlsx"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": string } };
  "status_2": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/imports/{runId}"; request: { parameters: { path: { brandId: string; runId: string; tenantId: string } } }; responses: { "200": CatalogImportStatusResponse } };
  "rows_1": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/imports/{runId}/rows"; request: { parameters: { path: { brandId: string; runId: string; tenantId: string }; query: { limit?: number; offset?: number } } }; responses: { "200": Array<CatalogImportRowResponse> } };
  ...
  "list_31": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/menus"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": Array<MenuResponse> } };
  "create_18": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/menus"; request: { parameters: { path: { brandId: string; tenantId: string } }; body: CreateMenuRequest }; responses: { "200": MenuResponse } };
  ...
  "update_8": { method: "PUT"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/menus/{menuId}"; request: { parameters: { path: { brandId: string; menuId: string; tenantId: string } }; body: UpdateMenuRequest }; responses: { "200": MenuResponse } };
  ...
  "removeItem": { method: "DELETE"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/menus/{menuId}/items/{variantId}"; request: { parameters: { path: { brandId: string; menuId: string; tenantId: string; variantId: string } } }; responses: { "200": unknown } };
  "addItem": { method: "PUT"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/menus/{menuId}/items/{variantId}"; request: { parameters: { path: { brandId: string; menuId: string; tenantId: string; variantId: string } }; body: MenuItemRequest }; responses: { "200": unknown } };
  ...
  "detachRecommendation": { method: "DELETE"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/products/{productId}/recommendations/{variantId}"; request: { parameters: { path: { brandId: string; productId: string; tenantId: string; variantId: string } } }; responses: { "200": unknown } };
  "setProductStatus": { method: "PUT"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/products/{productId}/status"; request: { parameters: { path: { brandId: string; productId: string; tenantId: string } }; body: ProductStatusRequest }; responses: { "200": unknown } };
  ...
  "history_4": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/catalog/publications"; request: { parameters: { path: { brandId: string; tenantId: string }; query: { limit?: number } } }; responses: { "200": Array<PublicationHistoryResponse> } };
  ...
  "list_41": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/conversations/flows"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": Array<FlowDocumentResponse> } };
  ...
  "list_30": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/delivery-tariffs"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": Array<TariffSummaryResponse> } };
  "create_17": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/delivery-tariffs"; request: { parameters: { path: { brandId: string; tenantId: string } }; body: CreateTariffRequest }; responses: { "200": TariffView } };
  ...
  "activate_13": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/delivery-tariffs/{tariffId}/versions/{version}/activate"; request: { parameters: { path: { brandId: string; tariffId: string; tenantId: string; version: number } }; body: ActorRequest }; responses: { "200": DeliveryTariffControllerVersionView } };
  ...
  "create_16": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/pricing/price-books"; request: { parameters: { path: { brandId: string; tenantId: string } }; body: CreatePriceBookRequest }; responses: { "200": PriceBookResponse } };
  ...
  "activate_12": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/pricing/price-books/{priceBookId}/activation"; request: { parameters: { path: { brandId: string; priceBookId: string; tenantId: string } } }; responses: { "200": PriceBookResponse } };
  ...
  "list_29": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/products/{productId}/comment-presets"; request: { parameters: { path: { brandId: string; productId: string; tenantId: string } } }; responses: { "200": Array<ProductPresetResponse> } };
  ...
  "list_28": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/service-schedules"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": Array<ScheduleSummaryResponse> } };
  "create_15": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/service-schedules"; request: { parameters: { path: { brandId: string; tenantId: string } }; body: CreateScheduleRequest }; responses: { "200": ScheduleView } };
  ...
  "list_27": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/service-zones"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": Array<ZoneSummaryResponse> } };
  "create_14": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/service-zones"; request: { parameters: { path: { brandId: string; tenantId: string } }; body: CreateZoneRequest }; responses: { "200": ZoneView } };
  ...
  "activate_11": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/brands/{brandId}/service-zones/{zoneId}/versions/{version}/activate"; request: { parameters: { path: { brandId: string; tenantId: string; version: number; zoneId: string } }; body: ActivateRequest }; responses: { "200": ServiceZoneControllerVersionView } };
  ...
  "list_26": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/comment-presets"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": Array<PresetResponse> } };
  "create_13": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/comment-presets"; request: { parameters: { path: { tenantId: string } }; body: NewPresetRequest }; responses: { "200": PresetResponse } };
  "update_7": { method: "PUT"; path: "/api/v1/control-plane/tenants/{tenantId}/comment-presets/{presetId}"; request: { parameters: { path: { presetId: string; tenantId: string } }; body: UpdatePresetRequest }; responses: { "200": PresetResponse } };
  ...
  "list_25": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/grants"; request: { parameters: { path: { tenantId: string }; query: { includeInactive?: boolean } } }; responses: { "200": Array<GrantView> } };
  ...
  "list_24": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": PageInstallationView } };
  ...
  "write_1": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/secrets"; request: { parameters: { path: { tenantId: string } }; body: SecretIngressRequest }; responses: { "200": SecretIngressResponse } };
  "bindings_1": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/bindings"; request: { parameters: { path: { installationId: string; tenantId: string } } }; responses: { "200": Array<BindingView> } };
  "bind_4": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/bindings"; request: { parameters: { path: { installationId: string; tenantId: string } }; body: BindRequest }; responses: { "200": {  } } };
  "activateBinding_1": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/bindings/{bindingId}/activate"; request: { parameters: { path: { bindingId: string; installationId: string; tenantId: string } }; body: ProviderInstallationControllerReasonRequest }; responses: { "200": {  } } };
  "suspendBinding_1": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/bindings/{bindingId}/suspend"; request: { parameters: { path: { bindingId: string; installationId: string; tenantId: string } }; body: ProviderInstallationControllerReasonRequest }; responses: { "200": {  } } };
  "capabilityCatalogue_1": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/capability-catalogue"; request: { parameters: { path: { installationId: string; tenantId: string } } }; responses: { "200": CapabilityCatalogueView } };
  "reconcileCapabilities_2": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/capability-reconciliation"; request: { parameters: { path: { installationId: string; tenantId: string } } }; responses: { "200": Reconciliation } };
  "rotateSecret_2": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/secret-rotations"; request: { parameters: { path: { installationId: string; tenantId: string } }; body: RotateSecretRequest }; responses: { "200": RotateSecretResponse } };
  "rotateSecretByValue_1": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/integrations/{installationId}/secret-rotations/value"; request: { parameters: { path: { installationId: string; tenantId: string } }; body: RotateSecretValueRequest }; responses: { "200": RotateSecretResponse } };
  ...
  "list_23": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/legal-entities"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": Array<LegalEntityView> } };
  ...
  "update_6": { method: "PUT"; path: "/api/v1/control-plane/tenants/{tenantId}/legal-entities/{entityId}"; request: { parameters: { path: { entityId: string; tenantId: string }; query: { expectedVersion: number } }; body: UpdateLegalEntityRequest }; responses: { "200": LegalEntityView } };
  "activate_10": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/legal-entities/{entityId}/activate"; request: { parameters: { path: { entityId: string; tenantId: string }; query: { expectedVersion: number } } }; responses: { "200": LegalEntityView } };
  ...
  "activate_9": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/onboarding-runs/{runId}/activate"; request: { parameters: { path: { runId: string; tenantId: string } }; body: OnboardingControllerReasonRequest }; responses: { "200": ActivationOutcome } };
  ...
  "list_22": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/order-outcome-reasons"; request: { parameters: { path: { tenantId: string }; query: { activeOnly?: boolean; kind: "CANCELLATION" | "COMPLETION" } } }; responses: { "200": Array<ReasonResponse> } };
  "create_12": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/order-outcome-reasons"; request: { parameters: { path: { tenantId: string } }; body: OrderOutcomeReasonControllerReasonRequest }; responses: { "200": OrderOutcomeReasonControllerIdResponse } };
  ...
  "reorder_1": { method: "PUT"; path: "/api/v1/control-plane/tenants/{tenantId}/order-outcome-reasons/reorder"; request: { parameters: { path: { tenantId: string } }; body: ReorderRequest }; responses: { "200": Array<ReasonResponse> } };
  ...
  "list_21": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/pos-mappings"; request: { parameters: { path: { tenantId: string }; query: { bindingId: string; cursor?: string; entityType: "PRODUCT" | "PAYMENT_TYPE" | "DISCOUNT" | "COURIER" | "CANCELLATION_REASON" | "CHANNEL_POS_CODE" | "VARIANT" | "MODIFIER"; limit?: number; status?: string } } }; responses: { "200": PageMappingView } };
  "create_11": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/pos-mappings"; request: { parameters: { path: { tenantId: string } }; body: CreateMappingRequest }; responses: { "200": MappingCreated } };
  ...
  "runDetail": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/pos-sync-runs/{runId}"; request: { parameters: { path: { runId: string; tenantId: string } } }; responses: { "200": RunDetailView } };
  ...
  "applyItems": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/pos-sync-runs/{runId}/apply-items"; request: { parameters: { path: { runId: string; tenantId: string }; query: { limit?: number; offset?: number } } }; responses: { "200": PageApplyItemView } };
  ...
  "list_20": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/sales-channels"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": Array<ChannelView> } };
  "create_10": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/sales-channels"; request: { parameters: { path: { tenantId: string } }; body: CreateChannelRequest }; responses: { "200": ChannelView } };
  "update_4": { method: "PUT"; path: "/api/v1/control-plane/tenants/{tenantId}/sales-channels/{channelId}"; request: { parameters: { path: { channelId: string; tenantId: string }; query: { expectedVersion: number } }; body: UpdateChannelRequest }; responses: { "200": ChannelView } };
  ...
  "deactivate_1": { method: "POST"; path: "/api/v1/control-plane/tenants/{tenantId}/sales-channels/{channelId}/deactivate"; request: { parameters: { path: { channelId: string; tenantId: string }; query: { expectedVersion: number } } }; responses: { "200": ChannelView } };
  ...
  "list_40": { method: "GET"; path: "/api/v1/control-plane/tenants/{tenantId}/statements"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": Array<StatementView> } };
  ...
  "list_37": { method: "GET"; path: "/api/v1/operations/tenants/{tenantId}/brands"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": Array<BrandView> } };
  ...
  "list_39": { method: "GET"; path: "/api/v1/operations/tenants/{tenantId}/brands/{brandId}/conversations"; request: { parameters: { path: { brandId: string; tenantId: string }; query: { limit?: number } } }; responses: { "200": Array<ConversationSummaryResponse> } };
  ...
  "bulkChangeServiceState": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/brands/{brandId}/locations/service-states"; request: { parameters: { path: { brandId: string; tenantId: string } }; body: BulkServiceStateRequest }; responses: { "200": BulkServiceStateResponse } };
  ...
  "current_3": { method: "GET"; path: "/api/v1/operations/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/voice/screen-pop/current"; request: { parameters: { path: { brandId: string; locationId: string; tenantId: string } } }; responses: { "200": CardResponse } };
  ...
  "list_38": { method: "GET"; path: "/api/v1/operations/tenants/{tenantId}/brands/{brandId}/reviews"; request: { parameters: { path: { brandId: string; tenantId: string }; query: { cursor?: string; customerAccountId?: string; limit?: number; locationId?: string; maxRating?: number; minRating?: number; submittedFrom?: string; submittedTo?: string } } }; responses: { "200": PageOperationsReviewControllerReviewResponse } };
  ...
  "activate_6": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/brands/{brandId}/service-zones/{zoneId}/versions/{version}/activate"; request: { parameters: { path: { brandId: string; tenantId: string; version: number; zoneId: string } } }; responses: { "200": ServiceZoneControllerVersionView } };
  ...
  "suspend_4": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/courier-engagements/{engagementId}/suspend"; request: { parameters: { path: { engagementId: string; tenantId: string } }; body: SuspendRequest }; responses: { "200": unknown } };
  ...
  "writeCourierPolicy": { method: "PUT"; path: "/api/v1/operations/tenants/{tenantId}/courier-policy"; request: { parameters: { path: { tenantId: string }; query: { brandId?: string; locationId?: string } }; body: CourierPolicyWriteRequest }; responses: { "200": CourierPolicyResponse } };
  ...
  "draftRosterEntry": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/courier-roster-entries"; request: { parameters: { path: { tenantId: string }; query: { brandId: string; locationId: string } }; body: DraftRosterEntryRequest }; responses: { "200": PlannedShiftResponse } };
  ...
  "cancelRosterEntry": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/courier-roster-entries/{entryId}/cancel"; request: { parameters: { path: { entryId: string; tenantId: string }; query: { brandId: string; locationId: string } }; body: RosterEntryReasonRequest }; responses: { "200": unknown } };
  "publishRosterEntry": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/courier-roster-entries/{entryId}/publish"; request: { parameters: { path: { entryId: string; tenantId: string }; query: { brandId: string; locationId: string } }; body: RosterEntryReasonRequest }; responses: { "200": unknown } };
  ...
  "types": { method: "GET"; path: "/api/v1/operations/tenants/{tenantId}/courier-types"; request: { parameters: { path: { tenantId: string }; query: { includeArchived?: boolean } } }; responses: { "200": Array<CourierTypeResponse> } };
  ...
  "history_2": { method: "GET"; path: "/api/v1/operations/tenants/{tenantId}/customers/{customerAccountId}/discount-history"; request: { parameters: { path: { customerAccountId: string; tenantId: string } } }; responses: { "200": CustomerDiscountHistoryResponse } };
  ...
  "bind_1": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/integrations/{installationId}/bindings"; request: { parameters: { path: { installationId: string; tenantId: string } }; body: BindRequest }; responses: { "200": {  } } };
  ...
  "update_3": { method: "PUT"; path: "/api/v1/operations/tenants/{tenantId}/legal-entities/{entityId}"; request: { parameters: { path: { entityId: string; tenantId: string }; query: { expectedVersion: number } }; body: UpdateLegalEntityRequest }; responses: { "200": LegalEntityView } };
  "activate_5": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/legal-entities/{entityId}/activate"; request: { parameters: { path: { entityId: string; tenantId: string }; query: { expectedVersion: number } } }; responses: { "200": LegalEntityView } };
  "archive_5": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/legal-entities/{entityId}/archive"; request: { parameters: { path: { entityId: string; tenantId: string }; query: { expectedVersion: number } } }; responses: { "200": LegalEntityView } };
  ...
  "suspend_3": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/legal-entities/{entityId}/suspend"; request: { parameters: { path: { entityId: string; tenantId: string }; query: { expectedVersion: number } } }; responses: { "200": LegalEntityView } };
  ...
  "activate_4": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/merchant-bindings/{bindingId}/activate"; request: { parameters: { path: { bindingId: string; tenantId: string }; query: { expectedVersion: number } } }; responses: { "200": MerchantBindingView } };
  ...
  "reorder": { method: "PUT"; path: "/api/v1/operations/tenants/{tenantId}/order-outcome-reasons/reorder"; request: { parameters: { path: { tenantId: string } }; body: ReorderRequest }; responses: { "200": Array<ReasonResponse> } };
  ...
  "push_2": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/orders/{orderId}/pos-export/push"; request: { parameters: { path: { orderId: string; tenantId: string } }; body: OrderPosExportControllerPushRequest }; responses: { "200": PushResultResponse } };
  ...
  "update_1": { method: "PUT"; path: "/api/v1/operations/tenants/{tenantId}/payment-methods/{methodId}"; request: { parameters: { path: { methodId: string; tenantId: string }; query: { expectedVersion: number } }; body: UpdatePaymentMethodRequest }; responses: { "200": PaymentMethodView } };
  "activate_3": { method: "POST"; path: "/api/v1/operations/tenants/{tenantId}/payment-methods/{methodId}/activate"; request: { parameters: { path: { methodId: string; tenantId: string }; query: { expectedVersion: number } } }; responses: { "200": PaymentMethodView } };
  ...
  "activate_2": { method: "POST"; path: "/api/v1/platform-admin/commercial/modules/{moduleId}/activation"; request: { parameters: { path: { moduleId: string } }; body: CommercialModuleControllerReasonRequest }; responses: { "200": unknown } };
  ...
  "issue_2": { method: "POST"; path: "/api/v1/platform-admin/commercial/tenants/{tenantId}/statements"; request: { parameters: { path: { tenantId: string } }; body: StatementIssueRequest }; responses: { "200": StatementIssued } };
  ...
  "list_7": { method: "GET"; path: "/api/v1/platform-admin/migration/programs"; request: { parameters: { query: { cursor?: string; limit?: number } } }; responses: { "200": PageProgramView } };
  "create_3": { method: "POST"; path: "/api/v1/platform-admin/migration/programs"; request: { parameters: Record<string, never>; body: CreateProgramRequest }; responses: { "200": ProgramView } };
  ...
  "quote_1": { method: "POST"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/delivery-fee"; request: { parameters: { path: { brandId: string; locationId: string; tenantId: string } }; body: DeliveryFeeQuoteRequest }; responses: { "200": DeliveryFeeView } };
  ...
  "updateAddress_1": { method: "PUT"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/me/addresses/{addressId}"; request: { parameters: { path: { addressId: string; brandId: string; tenantId: string } }; body: SaveAddressRequest }; responses: { "200": StorefrontCustomerControllerAddressResponse } };
  ...
  "requestErasure_1": { method: "POST"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/me/erasure-request"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": StorefrontCustomerControllerErasureRequestResponse } };
  ...
  "listOrders_2": { method: "GET"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/orders"; request: { parameters: { path: { brandId: string; tenantId: string }; query: { cursor?: string; limit?: number } } }; responses: { "200": PageStorefrontOrderingControllerOrderSummaryResponse } };
  ...
  "reorderPlan_2": { method: "GET"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/orders/{orderId}/reorder"; request: { parameters: { path: { brandId: string; orderId: string; tenantId: string } } }; responses: { "200": ReorderPlanResponse } };
  "submit_2": { method: "POST"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/orders/{orderId}/review"; request: { parameters: { path: { brandId: string; orderId: string; tenantId: string } }; body: SubmitReviewRequest }; responses: { "200": StorefrontReviewControllerReviewResponse } };
  ...
  "status_1": { method: "GET"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/telegram/link"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": CustomerTelegramLinkStatusResponse } };
  ...
  "poll_1": { method: "GET"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/telegram/sign-in-codes/{code}"; request: { parameters: { path: { brandId: string; code: string; tenantId: string } } }; responses: { "200": SignInPollResponse } };
  ...
  "accept_1": { method: "POST"; path: "/api/v1/storefront/tenants/{tenantId}/brands/{brandId}/terms/accept"; request: { parameters: { path: { brandId: string; tenantId: string } }; body: AcceptRequest }; responses: { "200": AcceptResponse } };
  ...
  "presentation_1": { method: "GET"; path: "/api/v1/storefront/tenants/{tenantId}/channels/{channel}/presentation"; request: { parameters: { path: { channel: string; tenantId: string } } }; responses: { "200": StorefrontChannelSetupControllerPresentationView } };
  ...
  "create_2": { method: "POST"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/customers"; request: { parameters: { path: { brandId: string; locationId: string; tenantId: string } }; body: OperationsCustomerControllerCreateCustomerRequest }; responses: { "200": CustomerControllerIdResponse } };
  ...
  "moveTable": { method: "PUT"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/dine-in/tables/{tableId}"; request: { parameters: { path: { brandId: string; locationId: string; tableId: string; tenantId: string } }; body: TableLayoutRequest }; responses: { "200": TableResponse } };
  ...
  "list_36": { method: "GET"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/kitchen/devices"; request: { parameters: { path: { brandId: string; locationId: string; tenantId: string } } }; responses: { "200": Array<DeviceResponse> } };
  ...
  "list_6": { method: "GET"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/kitchen/stations"; request: { parameters: { path: { brandId: string; locationId: string; tenantId: string } } }; responses: { "200": Array<StationResponse> } };
  ...
  "open_4": { method: "GET"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/operations/streams"; request: { parameters: { header: { "Last-Event-Id"?: string }; path: { brandId: string; locationId: string; tenantId: string }; query: { channels: Array<string>; scope?: string } } }; responses: { "200": SseEmitter } };
  ...
  "confirmAmendment": { method: "POST"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/orders/{orderId}/amendments/{amendmentId}/confirmation"; request: { parameters: { path: { amendmentId: string; brandId: string; locationId: string; orderId: string; tenantId: string } }; body: ConfirmAmendmentRequest }; responses: { "200": AmendmentResponse } };
  ...
  "list_4": { method: "GET"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/locations/{locationId}/reservations"; request: { parameters: { path: { brandId: string; locationId: string; tenantId: string }; query: { from: string; to: string } } }; responses: { "200": Array<ReservationResponse> } };
  ...
  "list_3": { method: "GET"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/marketing/attribution-links"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": Array<AttributionLinkResponse> } };
  ...
  "archive_2": { method: "POST"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/marketing/attribution-links/{linkId}/archives"; request: { parameters: { path: { brandId: string; linkId: string; tenantId: string } } }; responses: { "200": unknown } };
  ...
  "reschedule_1": { method: "POST"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/marketing/campaigns/{campaignId}/reschedules"; request: { parameters: { path: { brandId: string; campaignId: string; tenantId: string } }; body: OperationsMarketingControllerRescheduleRequest }; responses: { "200": unknown } };
  ...
  "bindings_2": { method: "GET"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/notification-routing/bindings"; request: { parameters: { path: { brandId: string; tenantId: string } } }; responses: { "200": Array<BindingResponse> } };
  ...
  "unbind_1": { method: "POST"; path: "/api/v1/tenants/{tenantId}/brands/{brandId}/notification-routing/bindings/{bindingId}/unbind"; request: { parameters: { path: { bindingId: string; brandId: string; tenantId: string } } }; responses: { "200": unknown } };
  ...
  "setWeekend": { method: "PUT"; path: "/api/v1/tenants/{tenantId}/business-calendar/weekend"; request: { parameters: { path: { tenantId: string } }; body: SetWeekendRequest }; responses: { "200": unknown } };
  "tenantArrears": { method: "GET"; path: "/api/v1/tenants/{tenantId}/commercial/arrears"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": TenantArrearsView } };
  ...
  "list_35": { method: "GET"; path: "/api/v1/tenants/{tenantId}/consent-types"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": Array<ConsentTypeResponse> } };
  ...
  "profile_1": { method: "GET"; path: "/api/v1/tenants/{tenantId}/customers/{accountId}"; request: { parameters: { path: { accountId: string; tenantId: string } } }; responses: { "200": CustomerProfileResponse } };
  ...
  "list_34": { method: "GET"; path: "/api/v1/tenants/{tenantId}/customers/{accountId}/notification-preferences"; request: { parameters: { path: { accountId: string; tenantId: string } } }; responses: { "200": Array<PreferenceResponse> } };
  ...
  "abcCurve": { method: "GET"; path: "/api/v1/tenants/{tenantId}/reporting/abc-curve"; request: { parameters: { path: { tenantId: string }; query: { from: string; limit?: number; locationId?: Array<string>; to: string } } }; responses: { "200": AbcCurveListResponse } };
  ...
  "deliveryDistance": { method: "GET"; path: "/api/v1/tenants/{tenantId}/reporting/delivery-distance"; request: { parameters: { path: { tenantId: string }; query: { from: string; locationId?: Array<string>; to: string } } }; responses: { "200": DistanceResponse } };
  ...
  "distanceBucketSet": { method: "GET"; path: "/api/v1/tenants/{tenantId}/reporting/distance-bucket-set"; request: { parameters: { path: { tenantId: string } } }; responses: { "200": DistanceBucketSetResponse } };
  "distanceBuckets": { method: "GET"; path: "/api/v1/tenants/{tenantId}/reporting/distance-buckets"; request: { parameters: { path: { tenantId: string }; query: { from: string; locationId?: Array<string>; to: string } } }; responses: { "200": DistanceBucketsResponse } };
