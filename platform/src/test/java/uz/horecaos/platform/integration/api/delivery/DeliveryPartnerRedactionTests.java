...
class DeliveryPartnerRedactionTests {
    ...
    private static final Pickup PICKUP =
            new Pickup(41.311081, 69.240562, "Tashkent, Navoi 7", "Branch manager", "+998712001122", "back door");

    private static final Dropoff DROPOFF =
            new Dropoff(41.299496, 69.269873, ADDRESS, "Dilnoza K.", PHONE, "call on arrival", "2", "5", "34");

    @Test
    @DisplayName("a provider call never prints its credential")
    void aProviderCallRedactsItsCredential() {
        ProviderCall call = new ProviderCall("https://partner.example/api", CREDENTIAL, "cmd-1", Duration.ofSeconds(5));
