...
class LegacyDeliveryParityTests {
    ...
    void theDistanceDiscountOffByOneIsCorrected() {
        ...
        long horecaosDiscount = discountAt(tariff, 9_000, noon());

        // The legacy discounts the bare fare. HorecaOS discounts the fare plus the
        ...
        assertThat(horecaosDiscount).isEqualTo(15_000L);
        assertThat(horecaosDiscount).isGreaterThan(legacyDiscount);
    ...
    void theInclusiveReachIsPreserved() {
        ...
        // served. HorecaOS's reach is half-open to match its bands, so it imports as
    ...
    void theClosingSecondKeepsItsLegacyAnswer() {
        ...
        // peak. HorecaOS's windows are half-open, so the import widens the close by a
