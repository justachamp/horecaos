...
class PaymentAndQuietHoursNotificationTests {
    ...
    private void activateTemplate(
        ...
        int versionNumber =
                templates.addVersion(tenantId, brandId(tenantId), templateId, wordings, Map.of("reasonCode", "string"));
        ...
        templates.activate(tenantId, brandId(tenantId), templateId, versionNumber, "copy-approver");
    }
