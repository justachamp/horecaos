...
class CloposQueryTests {
    ...
    void theEncodedFormNeedsNobodysGoodwill() {
        ...
        assertThat(URI.create("https://example.test/products?filters[0][0]=type").getRawQuery())
                .isEqualTo("filters[0][0]=type");

        String query = CloposQuery.create().filterIn(0, "type", List.of("GOODS")).render();
    ...
    void theRecoveryReadsDateRange() {
        String query = CloposQuery.create().dateRange("2026-08-23", "2026-08-23").render();
