    ...
    public static CheckoutService create(
        ...
        return new CheckoutService(
                ...
                new CheckoutEligibilityGuard(
                        carts, cartService, channels, serviceability, migrationOwnership, payments, settlements, quotes,
                        catalog),
                new CheckoutReservationStep(inventory, capacity, quotes),
                new CheckoutOrderWriter(
                        orders, acceptancePolicies, tenancy, catalog, cartService, protection, objectMapper, payments,
                        events),
