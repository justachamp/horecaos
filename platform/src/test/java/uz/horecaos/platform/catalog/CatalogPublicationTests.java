...
import uz.horecaos.platform.catalog.api.FiscalVatRate;
...
class CatalogPublicationTests {
    ...
    void categoryMembershipReachesTheStorefront() {
        ...
        var soup = authoring.createProduct(
                TENANT, BRAND, catalogId, "SHURPA", "Shurpa", null, LOCALE, "SKU-SHURPA", "PIECE", UNCLASSIFIED, ACTOR);
        ...
        assertThat(menu.categories()).singleElement().satisfies(category -> {
            ...
            assertThat(category.productIds()).containsExactly(soup.productId(), plov.productId());
        });
    }
    ...
    void categoryMembershipFollowsTheOffering() {
        ...
        authoring.setOffering(
                TENANT, BRAND, LOCATION, plov.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
        authoring.setOffering(
                TENANT, BRAND, LOCATION, salad.defaultVariantId(), OfferingStatus.HIDDEN, List.of("DELIVERY"));
        ...
        assertThat(menu.categories())
                .singleElement()
                .satisfies(category -> assertThat(category.productIds()).containsExactly(plov.productId()));
    ...
    void modifierGroupsReachTheProductThatOffersThem() {
        ...
        var plov = authoring.createProduct(
                TENANT, BRAND, catalogId, "PLOV", "Osh", null, LOCALE, "SKU-PLOV", "PIECE", UNCLASSIFIED, ACTOR);
        var tea = authoring.createProduct(
                TENANT, BRAND, catalogId, "TEA", "Choy", null, LOCALE, "SKU-TEA", "PIECE", UNCLASSIFIED, ACTOR);

        UUID extras =
                authoring.createModifierGroup(TENANT, BRAND, "EXTRAS", "Qo'shimchalar", LOCALE, false, 0, 2, true);
        authoring.addModifierOption(TENANT, BRAND, extras, "KAZY", "Qazi", LOCALE, null, 3, 1, UNCLASSIFIED, ACTOR);
        authoring.attachModifierGroup(TENANT, BRAND, plov.productId(), extras, 1);

        authoring.setOffering(
                TENANT, BRAND, LOCATION, plov.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
        authoring.setOffering(
                TENANT, BRAND, LOCATION, tea.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
    ...
    void unverifiedMediaBlocksPublication() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-4", "PIECE", UNCLASSIFIED, ACTOR);
    ...
    void crossTenantMediaReferenceIsRefusedByTheDatabase() {
        ...
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-9", "PIECE", UNCLASSIFIED, ACTOR);
        ...
        assertThat(catchThrowable(() -> authoring.attachMedia(
                        TENANT,
                        BRAND,
                        uz.horecaos.platform.catalog.domain.CatalogEntities.EntityType.PRODUCT,
                        burger.productId(),
    ...
    void unsatisfiableModifierGroupBlocksPublication() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-5", "PIECE", UNCLASSIFIED, ACTOR);
        ...
        UUID group = authoring.createModifierGroup(TENANT, BRAND, "SAUCES", "Sauces", LOCALE, true, 2, 3, false);
        authoring.addModifierOption(
                TENANT, BRAND, group, "KETCHUP", "Ketchup", LOCALE, null, 1, 0, UNCLASSIFIED, ACTOR);
    ...
    void locationOfferingsFilterTheMenu() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-6", "PIECE", UNCLASSIFIED, ACTOR);
        var pizza = authoring.createProduct(
                TENANT, BRAND, catalogId, "PIZZA", "Pizza", null, LOCALE, "SKU-7", "PIECE", UNCLASSIFIED, ACTOR);

        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
        authoring.setOffering(
                TENANT, BRAND, LOCATION, pizza.defaultVariantId(), OfferingStatus.UNAVAILABLE, List.of("DELIVERY"));
    ...
    void offeringChangesDoNotNeedARepublish() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-8", "PIECE", UNCLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
        var published = publication.publish(TENANT, BRAND, catalogId, "STOREFRONT", null);

        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.UNAVAILABLE, List.of("DELIVERY"));
    ...
    void republishingRetiresThePrevious() {
        ...
        assertThat(storefront
                        .menuFor(TENANT, BRAND, LOCATION, LOCALE, CHANNEL)
                        .orElseThrow()
                        .publicationId())
    ...
    void contentHashIsStableForUnchangedContent() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-10", "PIECE", UNCLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
    ...
    void contentHashIgnoresMapIterationOrder() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-13", "PIECE", UNCLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
        ...
        var reordered = items.stream()
                .map(item -> new uz.horecaos.platform.catalog.domain.CatalogEntities.PublicationItem(
                        item.entityType(), item.entityId(), item.entityVersion(), reverseKeyOrder(item.content())))
                .toList();
    ...
    void absentValuesAreOmittedFromThePublishedSnapshot() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "NOSKU", "No SKU", null, LOCALE, null, "PIECE", UNCLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
    ...
    void rollbackUsesThePublicationsChannel() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-14", "PIECE", UNCLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
    ...
    private static java.util.Map<String, Object> reverseKeyOrder(java.util.Map<String, Object> content) {
        ...
        content.keySet().stream().sorted(java.util.Comparator.reverseOrder()).forEach(key -> {
            Object value = content.get(key);
            reversed.put(key, value instanceof java.util.Map<?, ?> nested ? reverseKeyOrder(castMap(nested)) : value);
        });
        return reversed;
    }
    ...
    void catalogsAreBrandIsolated() {
        ...
        assertThat(catchThrowable(() -> publication.publish(TENANT, OTHER_BRAND, catalogId, "STOREFRONT", null)))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("does not belong to brand");

        // And the other brand has no live menu of its own to leak into.
        assertThat(storefront.menuFor(TENANT, OTHER_BRAND, LOCATION, LOCALE, CHANNEL))
                .isEmpty();
    }
    ...
    void unwiredPricingIsReportedOnEveryPublication() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-12", "PIECE", UNCLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));

        CatalogSnapshotLoader unwiredLoader = new CatalogSnapshotLoader(store, media, unwired(), LOCALE);
        var unwiredPublication = new CatalogPublicationService(
                store,
                new CatalogValidator(),
                unwiredLoader,
                new JdbcSalesChannelStore(jdbc),
    ...
    void missingFiscalClassificationWarnsWithoutBlocking() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-20", "PIECE", UNCLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
    ...
    void aPartialClassificationReportsOnlyWhatIsMissing() {
        ...
        var burger = authoring.createProduct(
                ...
                FiscalClassification.of("10202001001000000", null, 1, "Burger, dona"),
                ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
    ...
    void aCompleteClassificationIsNotReported() {
        ...
        UUID familySize = authoring.addVariant(
                TENANT,
                BRAND,
                pizza.productId(),
                "SKU-FAMILY",
        ...
        authoring.setOffering(
                TENANT, BRAND, LOCATION, pizza.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("PICKUP"));
        authoring.setOffering(TENANT, BRAND, LOCATION, familySize, OfferingStatus.AVAILABLE, List.of("PICKUP"));
    ...
    void modifierOptionsAreClassifiedInTheirOwnRight() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var coffee = authoring.createProduct(
                TENANT,
                BRAND,
                catalogId,
                "COFFEE",
                ...
                "SKU-COFFEE",
                "PIECE",
                FiscalClassification.of("10301001001000000", "1512399", 1, "Kofe, dona"),
                ACTOR);
        var shot = authoring.createProduct(
                TENANT,
                BRAND,
                catalogId,
                "SHOT",
                ...
                "SKU-SHOT",
                "PIECE",
                FiscalClassification.of("10301001002000000", "1512399", 1, "Shot, dona"),
                ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, coffee.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("PICKUP"));
        authoring.setOffering(
                TENANT, BRAND, LOCATION, shot.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("PICKUP"));

        UUID extras =
                authoring.createModifierGroup(TENANT, BRAND, "EXTRAS", "Qo'shimchalar", LOCALE, false, 0, 2, false);
        ...
        authoring.addModifierOption(
                ...
                1,
                1,
                FiscalClassification.of("10301001003000000", "1512399", 1, "Sirop, dona"),
                ACTOR);
        // Classified nowhere. A modifier reaches the receipt as its own line, so
        // this one genuinely has no code to print.
        authoring.addModifierOption(
                TENANT, BRAND, extras, "NO_SUGAR", "Shakarsiz", LOCALE, null, 1, 2, UNCLASSIFIED, ACTOR);
        ...
        assertThat(result.report().findings())
                ...
                .satisfies(finding -> {
                    ...
                    assertThat(finding.entityType())
                            .isEqualTo(uz.horecaos.platform.catalog.domain.CatalogEntities.EntityType.MODIFIER_OPTION);
                });
        assertThat(result.status()).isEqualTo(PublicationStatus.PUBLISHED);
    ...
    void anUnclassifiedDeliveryFeeIsReported() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-24", "PIECE", CLASSIFIED, ACTOR);
        authoring.setOffering(
                TENANT, BRAND, LOCATION, burger.defaultVariantId(), OfferingStatus.AVAILABLE, List.of("DELIVERY"));
    ...
    void markingReachesPaymentsThroughThePort() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var water = authoring.createProduct(
                TENANT, BRAND, catalogId, "WATER", "Suv", null, LOCALE, "SKU-WATER", "PIECE", CLASSIFIED, ACTOR);
        var vodka = authoring.createProduct(
                TENANT,
                BRAND,
                catalogId,
                "VODKA",
        ...
        assertThat(facts.markedNodes(TENANT, BRAND, cart)).containsExactly(vodka.defaultVariantId());
    ...
    void markingInheritsTowardsTheStricterValue() {
        ...
        var vodka = authoring.createProduct(
                ...
                new FiscalClassification(
                        ...
                        21),
                ACTOR);
        var mixer = authoring.createProduct(
                TENANT, BRAND, catalogId, "MIXER", "Tonik", null, LOCALE, "SKU-TONIC", "PIECE", CLASSIFIED, ACTOR);

        UUID extras = authoring.createModifierGroup(TENANT, BRAND, "SHOTS", "Shotlar", LOCALE, false, 0, 1, false);
        UUID linked = authoring.addModifierOption(
                TENANT,
                BRAND,
                extras,
                "ADD_VODKA",
    ...
    void anOverlongFiscalNameIsRefused() {
        ...
        assertThat(catchThrowable(() -> FiscalClassification.of("10202001001000000", "1512315", 1, tooLong)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void classificationIsOnePerNode() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-25", "PIECE", CLASSIFIED, ACTOR);

        authoring.classify(
                TENANT,
                BRAND,
                PriceableNode.variant(burger.defaultVariantId()),
                FiscalClassification.of("10202001009000000", "1512315", 1, "Burger, dona"),
                ACTOR);

        // A correction, not a second row. Two classifications for one node would
        // make the code on a receipt depend on row order.
        assertThat(jdbc.sql("SELECT count(*) FROM catalog.fiscal_classifications " + "WHERE variant_id = :id")
        ...
        assertThat(jdbc.sql("SELECT priceable_type FROM catalog.fiscal_classifications " + "WHERE variant_id = :id")
                        .param("id", burger.defaultVariantId())
                        .query(String.class)
                        .single())
                .isEqualTo("VARIANT");
    ...
    void theDatabaseRefusesABlankClassificationToo() {
        UUID catalogId = authoring.createCatalog(TENANT, BRAND, "MAIN", "Main menu", LOCALE);
        var burger = authoring.createProduct(
                TENANT, BRAND, catalogId, "BURGER", "Burger", null, LOCALE, "SKU-22", "PIECE", CLASSIFIED, ACTOR);
        ...
        assertThat(catchThrowable(() -> jdbc.sql("UPDATE catalog.fiscal_classifications SET marking_required = true "
                                + "WHERE variant_id = :id")
                        .param("id", burger.defaultVariantId())
                        .update()))
    ...
    private MediaAssetId aMediaAsset(UUID tenantId) {
        ...
        jdbc.sql("""
                INSERT INTO media.assets (
                    ...
                    width_px, height_px)
                VALUES (
                    :assetId, :tenantId, 'BRAND', :ownerId, :objectKey, 'horecaos-media-test',
