...
import uz.qoida.platform.customers.application.CustomerProfileService.AddressFields;
import uz.qoida.platform.customers.application.CustomerProfileService.ContactType;
import uz.qoida.platform.customers.application.CustomerProfileService.CoordinateSource;
import uz.qoida.platform.customers.infrastructure.persistence.ConfiguredCustomerPolicyLookup;
    ...
    void setUp() {
        ...
        FieldProtection protection = new EnvelopeFieldProtection(new DataEncryptionKeyProvider(
                new EnvironmentSecretResolver(
                        java.util.Map.of("qoida.secrets.data_encryption.platform.kek",
