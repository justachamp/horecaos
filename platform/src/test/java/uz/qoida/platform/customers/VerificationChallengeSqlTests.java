...
import uz.qoida.platform.customers.infrastructure.persistence.JdbcVerificationChallengeStore;
...
class VerificationChallengeSqlTests {
     ...
     * {@code qoida_application} is the role this schema actually uses. ADR 0015's
