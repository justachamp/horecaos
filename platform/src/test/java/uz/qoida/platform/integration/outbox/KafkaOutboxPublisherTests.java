...
class KafkaOutboxPublisherTests {
    ...
    static void startKafka() {
        String externalBootstrapServers = System.getenv("QOIDA_TEST_KAFKA_BOOTSTRAP_SERVERS");
        ...
        Assumptions.assumeTrue(
                ...
                "Docker or QOIDA_TEST_KAFKA_BOOTSTRAP_SERVERS is required for Kafka integration tests");
    ...
    void publishesTheVersionedEnvelopePartitionKeyAndIdempotencyHeaders() throws Exception {
        ...
        try {
            ...
            assertThat(new String(
                    record.headers().lastHeader("qoida-event-id").value(),
                    StandardCharsets.UTF_8)).isEqualTo(eventId.toString());
            assertThat(new String(
                    record.headers().lastHeader("qoida-correlation-id").value(),
    ...
    private static org.apache.kafka.clients.consumer.ConsumerRecord<String, String> consumeOne(String topic) {
        Map<String, Object> properties = Map.of(
                ...
                ConsumerConfig.GROUP_ID_CONFIG, "qoida-outbox-test-" + UUID.randomUUID(),
