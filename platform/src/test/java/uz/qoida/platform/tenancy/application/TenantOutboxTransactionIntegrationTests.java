...
import uz.qoida.platform.integration.outbox.TenancyOutboxEventListener;
...
class TenantOutboxTransactionIntegrationTests {
    ...
    static class TestConfiguration {
        ...
        @Bean
        uz.qoida.platform.audit.api.AuditRecorder auditRecorder(
                JdbcClient jdbc, ObjectMapper objectMapper) {
            return new uz.qoida.platform.audit.infrastructure.persistence.JdbcAuditRecorder(jdbc, objectMapper);
        }
