...
import uz.qoida.platform.tenancy.api.TenantActivated;
import uz.qoida.platform.tenancy.api.TenantOnboardingFailed;
import uz.qoida.platform.tenancy.api.TenantOnboardingStarted;
import uz.qoida.platform.tenancy.api.TenantOnboardingStepCompleted;
import uz.qoida.platform.tenancy.api.TenantReady;
...
class OnboardingServiceTests {
    ...
    void activationSucceedsOnceApproved() {
        ...
        new JdbcApprovalService(jdbc, new JdbcAuditRecorder(jdbc, JsonMapper.builder().build()),
                ...
                .decide(requestId, uz.qoida.platform.audit.api.ApprovalService.Decision.APPROVE,
    ...
    private double stalledAgeSeconds() {
        ...
        double age = gaugeMeters.get("qoida.onboarding.runs.stalled.age.seconds").gauge().value();
