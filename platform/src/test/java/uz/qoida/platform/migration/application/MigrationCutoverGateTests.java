...
import uz.qoida.platform.migration.application.MigrationCutoverDecisionStore.Decision;
...
import uz.qoida.platform.migration.application.MigrationScopeService.ResumeCommand;
import uz.qoida.platform.migration.application.MigrationScopeService.SuspendCommand;
...
class MigrationCutoverGateTests extends MigrationControlPlaneFixture {
    ...
    void theGatesDoNotReplaceTheTransitionTable() {
        ...
        assertThat(catchThrowable(() -> advance(scopeId, ScopeState.TARGET_OWNED)))
                .isInstanceOf(uz.qoida.platform.migration.domain.ScopeStateMachine
