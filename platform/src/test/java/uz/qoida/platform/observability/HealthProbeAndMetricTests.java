...
class HealthProbeAndMetricTests {
    ...
    static void properties(DynamicPropertyRegistry registry) {
        ...
        registry.add("qoida.messaging.inbox.listener.enabled", () -> "false");
    ...
    void prometheusSeriesNamesMatchTheProbe() {
        // The alert thresholds live in infra/observability/qoida-probe.sh and are
        ...
        assertThat(scrape)
                .contains("qoida_outbox_oldest_pending_age_seconds")
                .contains("qoida_inbox_oldest_pending_age_seconds")
                .contains("qoida_outbox_pending")
                .contains("qoida_inbox_pending")
                .contains("qoida_orders_oldest_live_age_seconds")
