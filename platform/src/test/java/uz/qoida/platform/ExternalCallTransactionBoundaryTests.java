...
import uz.qoida.platform.payments.application.PaymentProviderPort;
...
import uz.qoida.platform.tenancy.api.onboarding.OnboardingStep;
import uz.qoida.platform.tenancy.api.onboarding.OnboardingStepHandler;
import uz.qoida.platform.tenancy.application.onboarding.OnboardingService;
...
class ExternalCallTransactionBoundaryTests {
    ...
    private static ProviderBinding aBinding() {
        return new ProviderBinding(
                ...
                SecretReference.parse("qoida:test:provider_payment:tenant:click-binding"),
