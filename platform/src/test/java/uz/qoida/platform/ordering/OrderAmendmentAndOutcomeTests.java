...
import uz.qoida.platform.ordering.infrastructure.pos.JdbcPosExportStatus;
...
import uz.qoida.platform.ordering.domain.AmendmentStatus;
...
class OrderAmendmentAndOutcomeTests {
    ...
    void setUp() {
        ...
        var settlementStore = new uz.qoida.platform.payments.settlement.JdbcSettlementStore(jdbc);
        settlementPlanner = new uz.qoida.platform.payments.settlement.CheckoutSettlementPlanner(
                settlementStore,
                new uz.qoida.platform.payments.settlement.OrderSettlementService(
    ...
    private void exportRow(UUID orderId, String state) {
        ...
        jdbc.sql("""
                ...
                VALUES (:id, :tenantId, 'POS', 'clopos', 'clopos-open-api-v2', 'Till',
                    'ACTIVE', 'qoida:local:pos:till:token')
                """)
    ...
    private void requireApproval() {
        var policy = new uz.qoida.platform.ordering.domain.OrderAcceptancePolicy(
                uz.qoida.platform.ordering.domain.AcceptanceMode.RESTAURANT_APPROVAL,
                uz.qoida.platform.ordering.domain.ApprovalChannel.QOIDA_OPERATIONS, 300,
                uz.qoida.platform.ordering.domain.ApprovalTimeoutAction.AUTO_REJECT, true, true);
