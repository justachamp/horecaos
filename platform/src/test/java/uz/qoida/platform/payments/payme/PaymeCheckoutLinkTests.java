...
import uz.qoida.platform.payments.infrastructure.payme.PaymeCheckoutLink;
...
class PaymeCheckoutLinkTests {
     ...
     *
     * <p>A real Qoida payload is 74 bytes plus the digits of the amount, so its
    ...
    /**
     * The half of U19 that turns out not to apply to Qoida at all.
     *
     * <p>A Qoida payload is drawn from a closed alphabet: the literals {@code m=},
     ...
     */
    @Test
    @DisplayName("Qoida's own payloads never produce + or /, but do produce padding")
    void qoidaPayloadsNeverReachThePathSeparator() {
