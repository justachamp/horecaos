package uz.qoida.platform.payments;
...
import uz.qoida.platform.payments.api.RemedyEntitlementPort.RedeemCommand;
import uz.qoida.platform.payments.api.RemedyEntitlementPort.RedemptionOutcome;
...
import uz.qoida.platform.payments.settlement.EntitlementStatus;
...
import uz.qoida.platform.payments.settlement.OrderSettlementService.PlannedTender;
import uz.qoida.platform.payments.settlement.OrderSettlementService.SettlementPlan;
import uz.qoida.platform.payments.settlement.RemedyEntitlementService;
import uz.qoida.platform.payments.settlement.RemedyType;
import uz.qoida.platform.payments.settlement.SettlementBasis;
 ...
 * that quietly reads as if Qoida had performed the refunds it merely recorded.
 */
class RefundAndRemedyTests {
    ...
    void aLateCaptureSettlesOnlyTheMoneyThatArrived() {
        ...
        assertThat(settlementStore.tendersOf(TENANT, settlementId))
                .filteredOn(uz.qoida.platform.payments.settlement.JdbcSettlementStore.TenderRow
                        ::settlesFromBalance)
