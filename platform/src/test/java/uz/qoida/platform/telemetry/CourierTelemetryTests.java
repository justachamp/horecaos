...
import uz.qoida.platform.telemetry.api.RealtimeSignalPublisher;
import uz.qoida.platform.telemetry.api.SettlementCalendarPort;
import uz.qoida.platform.telemetry.api.StreamChannel;
import uz.qoida.platform.telemetry.api.TelemetryConfigurationKeys;
import uz.qoida.platform.telemetry.application.CourierPositionQueryService;
import uz.qoida.platform.telemetry.application.CourierPositionQueryService.FleetView;
import uz.qoida.platform.telemetry.application.CourierTrackRevealService;
import uz.qoida.platform.telemetry.application.CourierTrackRevealService.Reveal;
import uz.qoida.platform.telemetry.application.CourierTrackRevealService.RevealCommand;
import uz.qoida.platform.telemetry.application.DutySessionService;
import uz.qoida.platform.telemetry.application.DutySessionService.OpenCommand;
import uz.qoida.platform.telemetry.application.TelemetryIngestService;
import uz.qoida.platform.telemetry.application.TelemetryIngestService.IngestOutcome;
import uz.qoida.platform.telemetry.domain.CollectionGate;
import uz.qoida.platform.telemetry.domain.TrackObservation;
...
import uz.qoida.platform.telemetry.infrastructure.persistence.JdbcTelemetryStore.LivePositionRow;
import uz.qoida.platform.telemetry.infrastructure.persistence.TrackRetentionSweeper;
import uz.qoida.platform.telemetry.infrastructure.startup.TrackRetentionFloorCheck;
    ...
    void setUp() {
        ...
        FieldProtection protection = new EnvelopeFieldProtection(new DataEncryptionKeyProvider(
                new EnvironmentSecretResolver(
                        Map.of("qoida.secrets.data_encryption.platform.kek",
