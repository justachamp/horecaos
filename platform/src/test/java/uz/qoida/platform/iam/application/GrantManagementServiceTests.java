package uz.qoida.platform.iam.application;
...
import uz.qoida.platform.audit.application.GrantAuditListener;
...
class GrantManagementServiceTests {
    ...
    void setUp() {
        ...
        service = new GrantManagementService(
                ...
                event -> {
                    if (event instanceof uz.qoida.platform.iam.api.GrantChanged change) {
