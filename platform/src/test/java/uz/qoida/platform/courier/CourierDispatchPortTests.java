...
import uz.qoida.platform.courier.infrastructure.dispatch.CourierShiftAdapter;
import uz.qoida.platform.courier.infrastructure.dispatch.InternalFleetAdapter;
...
import uz.qoida.platform.fulfillment.infrastructure.sourcing.InternalFleetConfiguration;
import uz.qoida.platform.fulfillment.infrastructure.sourcing.JdbcActiveAssignments;
...
import uz.qoida.platform.telemetry.api.CourierProximityPort;
import uz.qoida.platform.telemetry.api.CourierShiftPort;
import uz.qoida.platform.telemetry.application.DutySessionService;
import uz.qoida.platform.telemetry.domain.CollectionGate;
import uz.qoida.platform.telemetry.domain.LivePositionRules;
import uz.qoida.platform.telemetry.infrastructure.fulfillment.LivePositionProximity;
...
class CourierDispatchPortTests {
    ...
    void aLapsedRegistrationRemovesTheCourierFromTheFleet() {
        ...
        courierStore.suspend(TENANT, alisherEngagement,
                uz.qoida.platform.courier.domain.EngagementStatus.SUSPENDED_COMPLIANCE,
                "REGISTRATION_LAPSED",
                uz.qoida.platform.courier.domain.RegistrationWarningState.LAPSED, clock.instant());
    ...
    void aCourierOpensHisOwnShiftAndTheDutySessionFollowsIt() {
        ...
        CourierShiftPort unwired = new uz.qoida.platform.telemetry.infrastructure.fulfillment
