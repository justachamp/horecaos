package uz.qoida.platform.commercial.domain;
...
import uz.qoida.platform.commercial.api.EntitlementSource;
...
class EntitlementBoundaryTests {
    ...
    void aSnapshotHashesTheEntitlementsAndNotTheInstantItWasRead() {
        ...
        var first = new uz.qoida.platform.commercial.api.EntitlementSnapshot(
                tenant, null, java.util.Map.of(ORDERS.code(), value), NOW);
        var second = new uz.qoida.platform.commercial.api.EntitlementSnapshot(
