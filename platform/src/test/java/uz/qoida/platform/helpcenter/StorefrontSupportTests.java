package uz.qoida.platform.helpcenter;
...
class StorefrontSupportTests {
    ...
    void socialLinksAreFilteredAndOrdered() {
        ...
        socialLink("TELEGRAM", "https://t.me/qoida", 10, "PUBLISHED", null);
        socialLink("INSTAGRAM", "https://instagram.com/qoida", 30, "ARCHIVED", null);
    ...
    void anAssetOverrideBecomesAUrl() {
        ...
        socialLink("TELEGRAM", "https://t.me/qoida", 10, "PUBLISHED", assetId);
