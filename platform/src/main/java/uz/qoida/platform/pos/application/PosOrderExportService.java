...
import uz.qoida.platform.integration.api.provider.ProviderEntityMappingLookup;
...
import uz.qoida.platform.pos.application.port.PosAdapter.ExportProbe;
import uz.qoida.platform.pos.application.port.PosAdapter.ExportResult;
import uz.qoida.platform.pos.application.port.PosAdapter.OrderExport;
import uz.qoida.platform.pos.application.port.PosAdapter.PosContext;
import uz.qoida.platform.pos.application.port.PosAdapter.RecoveryRead;
import uz.qoida.platform.pos.application.port.PosOrderSource;
import uz.qoida.platform.pos.domain.ExportCandidate;
import uz.qoida.platform.pos.domain.ExportState;
import uz.qoida.platform.pos.domain.ExportStateMachine;
import uz.qoida.platform.pos.domain.LineFingerprint;
import uz.qoida.platform.pos.domain.UncertainExportResolver;
import uz.qoida.platform.pos.infrastructure.persistence.JdbcPosBindingConfiguration;
import uz.qoida.platform.pos.infrastructure.persistence.JdbcPosCapabilityStore;
    ...
    private List<LineFingerprint.Line> fingerprintLines(BindingRef binding,
        ...
        for (PosOrderSource.ExportableOrder.Line line : order.lines()) {
            String externalId = mappings
                    ...
                    // The Qoida id keeps the value stable and different from any
