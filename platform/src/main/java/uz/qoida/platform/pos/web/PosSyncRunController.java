...
import uz.qoida.platform.pos.application.PosCapabilityService;
import uz.qoida.platform.pos.application.PosCatalogSyncService;
...
public class PosSyncRunController {
    ...
    /**
     * @param authority who owns this field. A {@code QOIDA} authority with a
    ...
    public record DifferenceView(
            String entityType, String externalEntityId, UUID qoidaEntityId, String category,
