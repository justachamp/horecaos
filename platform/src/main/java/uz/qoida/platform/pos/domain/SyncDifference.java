 ...
 * what Qoida holds, what the provider sent, who owns the field under the run's
...
public record SyncDifference(
    ...
    public enum DifferenceCategory {
        ...
        /** The provider has something Qoida does not. May become a draft. */
        ADDITION,
        ...
        /**
         * A field Qoida owns differs from the provider's value.
         *
        ...
        /**
         * The provider no longer lists something Qoida has mapped.
         *
    ...
    public enum FieldAuthority {
        ...
        /** Qoida decides. The provider's value is evidence and never applied. */
        QOIDA,
