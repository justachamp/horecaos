package uz.qoida.platform.pos.application.port;
...
public interface PosOrderSource {
     ...
     * @param acceptanceMode       whether Qoida already confirmed the order or is
    ...
    record ExportableOrder(
        ...
        /**
         * @param sourceVariantId what Qoida sold. The external identifier is
