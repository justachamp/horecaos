...
import uz.qoida.platform.migration.application.MigrationPreconditionException;
import uz.qoida.platform.migration.application.MigrationResourceNotFoundException;
...
import uz.qoida.platform.migration.application.MigrationRunStore.Counters;
...
import uz.qoida.platform.migration.application.QuarantineService;
...
import uz.qoida.platform.migration.infrastructure.persistence.JdbcEntityMappingStore.EntityMappingRow;
...
@ConditionalOnProperty(
        prefix = "qoida.migration.legacy", name = "enabled", havingValue = "true")
