...
import uz.qoida.platform.migration.application.MigrationReconciliationStore;
import uz.qoida.platform.migration.domain.ReconciliationSeverity;
import uz.qoida.platform.migration.domain.ReconciliationStatus;

import static uz.qoida.platform.migration.infrastructure.persistence.MigrationColumns.exactIntegerOrNull;
