...
import uz.qoida.platform.migration.application.MigrationConflictException;
...
import uz.qoida.platform.migration.domain.ScopeStateMachine.IllegalTransitionException;
import uz.qoida.platform.web.api.ApiProblem;
...
public class MigrationApiErrorHandler {
    ...
    ProblemDetail precondition(MigrationPreconditionException exception) {
        ...
        problem.setType(URI.create("https://docs.qoida.uz/problems/migration/"
