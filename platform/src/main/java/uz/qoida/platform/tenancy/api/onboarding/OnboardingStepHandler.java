...
public interface OnboardingStepHandler {
    ...
    record StepResult(
        ...
        public static StepResult completed(Map<String, Object> result, String externalReference) {
            return new StepResult(Outcome.COMPLETED, result, externalReference, null, null);
        }

        public static StepResult retry(String errorCode, String detail) {
            return new StepResult(Outcome.RETRY, Map.of(), null, errorCode, detail);
        }

        public static StepResult failed(String errorCode, String detail) {
            return new StepResult(Outcome.FAILED, Map.of(), null, errorCode, detail);
        }

        public static StepResult blocked(String detail) {
