package uz.qoida.platform.reporting.infrastructure.persistence;
...
import uz.qoida.platform.reporting.application.ReportingFacts.SlaBucketAggregate;
 ...
 * {@code qoida_reporting_read} role enforces at the database.
 */
@Repository
public class JdbcReportingStore {
     ...
     *
     * <p>The provider's {@code occurred_at} is used and not Qoida's
