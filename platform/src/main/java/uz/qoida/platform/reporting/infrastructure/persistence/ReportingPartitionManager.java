 ...
 */
@Component
@ConditionalOnProperty(name = "qoida.reporting.partitions.enabled", havingValue = "true",
        matchIfMissing = true)
public class ReportingPartitionManager {
    ...
    @Scheduled(
            initialDelayString = "${qoida.reporting.partitions.initial-delay:PT1M}",
            fixedDelayString = "${qoida.reporting.partitions.interval:P1D}")
