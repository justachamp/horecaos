...
import uz.qoida.platform.reporting.domain.MetricDefinition.Aggregation;
import uz.qoida.platform.reporting.domain.MetricDefinition.CurrencyRule;
import uz.qoida.platform.reporting.domain.MetricDefinition.MetricUnit;

/**
 * The only definition of a number in Qoida (ADR 0043).
 *
