...
import uz.qoida.platform.dinein.infrastructure.persistence.JdbcDineInStore.GuestSessionRow;
...
public class QrEntryService {
    ...
    public GuestAdmission exchange(String printedToken) {
        ...
        // the waiter already started for them. Null in VIEW_ONLY, where Qoida
