...
import uz.qoida.platform.fiscal.infrastructure.persistence.JdbcFiscalLifecycleStore.CoverageCounts;
import uz.qoida.platform.fiscal.infrastructure.persistence.JdbcFiscalLifecycleStore.FiscalDocumentRow;
import uz.qoida.platform.fiscal.infrastructure.persistence.JdbcFiscalLifecycleStore.ReportingCandidate;
...
public class FiscalDocumentService {
    ...
    public FiscalDocumentService(JdbcFiscalLifecycleStore documents,
            ...
            @Value("${qoida.fiscal.sweeper.minimum-age:PT1M}") Duration minimumAge) {
