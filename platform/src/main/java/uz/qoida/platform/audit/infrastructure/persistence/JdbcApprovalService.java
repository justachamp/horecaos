...
import uz.qoida.platform.audit.api.ApprovalAction.MissingPolicyMode;
import uz.qoida.platform.audit.api.ApprovalGrant;
...
public class JdbcApprovalService implements ApprovalService {
     ...
     */
    public static final String RESOLUTION_METRIC = "qoida.approval.policy.resolution";
