 ...
 */
@Component
@ConditionalOnProperty(name = "qoida.audit.approval.expiry.enabled",
...
public class ApprovalExpirySweeper {
    ...
    @Scheduled(
            initialDelayString = "${qoida.audit.approval.expiry.initial-delay:PT1M}",
            fixedDelayString = "${qoida.audit.approval.expiry.interval:PT5M}")
    public void sweep() {
