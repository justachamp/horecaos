...
import uz.qoida.platform.audit.application.ApprovalPolicyService;
import uz.qoida.platform.audit.application.ApprovalPolicyService.PolicyCoverage;
...
public class ApprovalPolicyController {
    ...
    private static uz.qoida.platform.iam.api.ResourceScope scope(
        ...
        return switch (scopeType(body.scopeType())) {
            case TENANT -> {
                ...
                yield uz.qoida.platform.iam.api.ResourceScope.tenant(tenantId);
            }
            case BRAND -> {
                if (body.brandId() == null || body.locationId() != null) {
                    throw new ApiException(ErrorCode.VALIDATION_FAILED,
                ...
                yield uz.qoida.platform.iam.api.ResourceScope.brand(tenantId, body.brandId());
            }
            case LOCATION -> {
                if (body.brandId() == null || body.locationId() == null) {
                    throw new ApiException(ErrorCode.VALIDATION_FAILED,
                ...
                yield uz.qoida.platform.iam.api.ResourceScope.location(
