...
import uz.qoida.platform.pricing.domain.Money;
import uz.qoida.platform.pricing.domain.Promotion;
import uz.qoida.platform.pricing.domain.Quote;
import uz.qoida.platform.pricing.domain.Quote.Adjustment;
import uz.qoida.platform.pricing.domain.QuoteRequest;
import uz.qoida.platform.pricing.domain.TaxCalculation;
...
public class PricingEngine {
    ...
    public static class UnsupportedTaxModeException extends RuntimeException {
        public UnsupportedTaxModeException(TaxMode mode) {
            super("Tax mode " + mode + " is not implemented; prices at Qoida are VAT-inclusive");
        }
    }
}
