package uz.qoida.platform.pricing.domain;
...
public record QuoteRequest(
     ...
     *
     * @param pricingAuthority whether Qoida prices this order at all. Carried on
    ...
    public record Delivery(GeoPoint destination, PricingAuthority pricingAuthority) {
        ...
        public Delivery {
            ...
            pricingAuthority = pricingAuthority == null ? PricingAuthority.QOIDA : pricingAuthority;
        }
    }
