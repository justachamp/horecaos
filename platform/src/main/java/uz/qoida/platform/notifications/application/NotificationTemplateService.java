...
import uz.qoida.platform.notifications.infrastructure.persistence.JdbcTemplateStore.TemplateRow;
...
public class NotificationTemplateService {
    ...
    /** A version does not exist in every locale Qoida sends in. */
