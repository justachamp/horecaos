package uz.qoida.platform.notifications.application;
...
import uz.qoida.platform.notifications.api.DispatchOutcome;
import uz.qoida.platform.notifications.api.NotificationDispatch;
import uz.qoida.platform.notifications.api.NotificationTransport;
import uz.qoida.platform.notifications.domain.ContentHashes;
import uz.qoida.platform.notifications.domain.NotificationStatus;
import uz.qoida.platform.notifications.domain.TemplateRenderer;
import uz.qoida.platform.notifications.infrastructure.persistence.JdbcNotificationStore;
import uz.qoida.platform.notifications.infrastructure.persistence.JdbcNotificationStore.AttemptRow;
import uz.qoida.platform.notifications.infrastructure.persistence.JdbcNotificationStore.NotificationRow;
import uz.qoida.platform.notifications.infrastructure.persistence.JdbcTemplateStore;
import uz.qoida.platform.notifications.infrastructure.persistence.JdbcTemplateStore.VersionRow;
...
public class NotificationDispatchService {
    ...
    public NotificationDispatchService(JdbcNotificationStore notifications,
            ...
            @Value("${qoida.notifications.max-attempts:8}") int maximumAttempts,
            @Value("${qoida.notifications.retry-backoff:PT30S}") Duration retryBackoff) {
    ...
    private void record(NotificationRow row, AttemptRow attempt, DispatchOutcome outcome,
        ...
        switch (outcome.status()) {
            case ACCEPTED -> {
                ...
                // anything, and ADR 0020 forbids Qoida promising more than it was
     ...
     * recognise. Guessing upward is how Qoida ends up claiming a delivery the
