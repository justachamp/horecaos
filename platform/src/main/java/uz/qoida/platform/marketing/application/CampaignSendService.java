...
import uz.qoida.platform.marketing.api.CampaignMessagePort;
import uz.qoida.platform.marketing.api.CampaignMessagePort.MarketingMessage;
import uz.qoida.platform.marketing.domain.CampaignStatus;
import uz.qoida.platform.marketing.domain.EngagementPolicy;
import uz.qoida.platform.marketing.domain.MarketingChannel;
import uz.qoida.platform.marketing.domain.RefusalReason;
import uz.qoida.platform.marketing.infrastructure.persistence.JdbcAudienceStore;
import uz.qoida.platform.marketing.infrastructure.persistence.JdbcAudienceStore.SnapshotMemberRow;
import uz.qoida.platform.marketing.infrastructure.persistence.JdbcCampaignStore;
import uz.qoida.platform.marketing.infrastructure.persistence.JdbcCampaignStore.BatchClaim;
import uz.qoida.platform.marketing.infrastructure.persistence.JdbcCampaignStore.CampaignRow;
...
public class CampaignSendService {
    ...
    public CampaignSendService(JdbcCampaignStore campaigns, JdbcAudienceStore audiences,
            ...
            @Value("${qoida.marketing.batch-size:200}") int batchSize) {
