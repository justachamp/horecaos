package uz.qoida.platform.helpcenter.web;
...
import uz.qoida.platform.helpcenter.application.SupportQuery;
...
public class StorefrontSupportController {
    ...
    public record FaqEntryResponse(UUID entryId, String code, String question, String answer) {
        ...
        static FaqEntryResponse of(uz.qoida.platform.helpcenter.domain.SupportContent.FaqEntry entry) {
