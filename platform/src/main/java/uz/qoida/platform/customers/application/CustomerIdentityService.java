...
import uz.qoida.platform.customers.api.CustomerDirectory;
import uz.qoida.platform.customers.api.CustomerIdentityPolicy;
import uz.qoida.platform.customers.application.CustomerPolicyLookup.ResolvedIdentityPolicy;
...
public class CustomerIdentityService implements CustomerDirectory {
     ...
     */
    public static final String PROVEN_NUMBER_ISSUER = "urn:qoida:customer-identity:proven-phone";
