...
import uz.qoida.platform.customers.application.VerificationCodeSource;
...
public class PresetVerificationCodeSource implements VerificationCodeSource {
    ...
    public static final String PHONE_PROPERTY = "qoida.customers.verification.preset.phone";

    public static final String CODE_PROPERTY = "qoida.customers.verification.preset.code";
