...
import uz.qoida.platform.customers.application.CustomerSessionStore.NewSession;
import uz.qoida.platform.customers.application.CustomerSessionStore.StoredSession;
...
public class CustomerSessionService {
    ...
    public CustomerSessionService(
            ...
            AuditRecorder audit,
            Clock clock,
            @Value("${qoida.customers.session.ttl:P30D}") Duration sessionTtl) {
