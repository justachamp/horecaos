...
final class VerificationCodeText {
    ...
    static String render(String code, Duration validFor, String locale) {
        ...
        return switch (language(locale)) {
            case "ru" -> "Qoida: kod %s. Deystvitelen %d min. Nikomu ego ne soobshchayte."
                    .formatted(code, minutes);
            case "en" -> "Qoida: your code is %s. Valid for %d min. Do not share it."
                    .formatted(code, minutes);
            ...
            default -> "Qoida: kod %s. %d daqiqa amal qiladi. Hech kimga aytmang."
                    .formatted(code, minutes);
        };
    }
