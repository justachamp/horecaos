 ...
 *       collects the basket total from the recipient. On a basket Qoida has
...
public class NoorDeliveryAdapter implements DeliveryPartner {
    ...
    private Map<String, Object> createBody(DeliveryRequest request) {
        ...
        body.put("vendor_order_id", request.qoidaReference());
    ...
    /**
     * True when Qoida has already taken the money.
     *
