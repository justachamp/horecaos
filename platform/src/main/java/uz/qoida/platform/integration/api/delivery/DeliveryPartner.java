...
public interface DeliveryPartner {
    ...
    /**
     * @param prepaid whether Qoida already took payment. Some partners will
    ...
    record DeliveryRequest(
        ...
        public String toString() {
            return "DeliveryRequest[qoidaReference=%s, requestedPickupAt=%s, prepaid=%s, currency=%s]"
                    .formatted(qoidaReference, requestedPickupAt, prepaid, currency);
        }
    }
