...
import uz.qoida.platform.integration.api.provider.ProviderInstallationLookup.InstallationSnapshot;
...
public class PaymentGateway {
    ...
    public PaymentGateway(ProviderInstallationLookup installations, SecretResolver secrets,
    ...
    public ProviderOutcome invoke(MerchantApiCall call) {
        ...
        ImportSuppression.refuse(ExternalEffect.PAYMENT_COLLECTION,
    ...
    private ProviderOutcome send(MerchantApiCall call, InstallationSnapshot installation,
        ...
        return switch (call.method()) {
            ...
            case "POST" -> http.post(providerCall, call.path(), headers, call.body(),
                    PaymentGateway::body);
            case "PUT" -> http.put(providerCall, call.path(), headers, call.body(),
                    PaymentGateway::body);
     ...
     */
    private static ProviderOutcome classifyForPayments(MerchantApiCall call,
