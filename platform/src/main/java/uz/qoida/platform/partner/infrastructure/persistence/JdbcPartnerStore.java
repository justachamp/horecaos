package uz.qoida.platform.partner.infrastructure.persistence;
...
import uz.qoida.platform.partner.domain.PartnerClientStatus;
...
public class JdbcPartnerStore {
    ...
    /**
     * Resolves the aggregator's own venue identifier to a Qoida branch.
     *
     ...
     * it, and the alternative is a paid customer refused by a timetable Qoida
    ...
    /**
     * Resolves the partner's own item identifiers to Qoida catalogue variants.
     *
    ...
    public Map<String, UUID> resolveMenuItems(UUID tenantId, UUID bindingId,
        ...
        jdbc.sql("""
                SELECT external_entity_id, qoida_entity_id
    ...
    /**
     * What Qoida already decided about this partner order id.
     *
     ...
     * a partner restate a total Qoida had already refused, and the second
