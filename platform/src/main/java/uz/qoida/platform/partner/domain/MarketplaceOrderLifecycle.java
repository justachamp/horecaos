 ...
 * (ADR 0040).
 *
 * <p>Qoida stays the only writer of {@code ordering.orders.status}. This is not
 ...
 * Qoida instructs — a marketplace partner is not one of them.
 *
 ...
 *
 * <p>Two things are deliberately different from a Qoida-fulfilled order.
 *
 * <p><strong>{@code FULFILLING} is skipped.</strong> It means "Qoida is
 * delivering this", and Qoida is not. Leaving it in the path would put every
 ...
 * delivery.</strong> Handover is the last event Qoida can observe. The customer
...
public final class MarketplaceOrderLifecycle {
    ...
    /**
     * The one exception granted knowingly: a partner may cancel an order Qoida
