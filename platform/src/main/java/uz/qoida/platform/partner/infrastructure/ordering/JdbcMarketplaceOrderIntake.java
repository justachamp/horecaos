package uz.qoida.platform.partner.infrastructure.ordering;
 ...
 * those from {@code NOT NULL} to "present exactly when Qoida priced it", so this
...
public class JdbcMarketplaceOrderIntake implements MarketplaceOrderIntake {
    ...
    public Created create(NewMarketplaceOrder order) {
        ...
        // to the customer and Qoida did not; copying it into promise columns
        // that ADR 0036 defines as Qoida's own derivation would make an
