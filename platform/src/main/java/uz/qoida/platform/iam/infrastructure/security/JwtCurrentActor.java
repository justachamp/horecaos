package uz.qoida.platform.iam.infrastructure.security;
...
import uz.qoida.platform.iam.api.NonStaffPrincipal;
...
public class JwtCurrentActor implements CurrentActor {
    ...
    public JwtCurrentActor(@Value("${qoida.security.oauth2.client-id:qoida-api}") String resourceServerClientId) {
