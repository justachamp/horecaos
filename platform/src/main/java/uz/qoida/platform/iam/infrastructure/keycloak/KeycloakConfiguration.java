...
public class KeycloakConfiguration {
    ...
    OrganizationProvisioner organizationProvisioner(
            ...
            Clock clock,
            @Value("${qoida.keycloak.base-url:http://localhost:8081}") String baseUrl,
            @Value("${qoida.keycloak.realm:qoida}") String realm,
            @Value("${qoida.keycloak.provisioning-client-id:qoida-provisioning}") String clientId,
            @Value("${qoida.environment:local}") String environment) {
     ...
     *
     * <p>{@code qoida-identity-reader} holds view and query roles only, verified
    ...
    OrganizationDirectory organizationDirectory(
            ...
            @Value("${qoida.keycloak.base-url:http://localhost:8081}") String baseUrl,
            @Value("${qoida.keycloak.realm:qoida}") String realm,
            @Value("${qoida.keycloak.identity-reader-client-id:qoida-identity-reader}") String clientId,
            @Value("${qoida.environment:local}") String environment) {
