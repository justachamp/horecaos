package uz.qoida.platform.web.idempotency;
...
import uz.qoida.platform.web.CorrelationIdFilter;
...
public class CachedBodyRequestFilter extends OncePerRequestFilter {
    ...
    static final String CACHED_BODY_ATTRIBUTE = "qoida.cachedRequestBody";
    ...
    public CachedBodyRequestFilter(
            @Value("${qoida.web.request-body.max-bytes:" + DEFAULT_MAX_BODY_BYTES + "}")
            int maxBodyBytes) {
     ...
     *
     * <p>{@link uz.qoida.platform.web.api.GlobalApiErrorHandler} sits inside the
    ...
    private static void refuse(HttpServletResponse response) throws IOException {
        ...
        response.getWriter().write("""
                {"type":"https://docs.qoida.uz/problems/request-body-too-large",\
