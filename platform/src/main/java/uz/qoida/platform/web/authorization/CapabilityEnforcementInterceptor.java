...
import uz.qoida.platform.iam.api.ResourceScopeVerifier;
 ...
 * {@code qoida.authorization.enforce} defaults to true — because a capability
 ...
 *
 * <p>Setting {@code qoida.authorization.enforce} to false restores the
...
public class CapabilityEnforcementInterceptor implements HandlerInterceptor {
    ...
    public CapabilityEnforcementInterceptor(
            ...
            @Value("${qoida.authorization.enforce:true}") boolean enforce) {
    ...
    public void afterCompletion(
        ...
        try {
            ...
            Counter.builder("qoida.authorization.shadow")
