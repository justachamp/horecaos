package uz.qoida.platform.payments.infrastructure;
 ...
 *
 * <p>Both payment providers call Qoida on public endpoints, and both
 ...
 * a lost response the provider will retry into; it is Qoida telling Payme the
