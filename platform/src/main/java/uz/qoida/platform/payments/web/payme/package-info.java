 ...
 *
 * <p>This is the Payme integration. Payme is the JSON-RPC client and Qoida is the
 * server; the only thing Qoida ever sends Payme is an unsigned checkout link, and
 ...
 * same constraint. See {@link uz.qoida.platform.payments.web.payme.PaymeEndpointSecurity}.
 *
 ...
 * keyed on {@code params.id}, which Payme minted, rather than on a header Qoida
