 ...
 * Click has no expiry at all, so on Click this is a fact Qoida decided and the
...
public enum PaymentTransactionType {
    ...
    /** Qoida's own reservation timeout. See {@link #CANCEL} for the provider-side event. */
    EXPIRE,

    /** A reversal Qoida initiated, which only Click offers and which may still be refused. */
    REVERSE,
