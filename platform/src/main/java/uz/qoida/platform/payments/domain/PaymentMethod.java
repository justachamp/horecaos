...
public enum PaymentMethod {
     ...
     *
     * <p>Not offerable on a Qoida channel and never chosen by a customer here:
     * this is the tender of an order that arrived already paid, pushed by a
     * marketplace that took the customer's money before Qoida heard of the order.
     ...
     * {@link PaymentProviderType} because Qoida holds no merchant account behind
