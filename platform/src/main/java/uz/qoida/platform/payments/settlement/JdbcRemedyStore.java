...
public class JdbcRemedyStore {
    ...
    /**
     * @param attestedMoneyMinor   the part a person says moved in a place Qoida
     *                             cannot see. Unverifiable by construction
     * @param platformSettledMinor the part Qoida performed in its own ledger and
     *                             can prove. Today only a points reversal
     * @param deliveryFeeBasisMinor the fee ceiling that was checked, or null when
     *                             {@link uz.qoida.platform.payments.application.DeliveryFeeBasisPort}
    ...
    /**
     * The reconciliation worklist: money Qoida asserted moved and nothing has
     * corroborated.
     *
    ...
    /**
     * Records that something outside Qoida agreed, or disagreed, with an
     * attestation.
     *
