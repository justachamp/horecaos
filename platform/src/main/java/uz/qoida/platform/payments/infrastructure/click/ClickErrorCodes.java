 ...
 * {@link uz.qoida.platform.payments.domain.ProviderOutcome.Classification#UNCERTAIN}
...
public final class ClickErrorCodes {
    ...
    /** Qoida's own failure code for the gap above. Never one of Click's. */
     ...
     * {@code error_code} — the {@code ofd_data} GET is the one Qoida makes — and
