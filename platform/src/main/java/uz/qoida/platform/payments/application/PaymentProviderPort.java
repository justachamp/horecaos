 ...
 * belongs to the adapter and only a Qoida failure code comes back.
 */
public interface PaymentProviderPort {
     ...
     * {@code CancelTransaction}, which Qoida can only veto. Ask
    ...
    uz.qoida.platform.payments.domain.PaymentProviderType providerType();
}
