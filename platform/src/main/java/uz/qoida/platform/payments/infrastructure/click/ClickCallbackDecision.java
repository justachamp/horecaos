...
/**
 * What Qoida decided about one SHOP API arrival (ADR 0013).
 *
 ...
 *
 * @param merchantTransactionId the value Qoida returns as {@code merchant_prepare_id}
...
public record ClickCallbackDecision(
    ...
    /** What the callback inbox records as the answer Qoida gave, in Click's vocabulary. */
