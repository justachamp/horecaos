...
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.CANCELLED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.CAPTURED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.EXPIRED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.FAILED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.INITIATED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.PRESENTED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.RESERVED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.REVERSED;
import static uz.qoida.platform.payments.domain.PaymentAttemptStatus.UNCERTAIN;
