 ...
 * is what a settlement file matches against; {@link #recordedAt()} is Qoida's, and
 ...
 *                          event no provider originates — an expiry Qoida decided
...
public record PaymentTransaction(
    ...
    /** The reference for an event Qoida decided and no provider originated. */
