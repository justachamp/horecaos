 ...
 *
 * <p>These never leave this package. The domain sees a Qoida failure code and
...
public final class PaymeErrorCode {
     ...
     * cancelled.
     *
     * <p>The only veto Qoida has over a refund Payme initiated from the merchant
     ...
     * offending {@code account} sub-field. Qoida's account schema has exactly one
