...
public class ClickMerchantApi {
     ...
     * the Click application, and Qoida learns about the money through the SHOP API
    ...
    /**
     * Resolves Qoida's own id to Click's {@code payment_id}.
     *
    ...
    /**
     * Attaches a receipt Qoida fiscalized elsewhere.
     *
