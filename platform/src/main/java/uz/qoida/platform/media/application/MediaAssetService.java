...
import uz.qoida.platform.media.api.MediaAssetAvailable;
...
import uz.qoida.platform.media.domain.MediaAsset;
...
public class MediaAssetService implements MediaAvailability {
    ...
    public MediaAssetService(JdbcMediaAssetStore store, JdbcDerivativeJobStore derivativeJobs,
            ...
            @Value("${qoida.media.bucket:qoida-media}") String bucket) {
        this.store = store;
