package uz.horecaos.platform.tenancy.infrastructure.migration;
...
/**
 * Legacy {@code companies} become HorecaOS brands (ADR 0024, wave 1).
 *
 ...
 * {@link uz.horecaos.platform.migration.api.ImportContext} the append is skipped and
 ...
 * HorecaOS tenant and each company becomes a brand.</strong> The tenant comes from
