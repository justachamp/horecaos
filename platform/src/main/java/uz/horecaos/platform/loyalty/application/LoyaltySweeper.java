...
public class LoyaltySweeper {
    ...
    @Scheduled(
            ...
            fixedDelayString = "${horecaos.loyalty.sweeper.maturity-interval:PT5M}")
    ...
    @Scheduled(
            initialDelayString = "${horecaos.loyalty.sweeper.initial-delay:PT1M}",
            fixedDelayString = "${horecaos.loyalty.sweeper.expiry-interval:PT1H}")
    ...
    @Scheduled(
            initialDelayString = "${horecaos.loyalty.sweeper.initial-delay:PT1M}",
            fixedDelayString = "${horecaos.loyalty.sweeper.hold-interval:PT2M}")
    ...
    @Scheduled(
            initialDelayString = "${horecaos.loyalty.sweeper.initial-delay:PT1M}",
            fixedDelayString = "${horecaos.loyalty.sweeper.reconciliation-interval:PT24H}")
