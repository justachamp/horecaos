...
/**
 * The languages HorecaOS sends in (ADR 0035, ADR 0020).
 *
...
public enum MessageLocale {
    ...
    /** The default when a customer has expressed no preference. See {@code horecaos.notifications.default-locale}. */
