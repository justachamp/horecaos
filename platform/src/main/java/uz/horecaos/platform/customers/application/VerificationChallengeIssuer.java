...
public class VerificationChallengeIssuer {
    ...
    public VerificationChallengeIssuer(
            ...
            Clock clock,
            @Value("${horecaos.customers.verification.code-ttl:PT5M}") Duration codeTtl,
            @Value("${horecaos.customers.verification.max-attempts:5}") int maxAttempts,
            @Value("${horecaos.customers.verification.resend-interval:PT1M}") Duration resendInterval,
            @Value("${horecaos.customers.verification.destination-window:PT1H}") Duration destinationWindow,
            @Value("${horecaos.customers.verification.destination-budget:5}") int destinationBudget) {
