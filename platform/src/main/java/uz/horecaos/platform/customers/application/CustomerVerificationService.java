...
import uz.horecaos.platform.customers.domain.VerificationGrantSecret;
 ...
 *
 * <p>The grant is still the seam, and it is still not a session: HorecaOS proves
...
public class CustomerVerificationService {
    ...
    public CustomerVerificationService(
            ...
            AuditRecorder audit,
            Clock clock,
            @Value("${horecaos.customers.verification.grant-ttl:PT10M}") Duration grantTtl) {
