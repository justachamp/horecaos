...
public enum PaymentProviderType {
    ...
    /**
     * Whether HorecaOS may initiate a reversal against this provider.
     *
     * <p>A declared fact rather than a call that fails. On Payme there is no
     * outbound refund at all — the cabinet's refund button calls HorecaOS's
     * {@code CancelTransaction}, and HorecaOS's only lever is to veto it — so a
