...
/**
 * Payme's transaction states, and the projection of HorecaOS's onto them (ADR 0013).
 *
 ...
 *
 * <p>This is a projection and never a source of truth. HorecaOS's state is
 ...
 * that has been presented but not created, and HorecaOS has no separate state for
