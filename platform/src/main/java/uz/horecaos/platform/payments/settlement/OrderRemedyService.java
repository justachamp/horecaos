 ...
 * cabinet, and HorecaOS records what they did so the order, the settlement and the
 ...
 * merchant account HorecaOS cannot see, on the word of one person. Three things keep
 ...
 *       {@code platform_settled_minor}, which is the part HorecaOS genuinely
 ...
 *       {@code recorded_by} and {@code recorded_at} are HorecaOS's observation of
...
public class OrderRemedyService {
    ...
    /**
     * Evidence is demanded only for money HorecaOS did not move.
     *
    ...
    /**
     * Records that something outside HorecaOS corroborated — or contradicted — an
     * attestation.
     *
