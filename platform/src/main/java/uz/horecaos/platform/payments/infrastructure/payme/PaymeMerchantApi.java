 ...
 *
 * <p>Payme is the JSON-RPC client and HorecaOS is the server. Nothing HorecaOS sends
 ...
 * Payme's creation moment, never HorecaOS's. Payme's Java template measures from the
...
public class PaymeMerchantApi {
    ...
    private Map<String, Object> cancelTransaction(ProviderBinding binding, JsonNode params) {
        ...
        return switch (stateOf(attempt)) {
            ...
            case PERFORMED -> {
                ...
                // REFUND rather than REVERSE. REVERSE names a reversal HorecaOS
     ...
     * "retain the evidence" means the money moves, the receipt is issued, and HorecaOS
     ...
     * {@code LOCAL:{uuid}}, matching the background sweep. An expiry is HorecaOS's own
