 ...
 *                           HorecaOS stored. Identity runs the other way on Click
 ...
 *                           the field {@code GetStatement} filters on. Not HorecaOS's
...
public record PaymeTransactionView(
     ...
     * the sole receiver on every HorecaOS payment, and the docs say it may be omitted
     * in that case.
     */
