...
public class OrderSettlementService {
     ...
     * when an order ends, and that is a record of HorecaOS's expectation rather than
     ...
     * {@link uz.horecaos.platform.ordering.api.OrderSettlementPort#recordTerminalOutcome},
