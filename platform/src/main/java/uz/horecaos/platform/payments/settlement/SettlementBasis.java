...
/**
 * Who actually moved the money a remedy records — and therefore whether HorecaOS
 * can prove it moved.
 *
 * <p>This column is the whole point of the amended design. HorecaOS does not call
 ...
 * HorecaOS performed that, in its own ledger, and can prove it — while the 82 000
 * is a person saying they pressed a button in a cabinet HorecaOS cannot see.
 */
public enum SettlementBasis {

    /**
     * A person asserts the money moved. Nothing in HorecaOS observed it.
     *
    ...
    /**
     * HorecaOS performed the movement itself and the evidence is its own ledger.
     *
