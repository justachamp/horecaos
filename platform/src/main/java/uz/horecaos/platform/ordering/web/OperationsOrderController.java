...
public class OperationsOrderController {
    ...
    @Operation(
            ...
            description = "orders.md §2.4 (ADR 0102): the board's filter set, every predicate "
                    ...
                    + "by an aggregator's or a POS's own identifier (ADR 0040) — it is a filter, "
                    + "not the tenant-wide search of orders.md §2.8, which needs an endpoint at "
                    + "its own scope: nothing here reaches past this location. Keyset-paginated "
