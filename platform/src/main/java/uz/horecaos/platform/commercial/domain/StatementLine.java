 ...
 *
 * <p>{@code kind} is {@code PLAN}, {@code MODULE}, {@code OVERAGE}, or
 * {@code EARLY_EXIT} for the term discount repaid when a subscription ends
 * before its term does (ADR 0093); {@code DEPOSIT} survives on statements
 * issued before the deposit moved to the wallet.
...
public record StatementLine(
    ...
    public static final String EARLY_EXIT = "EARLY_EXIT";
