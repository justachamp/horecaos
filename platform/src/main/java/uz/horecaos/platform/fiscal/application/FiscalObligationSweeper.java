...
public class FiscalObligationSweeper {
     ...
     */
    @Scheduled(
            initialDelayString = "${horecaos.fiscal.obligation-opener.initial-delay:PT20S}",
            fixedDelayString = "${horecaos.fiscal.obligation-opener.interval:PT1M}")
     ...
     */
    @Scheduled(
            initialDelayString = "${horecaos.fiscal.obligation-opener.submit-initial-delay:PT40S}",
            fixedDelayString = "${horecaos.fiscal.obligation-opener.submit-interval:PT1M}")
