...
public class SseStreamRegistry {
    ...
    public SseStreamRegistry(ObjectMapper json, Clock clock, MeterRegistry meters, List<SnapshotSource> sources) {
        ...
        this.refusedTenantShare = Counter.builder("horecaos.realtime.streams.refused.tenant.share")
                .description("Refused connects that were a tenant past its ADR 0045 share, "
                        + "counted again here as a subset of horecaos.realtime.streams.refused")
                .register(meters);
        this.coalescedSignals = Counter.builder("horecaos.realtime.signals.coalesced")
