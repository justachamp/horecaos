...
import uz.horecaos.platform.pos.domain.SyncDifference.Severity;

/**
 * Compares a staged provider snapshot against what HorecaOS holds (ADR 0012).
 *
 ...
 *   <li><b>A HorecaOS-authoritative field never produces an applicable action.</b>
...
public final class DifferenceEngine {
    ...
    /**
     * Entities HorecaOS has mapped that the provider did not send.
     *
    ...
    private SyncDifference removal(
        ...
        return new SyncDifference(
                ...
                // never physically deletes a HorecaOS product, so the strongest
    ...
    private void compareField(
        ...
        DifferenceCategory category = authority == FieldAuthority.HORECAOS
    ...
    /** What HorecaOS holds for the entities this binding has mapped. */
    public record TargetCatalog(Map<EntityType, Map<String, Entity>> byType) {
         ...
         *                overwritten
         */
        public record Entity(UUID horecaosId, int version, Map<String, String> fields) {
