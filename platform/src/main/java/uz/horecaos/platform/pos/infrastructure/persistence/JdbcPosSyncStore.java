...
public class JdbcPosSyncStore {
    ...
    public void recordFindings(
        ...
        for (SyncDifference difference : differences) {
            ...
            parameters.put("horecaosId", difference.horecaosEntityId());
        ...
        insertRows(
                ...
                VALUES """,
                "(:id, :tenantId, :runId, :entityType, :externalId, :horecaosId, "
    ...
    public List<SyncDifference> differences(UUID tenantId, UUID runId, int limit, int offset) {
        return jdbc.sql("""
                SELECT entity_type, external_entity_id, horecaos_entity_id, category, field_path,
