 ...
 * right now, and {@link uz.horecaos.platform.migration.api.MigrationOwnershipPort}
 * is the only way to ask it.
 *
 * <p>Three groups of type live here, and each is here because another module has
 * to reach it.
 *
 * <p>{@link uz.horecaos.platform.migration.api.ImportContext},
 * {@link uz.horecaos.platform.migration.api.ExternalEffect} and
 * {@link uz.horecaos.platform.migration.api.ImportSuppression} are read by every
 ...
 *
 * <p>{@link uz.horecaos.platform.migration.api.ImportPort} and the types it needs —
 * {@link uz.horecaos.platform.migration.api.ExtractionSpec},
 * {@link uz.horecaos.platform.migration.api.LegacyRecord},
 * {@link uz.horecaos.platform.migration.api.Transformation},
 * {@link uz.horecaos.platform.migration.api.TransformationOutcome} — are
 ...
 *
 * <p>{@link uz.horecaos.platform.migration.api.MigrationCapability} lives here and
 ...
 * {@link uz.horecaos.platform.migration.api.CapabilityOwnership} through its
