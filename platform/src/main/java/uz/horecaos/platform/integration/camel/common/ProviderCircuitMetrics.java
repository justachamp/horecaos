...
public final class ProviderCircuitMetrics {
    ...
    private static void bindBreaker(
        ...
        Gauge.builder("horecaos.provider.circuit.open.duration", openSince, OpenSince::seconds)
        ...
        Gauge.builder("horecaos.provider.circuit.state", breaker, ProviderCircuitMetrics::stateValue)
