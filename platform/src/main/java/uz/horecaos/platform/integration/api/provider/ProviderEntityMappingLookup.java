...
public interface ProviderEntityMappingLookup {
    ...
    Optional<String> externalIdFor(UUID bindingId, String entityType, UUID horecaosEntityId);

    Optional<UUID> horecaosIdFor(UUID bindingId, String entityType, String externalId);
}
