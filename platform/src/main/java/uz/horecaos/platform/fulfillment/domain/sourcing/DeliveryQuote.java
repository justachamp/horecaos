 ...
 *
 * @param requestId          HorecaOS's own id for the ask, not the partner's.
 ...
 *                           guarantee or a TTL HorecaOS imposed. Today every
...
public record DeliveryQuote(
    ...
    public String validitySource() {
        return partnerSuppliedExpiry ? "PARTNER" : "HORECAOS_POLICY";
    }
