...
-- The list below re-states V0103's digest classes and V0104's trigger
-- classes alongside the one value this migration adds. Each recreation of
-- this constraint replaces the whole list, so a migration enumerating only
-- what its own worktree knew about would silently revoke its siblings'
-- values — V0103, V0104 and this file were written in parallel worktrees
