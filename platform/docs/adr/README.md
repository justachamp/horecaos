...
| **Partial** — Some of it exists. Each record's status line names what does not. | 57 | [`partial/`](partial/) |
| **Not started** — Decided and not begun. | 6 | [`not-started/`](not-started/) |
