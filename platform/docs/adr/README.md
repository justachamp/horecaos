...
| **Partial** — Some of it exists. Each record's status line names what does not. | 68 | [`partial/`](partial/) |
| **Not started** — Decided and not begun. | 10 | [`not-started/`](not-started/) |
...
| [0135](partial/0135-object-storage-runtime-rustfs-replaces-minio.md) | Object storage runtime: RustFS replaces MinIO | Accepted | Partial |
...
| A9 | [0135](partial/0135-object-storage-runtime-rustfs-replaces-minio.md) | Same slot as 0034: MinIO's public images were withdrawn 2026-09-25, so the S3-compatible runtime 0034/0010 assume has to be RustFS before any of Track A's later dependents can build against it |
