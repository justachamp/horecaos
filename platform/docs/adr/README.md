...
| **Partial** — Some of it exists. Each record's status line names what does not. | 43 | [`partial/`](partial/) |
...
**Not started** — [0022](not-started/0022-frontend-platform-authentication-and-journey-migration.md), [0056](not-started/0056-tenant-isolation-enforcement-and-rls.md), [0061](not-started/0061-production-deployment-pilot-on-owned-hardware-portable-by-construction.md)
