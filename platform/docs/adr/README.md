...
|---|---|---|
| **Built** — A real operator could use the whole feature today. | 11 | [`built/`](built/) |
...
**Not started** — [0022](not-started/0022-frontend-platform-authentication-and-journey-migration.md), [0053](not-started/0053-horecaos-identity-and-rebrand.md)
