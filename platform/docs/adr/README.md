...
| **Partial** — Some of it exists. Each record's status line names what does not. | 64 | [`partial/`](partial/) |
| **Not started** — Decided and not begun. | 9 | [`not-started/`](not-started/) |
