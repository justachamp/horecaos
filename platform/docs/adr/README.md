...
|---|---|---|
| **Built** — A real operator could use the whole feature today. | 16 | [`built/`](built/) |
| **Partial** — Some of it exists. Each record's status line names what does not. | 47 | [`partial/`](partial/) |
