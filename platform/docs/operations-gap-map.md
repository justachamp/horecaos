...
|---|---|---|---|---|---|
| **P** — pilot | 56 | 65 | 29 | 1 | **151** |
| **2** — parity | 28 | 37 | 32 | 3 | **100** |
| **3** — tail | 2 | 14 | 12 | 2 | **30** |
| **?** — no IA row | 1 | 2 | 4 | 0 | **7** |
| **Total** | **87** | **118** | **77** | **6** | **288** |
...
87 rows of 288 are finished. The pilot tier alone carries 94 rows that are neither
built nor blocked, and **65 of them are PARTIAL** — a real screen against a real endpoint
...
40 rows — 10 built · 16 partial · 14 not built
...
25 rows — 9 built · 6 partial · 8 not built · 2 blocked
...
15 rows — 3 built · 2 partial · 9 not built · 1 blocked
...
39 rows — 4 built · 14 partial · 21 not built
...
20 rows — 7 built · 7 partial · 6 not built
