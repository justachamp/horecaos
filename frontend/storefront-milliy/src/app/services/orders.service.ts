...
export class OrdersService {
   ...
   * application's, and lives in `OrdersComponent`. Nothing here inspects the
   * menu: the platform already did, against the location and channel this order
   * was placed on, including the 86 list a storefront cannot see.
   */
