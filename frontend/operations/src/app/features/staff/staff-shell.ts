 ...
 * **Должности** (§5) and, new this wave, **Активность** (IA 9.3 Activity &
 * audit) — the same "a shell wrapping otherwise-unrelated screens" shape
 * `settings-shell.ts` already establishes for this app, needed here because
 * neither Должности nor Активность should render docked beside the Люди
