...
export const messagesEn = {
  ...
  'shell.callBar.ringing': 'Ringing',
  'shell.callBar.claim': 'Answer',
  'shell.callBar.open': 'Open call centre',
  'shell.callBar.startOrder': 'Start order',
  'support.banner.view': 'HorecaOS support · view only',
  'support.banner.assist': 'HorecaOS support · assisting',
  ...
  'settings.supportVisits.lapsedAt': 'Ran out at {time}',
  'settings.supportVisits.end': 'End this visit',
  ...
  'reservations.detail.guestName': 'Guest name',
  'reservations.detail.guestPhone': 'Phone',
  'reservations.detail.guestNote': 'Note',
  'reservations.detail.revealGuest': 'Show guest details',
  'reservations.detail.revealing': 'Loading…',
  'reservations.detail.guestRevealError': 'Could not load the guest’s details',
  ...
  'reservations.action.complete': 'Mark completed',
  'reservations.action.seat': 'Seat this booking',
  'reservations.seat.title': 'Seat this booking',
  'reservations.seat.confirm': 'Seat',
  'reservations.form.title': 'New booking',
  'reservations.form.editTitle': 'Edit booking',
  'reservations.form.editHint':
    'Leave the guest’s name, phone or note blank to keep what is already on the booking — only fill one in to correct it.',
  ...
  'orders.action.override.PREPARING': 'Send back to kitchen',
  'orders.action.override.READY': 'Send back to ready',
  'orders.action.override.generic': '↩ {status}',
  'orders.action.override.confirm': 'Confirm',
  ...
  'orders.dialog.complete.title': 'Complete order',
  'orders.dialog.override.title': 'Move order back to {status}',
  ...
  'orders.dialog.outcome.stockDisposition.NO_EFFECT': 'No stock effect',
  'orders.dialog.outcome.liabilityParty.TENANT': 'At the branch’s cost',
  'orders.dialog.outcome.liabilityParty.CUSTOMER': 'At the customer’s cost',
  'orders.dialog.outcome.liabilityParty.COURIER_PARTNER': 'At the delivery service’s cost',
  'orders.dialog.outcome.liabilityParty.PLATFORM': 'At the platform’s cost',
  'orders.dialog.outcome.customerRefund.FULL': 'Full refund',
  'orders.dialog.outcome.customerRefund.NONE': 'No refund',
  'orders.dialog.outcome.customerRefund.DISCRETIONARY': 'Refund at discretion',
  ...
  'orders.detail.money.deliveryCustomer': 'Delivery (charged to customer)',
  ...
  'orders.detail.timeline.kitchen.FIRED': 'Fired',
  'orders.detail.timeline.kitchen.IN_PRODUCTION': 'In production',
  'orders.detail.timeline.kitchen.READY': 'Ready',
  'orders.detail.timeline.kitchen.HANDED_OVER': 'Handed over',
  'orders.detail.timeline.kitchen.HELD': 'Held',
  'orders.detail.timeline.kitchen.VOIDED': 'Voided',
  'orders.detail.timeline.delivery.ASSIGNED': 'Assigned',
  'orders.detail.timeline.delivery.PICKED_UP': 'Picked up',
  'orders.detail.timeline.delivery.DELIVERED': 'Delivered',
  'orders.detail.timeline.decisions.title': 'Other decisions on this order',
  ...
  'orders.detail.outcome.category': 'Reason',
  'orders.detail.outcome.stockDisposition': 'Stock',
  'orders.detail.outcome.liabilityParty': 'Liable party',
  'orders.detail.outcome.customerRefund': 'Refund',
  'orders.detail.outcome.occurredAt': 'When',
  'orders.detail.outcome.kind.COMPLETED': 'Completed',
  'orders.detail.outcome.kind.CANCELLED': 'Cancelled',
  'orders.detail.outcome.kind.REJECTED': 'Rejected',
  'orders.detail.outcome.kind.EXPIRED': 'Expired',
  'orders.detail.outcome.category.CUSTOMER_CANCELLED': 'Customer cancelled',
  'orders.detail.outcome.category.CUSTOMER_UNREACHABLE': 'Could not reach the customer',
  'orders.detail.outcome.category.CUSTOMER_NO_SHOW': 'Customer did not show up',
  'orders.detail.outcome.category.RESTAURANT_REFUSED': 'Restaurant refused',
  'orders.detail.outcome.category.ITEM_UNAVAILABLE': 'Item unavailable',
  'orders.detail.outcome.category.KITCHEN_CAPACITY': 'Kitchen at capacity',
  'orders.detail.outcome.category.DELIVERY_FAILED': 'Delivery failed',
  'orders.detail.outcome.category.COURIER_UNAVAILABLE': 'No courier available',
  'orders.detail.outcome.category.ADDRESS_UNSERVICEABLE': 'Address not serviceable',
  'orders.detail.outcome.category.PAYMENT_NOT_RECEIVED': 'Payment not received',
  'orders.detail.outcome.category.DUPLICATE_ORDER': 'Duplicate order',
  'orders.detail.outcome.category.TEST_ORDER': 'Test order',
  'orders.detail.outcome.category.SUSPECTED_FRAUD': 'Suspected fraud',
  'orders.detail.outcome.category.PRICING_ERROR': 'Pricing error',
  'orders.detail.outcome.category.DELIVERED_OWN_COURIER': 'Delivered by our own courier',
  'orders.detail.outcome.category.DELIVERED_PARTNER_COURIER': 'Delivered by a partner service',
  'orders.detail.outcome.category.COLLECTED_BY_CUSTOMER': 'Collected by the customer',
  'orders.detail.outcome.category.SERVED_IN_HOUSE': 'Served in the dining room',
  'orders.detail.outcome.category.APPROVAL_DEADLINE_LAPSED': 'Nobody responded in time',
  'orders.detail.outcome.category.OTHER': 'Other',

  'orders.detail.section.details': 'Order details',
  'orders.detail.details.acceptanceMode': 'Acceptance mode',
  'orders.detail.details.kitchenNote': 'Note to the kitchen',
  'orders.detail.details.kitchenNote.none': 'No note',
  'orders.detail.details.callback': 'Callback',
  'orders.detail.details.callback.none': 'Not requested',
  'orders.detail.details.callback.outstanding': 'Requested — not yet resolved',
  ...
  'orders.detail.revisions.error': 'The revisions could not be loaded',
  'orders.detail.revisions.column.revision': '#',
  'orders.detail.revisions.column.source': 'Source',
  'orders.detail.revisions.column.total': 'Total',
  'orders.detail.revisions.column.delta': 'Change',
  'orders.detail.revisions.column.createdAt': 'When',

  'orders.detail.section.attribution': 'Attribution',
  'orders.detail.attribution.createdBy': 'Created by',
  'orders.detail.attribution.acceptedBy': 'Accepted by',
  'orders.detail.attribution.notYetAccepted': 'Not yet accepted',

  'orders.detail.section.handover': 'Handover code',
  'orders.detail.handover.type': 'Proof type',
  'orders.detail.handover.statusLabel': 'Status',
  'orders.detail.handover.attemptsRemaining': 'Attempts remaining',
  'orders.detail.handover.error': 'The handover state could not be loaded',
  'orders.detail.handover.none': 'No handover challenge on this order',
  'orders.detail.handover.type.CODE': 'Code',
  'orders.detail.handover.type.QR': 'QR code',
  'orders.detail.handover.type.SIGNATURE': 'Signature',
  'orders.detail.handover.type.NONE': 'Not required',
  'orders.detail.handover.status.PENDING': 'Awaiting verification',
  'orders.detail.handover.status.VERIFIED': 'Verified',
  'orders.detail.handover.status.BYPASSED': 'Overridden by a supervisor',
  'orders.detail.handover.status.FAILED': 'Attempts exhausted',
  'orders.detail.handover.status.EXPIRED': 'Expired',
  'orders.detail.handover.codeLabel': 'Code',
  'orders.detail.handover.verify': 'Verify',
  'orders.detail.handover.verified': 'Verified.',
  'orders.detail.handover.wrongCode': 'Wrong code — {attemptsRemaining} attempts left.',
  'orders.detail.handover.bypassOpen': 'Override verification',
  ...
  'orders.queue.filter.paymentStatus.label': 'Payment status',
  'orders.queue.filter.paymentStatus.all': 'Any status',
  'orders.queue.filter.paymentStatus.NOT_REQUIRED': 'Not required',
  'orders.queue.filter.origin.label': 'Source',
  'orders.queue.filter.origin.all': 'All sources',
  'orders.queue.filter.origin.HORECAOS': 'Own channels',
  ...
  'settings.brandProfile.field.country': 'Country',
  'settings.brandProfile.field.currency': 'Currency',
  'settings.brandProfile.field.timezone': 'Timezone',
  ...
  'settings.brandProfile.field.logo': 'Logo',
  'settings.brandProfile.field.banner': 'Aggregator/QR banner',
  ...
  'settings.salesChannels.field.locationCount': 'Branches',
  'settings.salesChannels.field.paymentMethodCount': 'Payment methods',
  'settings.salesChannels.field.fulfillmentModes': 'Fulfilment types',
  'settings.salesChannels.field.pricePlane': 'Prices from',
  'settings.salesChannels.field.pricePlane.own': 'own',
  'settings.salesChannels.field.externallyPriced': 'Partner sets price',
  'settings.salesChannels.field.guestOrdersAllowed': 'Guest orders',
  'settings.salesChannels.field.installation': 'Connection',
  'settings.salesChannels.field.installation.none': '—',
  'settings.salesChannels.field.icon': 'Icon',
  ...
  'settings.salesChannels.field.socialLinks': 'Social links',
  ...
  'settings.salesChannels.deactivate.action': 'Suspend',
  'settings.salesChannels.reactivate.action': 'Resume',
  'settings.salesChannels.setup.action': 'Setup',
  'settings.salesChannels.edit.action': 'Edit',
  'settings.salesChannels.edit.save': 'Save',
  'settings.salesChannels.edit.locations': 'Which branches sell here',
  'settings.salesChannels.filter.allTypes': 'All types',
  'settings.salesChannels.filter.allStatuses': 'All statuses',
  'settings.salesChannels.filter.onlyProblems': 'Only with problems',
  'settings.salesChannels.matrix.paymentMethods': 'Payment methods × channel',
  'settings.salesChannels.matrix.fulfillmentModes': 'Fulfilment types × channel',
  'settings.salesChannels.matrix.lastMethodConfirm':
    '"{name}" will have no payment methods left — placing an order through it will be impossible. Continue?',
  'settings.salesChannels.matrix.unavailableHint':
    'This method needs a fiscal-capable terminal at one of this channel’s branches, and none is bound yet.',
  'settings.salesChannels.empty': 'No sales channels yet.',

  // 10.5 Channel setup
  'settings.channelSetup.back': '← Channels',
  'settings.channelSetup.title': 'Setup — {name}',
  'settings.channelSetup.notFound': 'Not found.',
  'settings.channelSetup.status.configured': 'Configured',
  'settings.channelSetup.status.notConfigured': 'Not configured',
  'settings.channelSetup.noFacets': 'No setup for this type yet.',
  'settings.channelSetup.telegram.title': 'Telegram bot',
  'settings.channelSetup.hostname.title': 'Web address',
  'settings.channelSetup.hostname.verified': 'verified',
  'settings.channelSetup.hostname.unverified': 'not verified',
  'settings.channelSetup.hostname.markVerified': 'Mark verified',
  'settings.channelSetup.hostname.release': 'Release',
  'settings.channelSetup.hostname.subdomain.label': 'Free address',
  ...
  'settings.channelSetup.presentation.ogImage': 'Preview image',
  'settings.channelSetup.presentation.save': 'Save',
  'settings.channelSetup.pages.title': 'Pages',
  'settings.channelSetup.pages.published': 'Published v{version}',
  'settings.channelSetup.pages.edit': 'Edit',
  'settings.channelSetup.pages.publish': 'Publish',
  'settings.channelSetup.pages.cancel': 'Cancel',
  'settings.channelSetup.pages.slug.about': 'About',
  'settings.channelSetup.pages.slug.contacts': 'Contacts',
  'settings.channelSetup.pages.slug.deliveryTerms': 'Delivery terms',
  'settings.channelSetup.pages.slug.privacyOffer': 'Privacy / offer',
  'settings.channelSetup.dineIn.title': 'QR dine-in mode',
  'settings.channelSetup.dineIn.edit': 'Open branch →',
  'settings.channelSetup.kiosk.title': 'Kiosk pairing',
  'settings.channelSetup.kiosk.locked': 'Not built yet.',

  // 10.6 Payment methods
  'settings.paymentMethods.title': 'Payment methods',
  'settings.paymentMethods.lead':
    'The tenant-owned registry every channel’s payment matrix reads from — nothing can be offered on a channel until it is registered here.',
  'settings.paymentMethods.field.code': 'Code',
  'settings.paymentMethods.field.displayName': 'Name',
  'settings.paymentMethods.field.responsibility': 'Base type',
  'settings.paymentMethods.field.icon': 'Icon',
  'settings.paymentMethods.field.sortOrder': 'Order',
  'settings.paymentMethods.field.installation': 'Acquirer installation',
  'settings.paymentMethods.field.installation.none': 'Not bound',
  'settings.paymentMethods.field.contractReference': 'Contract reference',
  'settings.paymentMethods.field.localizedNames': 'Name per language',
  'settings.paymentMethods.field.status': 'Status',
  'settings.paymentMethods.field.actions': 'Actions',
  'settings.paymentMethods.responsibility.PARTNER': 'Partner (provider settles)',
  'settings.paymentMethods.responsibility.TERMINAL': 'Terminal (fiscal equipment settles)',
  'settings.paymentMethods.responsibility.MARKETPLACE': 'Marketplace (aggregator collected)',
  'settings.paymentMethods.responsibility.OPERATOR': 'Operator (cash drawer)',
  'settings.paymentMethods.create.action': 'Add payment method',
  'settings.paymentMethods.create.cancel': 'Cancel',
  'settings.paymentMethods.create.submit': 'Create',
  'settings.paymentMethods.create.submitting': 'Creating…',
  'settings.paymentMethods.action.save': 'Save',
  'settings.paymentMethods.action.activate': 'Activate',
  'settings.paymentMethods.action.disable': 'Disable',
  'settings.paymentMethods.empty': 'No payment methods registered yet.',
  ...
  'settings.fiscalization.entities.suspend': 'Suspend',
  'settings.fiscalization.entities.archive': 'Archive',
  'settings.fiscalization.entities.edit': 'Edit',
  'settings.fiscalization.entities.edit.submit': 'Save',
  'settings.fiscalization.entities.edit.submitting': 'Saving…',
  'settings.fiscalization.field.code': 'Code',
  'settings.fiscalization.field.legalName': 'Legal name',
  'settings.fiscalization.field.shortName': 'Short name',
  'settings.fiscalization.field.tin': 'TIN',
  'settings.fiscalization.field.vatRegistered': 'VAT registered',
  'settings.fiscalization.field.vatCertificateReference': 'VAT certificate reference',
  'settings.fiscalization.field.taxProfileId': 'Tax profile',
  'settings.fiscalization.field.registeredAddress': 'Registered address',
  'settings.fiscalization.field.contactPhone': 'Contact phone',
  ...
  'settings.fiscalization.assignment.empty':
    'No fiscal assignments recorded for this location yet.',
  ...
  'settings.fiscalization.assignment.effectiveUntil': 'Effective until',
  'settings.fiscalization.assignment.approvedBy': 'Approved by',
  'settings.fiscalization.assignment.submit': 'Assign',
  'settings.fiscalization.assignment.submitting': 'Assigning…',

  'settings.fiscalization.terminals.title': 'Fiscal terminals',
  'settings.fiscalization.terminals.empty': 'No fiscal terminals registered yet.',
  'settings.fiscalization.terminals.register.action': 'Register terminal',
  'settings.fiscalization.terminals.register.submit': 'Register',
  'settings.fiscalization.terminals.register.submitting': 'Registering…',
  'settings.fiscalization.terminals.field.kind': 'Kind',
  'settings.fiscalization.terminals.field.legalEntity': 'Legal entity',
  'settings.fiscalization.terminals.field.reference': 'Reference',
  'settings.fiscalization.terminals.field.issuesReceipts': 'Can issue fiscal receipts',
  'settings.fiscalization.terminals.field.providerBinding': 'Provider binding ID',
  'settings.fiscalization.terminals.field.providerBinding.hint':
    'A terminal cannot claim it can issue receipts without a provider binding.',
  'settings.fiscalization.terminals.field.health': 'Connection',
  'settings.fiscalization.terminals.kind.POS': 'POS',
  'settings.fiscalization.terminals.kind.COURIER_TERMINAL': 'Courier terminal',
  'settings.fiscalization.terminals.kind.KIOSK': 'Kiosk',
  'settings.fiscalization.terminals.kind.VIRTUAL': 'Virtual',
  'settings.fiscalization.terminals.health.healthy': 'Connected',
  'settings.fiscalization.terminals.health.unhealthy': 'Failing',
  'settings.fiscalization.terminals.health.never': 'Never checked',
  'settings.fiscalization.terminals.checkConnection': 'Check connection',
  'settings.fiscalization.terminals.suspend': 'Disable',
  'settings.fiscalization.terminals.reactivate': 'Reactivate',
  'settings.fiscalization.terminals.retire': 'Retire',

  'settings.fiscalization.classification.title': 'Product classification',
  ...
  'settings.fiscalization.classification.field.locations': 'Locations',
  'settings.fiscalization.classification.nodeType.VARIANT': 'Dish',
  'settings.fiscalization.classification.nodeType.MODIFIER_OPTION': 'Modifier',
  'settings.fiscalization.classification.nodeType.FEE': 'Fee',
  'settings.fiscalization.classification.deliveryFee.name': 'Delivery fee',
  'settings.fiscalization.classification.deliveryFee.warning':
    'The delivery fee has no fiscal classification — the one item people forget. A brand cannot charge delivery through a channel that fiscalizes without it.',
  'settings.fiscalization.classification.deliveryFee.action': 'Classify delivery fee',
  'settings.fiscalization.classification.deliveryFee.mxik': 'ИКПУ / MXIK code',
  ...
  'settings.notifications.versions.column.locales': 'Locales',
  'settings.notifications.versions.column.moderation': 'Moderation',
  'settings.notifications.versions.column.approvedBy': 'Approved by',
  'settings.notifications.moderation.NOT_REQUIRED': 'Not required',
  ...
  'settings.notifications.editor.saved.warning':
    'Saved as version {version} — but withheld from sending until the SMS gateway approves it (see the moderation column).',
  'settings.notifications.editor.saved.ok': 'Saved as version {version}.',
  'settings.notifications.editor.channelUnwired':
    'This channel has no adapter yet: a version saved here can never actually be sent.',
  'settings.notifications.editor.locale.incomplete':
    'ru, uz-Latn and en all need text before this version can be saved.',
  'settings.notifications.testSend.title': 'Send a test message',
  'settings.notifications.testSend.destination': 'Phone number',
  'settings.notifications.testSend.locale': 'Locale',
  'settings.notifications.testSend.submit': 'Send',
  'settings.notifications.testSend.sending': 'Sending…',
  ...
  'settings.notifications.routing.column.scope': 'Scope',
  'settings.notifications.routing.column.events': 'Event classes',
  'settings.notifications.routing.status.ACTIVE': 'Active',
  'settings.notifications.routing.status.retired': 'Unbound ({reason})',
  ...
  'settings.locations.field.sortOrder': 'Sort order',
  'settings.locations.field.seats': 'Seats',
  'settings.locations.field.averageCheque': 'Average cheque',
  'settings.locations.field.averageChequeCurrency': 'Currency',
  'settings.locations.field.hasParking': 'Parking',
  'settings.locations.field.hasPlayground': 'Playground',
  'settings.locations.field.virtualTourUrl': 'Virtual tour link',
  'settings.locations.field.yes': 'Yes',
  'settings.locations.field.no': 'No',
  'settings.locations.venue.title': 'Venue',
  ...
  'settings.locations.list.bulk.outcome.problem.VALIDATION_FAILED': 'Rejected as invalid',
  'settings.locations.list.bulk.outcome.problem.LOCATION_NOT_IN_BRAND': 'Not part of this brand',
  'settings.locations.list.bulk.outcome.problem.UNEXPECTED_FAILURE': 'Something went wrong',
  ...
  'finance.payments.lookup.byNumber.label': 'Order number',
  'finance.payments.lookup.byNumber.placeholder': 'e.g. 0007',
  'finance.payments.lookup.byNumber.action': 'Find',
  'finance.payments.lookup.byNumber.searching': 'Searching…',
  'finance.payments.lookup.byNumber.empty': 'No order found with that number.',
  'finance.payments.lookup.byNumber.multiple': 'More than one order carries this number. Pick one:',
  'finance.payments.lookup.byNumber.pick': 'Use this order',
  ...
  'finance.payments.tenders.title': 'Tenders',
  'finance.payments.tenders.sequence': '#',
  'finance.payments.tenders.method': 'Method',
  'finance.payments.tenders.amount': 'Amount',
  'finance.payments.tenders.status': 'Status',
  'finance.payments.tenders.refunded': 'Refunded',
  'finance.payments.tenders.empty': 'No settlement recorded for this order yet.',
  'finance.tenderStatus.PLANNED': 'Planned',
  'finance.tenderStatus.RESERVED': 'Reserved',
  'finance.tenderStatus.SETTLED': 'Settled',
  'finance.tenderStatus.RELEASED': 'Released',
  'finance.tenderStatus.REVERSED': 'Reversed',
  'finance.tenderStatus.FAILED': 'Failed',
  ...
  'finance.payments.remedy.reasonCode.placeholder': 'Choose a reason',
  ...
  'finance.payments.remedy.discount.appliesTo.label': 'Applies to',
  'finance.payments.remedy.discount.benefit.label': 'Value',
  'finance.payments.remedy.discount.percent.label': 'Percent (basis points, e.g. 1000 = 10%)',
  'finance.payments.remedy.discount.maximum.label': 'Maximum per use ({currency})',
  'finance.payments.remedy.discount.amount.label': 'Amount per use ({currency})',
  'finance.payments.remedy.discount.uses.label': 'Uses',
  'finance.payments.remedy.discount.validForDays.label': 'Valid for (days)',
  ...
  'finance.paymentIntentStatus.PENDING': 'Pending',
  'finance.paymentIntentStatus.AUTHORIZING': 'Authorizing',
  'finance.paymentIntentStatus.PAID': 'Paid',
  'finance.paymentIntentStatus.CANCELLED': 'Cancelled',
  'finance.paymentIntentStatus.EXPIRED': 'Expired',
  'finance.paymentIntentStatus.FAILED': 'Failed',

  'finance.paymentAttemptStatus.INITIATED': 'Initiated',
  'finance.paymentAttemptStatus.PRESENTED': 'Presented',
  'finance.paymentAttemptStatus.RESERVED': 'Reserved',
  'finance.paymentAttemptStatus.CAPTURED': 'Captured',
  'finance.paymentAttemptStatus.CANCELLED': 'Cancelled',
  'finance.paymentAttemptStatus.EXPIRED': 'Expired',
  ...
  'finance.entitlementBenefit.PERCENT': 'Percent',
  'finance.entitlementBenefit.FIXED_AMOUNT': 'Fixed amount',

  'finance.reasonCode.CUSTOMER_CANCELLED': 'Customer asked to cancel',
  'finance.reasonCode.ITEM_MISSING': 'Item missing from the order',
  'finance.reasonCode.ITEM_QUALITY': 'Food or item quality issue',
  'finance.reasonCode.WRONG_ITEM': 'Wrong item delivered',
  'finance.reasonCode.LATE_DELIVERY': 'Delivered too late',
  'finance.reasonCode.NOT_DELIVERED': 'Order never arrived',
  'finance.reasonCode.DUPLICATE_CHARGE': 'Charged more than once',
  'finance.reasonCode.PRICING_ERROR': 'Priced or charged incorrectly',
  'finance.reasonCode.GOODWILL': 'Goodwill gesture, no fault',
  'finance.reasonCode.OTHER': 'Other (see notes)',
  ...
  'finance.fiscal.lookup.title': 'Look up an order',
  'finance.fiscal.lookup.label': 'Order number',
  'finance.fiscal.lookup.placeholder': 'e.g. 0007',
  'finance.fiscal.lookup.action': 'Find',
  'finance.fiscal.lookup.searching': 'Searching…',
  'finance.fiscal.lookup.empty': 'No order found with that number.',
  'finance.fiscal.lookup.multiple': 'More than one order carries this number. Pick one:',
  'finance.fiscal.lookup.pick': 'Show this order',
  'finance.fiscal.lookup.documents.title': 'Order {number}’s fiscal documents',
  'finance.fiscal.lookup.documents.empty': 'No fiscal documents for this order.',
  ...
  'finance.fiscal.field.reasonNote': 'Note',
  'finance.fiscal.field.attempts': 'Attempts',
  'finance.fiscal.field.evidence': 'Evidence',
  'finance.fiscal.field.submittedAt': 'Submitted at',
  'finance.fiscal.field.reportingDeadlineAt': 'Reporting deadline',
  ...
  'catalog.nav.priceBulk': 'Bulk pricing',
  'catalog.nav.taxProfile': 'VAT',
  'catalog.nav.referenceData': 'Reference data',
  'catalog.nav.autoAdd': 'Auto-add rules',

  // catalog.menuSets.* -- row 4.4a, the named Menu entity
  'catalog.menuSets.title': 'Menu sets',
  'catalog.menuSets.note':
    'A named, copyable assortment. Bind one to a branch to publish that branch from this list instead of its own offering toggles.',
  'catalog.menuSets.create.trigger': 'New menu',
  'catalog.menuSets.loading': 'Loading…',
  'catalog.menuSets.denied': 'You do not have access to menus for this brand.',
  'catalog.menuSets.empty':
    'No menus yet. Create one to start rolling an assortment out to branches.',
  'catalog.menuSets.table.name': 'Name',
  'catalog.menuSets.table.status': 'Status',
  'catalog.menuSets.copy.trigger': 'Copy',
  'catalog.menuSets.items.title': 'Items',
  'catalog.menuSets.items.empty': 'No items on this menu yet.',
  'catalog.menuSets.items.remove': 'Remove',
  'catalog.menuSets.addByFilter.title': 'Add products by filter',
  'catalog.menuSets.addByFilter.category': 'Category',
  'catalog.menuSets.addByFilter.anyCategory': 'Any category',
  'catalog.menuSets.addByFilter.search': 'Search',
  'catalog.menuSets.addByFilter.availability': 'Availability',
  'catalog.menuSets.addByFilter.submit': 'Add matching items',
  'catalog.menuSets.addByFilter.result': '{count} item(s) added or updated.',
  'catalog.menuSets.availability.AVAILABLE': 'Available',
  'catalog.menuSets.availability.UNAVAILABLE': 'Unavailable',
  'catalog.menuSets.availability.HIDDEN': 'Hidden',
  'catalog.menuSets.bindings.title': 'Bound branches',
  'catalog.menuSets.bindings.empty': 'This menu is not bound to any branch.',
  'catalog.menuSets.bindings.unbind': 'Unbind',
  'catalog.menuSets.bindings.branch': 'Branch',
  'catalog.menuSets.bindings.choose': 'Choose a branch',
  ...
  'catalog.menuSets.dialog.cancel': 'Cancel',
  'catalog.menuSets.dialog.confirm': 'Save',

  // catalog.md §4.11 (Import: Excel and POS), gap-map rows 4.5a/10.8b/X.24.
  // Excel import (4.5b) stays a separate, deferred row.
  'catalog.import.loading': 'Loading…',
  'catalog.import.binding': 'Connection',
  'catalog.import.noBindings.title': 'No POS connection yet',
  'catalog.import.noBindings.body': 'Connect a point of sale under Settings → Integrations first.',
  'catalog.import.tab.runs': 'Import runs',
  'catalog.import.tab.mapping': 'Соответствия',
  'catalog.import.start.title': 'Start an import',
  'catalog.import.start.dryRun': 'Dry run (report only, changes nothing)',
  'catalog.import.start.importLanguage': 'Compare against locale',
  'catalog.import.start.priceReImport': 'Re-import prices as reviewable (instead of ignored)',
  'catalog.import.start.action': 'Start',
  'catalog.import.start.running': 'Starting…',
  'catalog.import.runs.title': 'Run history',
  'catalog.import.runs.empty': 'No imports yet',
  'catalog.import.runs.column.started': 'Started',
  'catalog.import.runs.column.status': 'Status',
  'catalog.import.runs.column.trigger': 'Trigger',
  'catalog.import.runs.column.additions': 'Additions',
  'catalog.import.runs.column.changes': 'Changes',
  'catalog.import.runs.column.removals': 'Removals',
  'catalog.import.runs.column.conflicts': 'Conflicts',
  'catalog.import.detail.title': 'Run detail',
  'catalog.import.detail.status': 'Status',
  'catalog.import.detail.adapter': 'Adapter',
  'catalog.import.detail.received': 'Items received',
  'catalog.import.detail.lastError': 'Last error',
  'catalog.import.detail.applyItems.title': 'Per-item outcome',
  'catalog.import.detail.applyItems.empty': 'Nothing applied yet',
  ...
  'catalog.editor.photos.channel.label': 'Channel',
  'catalog.editor.photos.channel.all': 'Universal (every channel)',
  'catalog.editor.photos.channel.empty':
    'No override for this channel yet — it falls back to the universal photos.',
  'catalog.editor.photos.channel.hint': 'New photos attach to the channel selected above.',
  ...
  'catalog.editor.recommendations.column.eligible': 'Eligible here',
  'catalog.editor.recommendations.eligible.yes': 'Yes — shown to customers',
  'catalog.editor.recommendations.eligible.no':
    'Not yet — stopped, unpublished, or not offered here',
  ...
  'catalog.publication.finding.open': 'Open product',
  ...
  'catalog.publication.channel.hash': 'Hash',
  'catalog.publication.channel.lastPublished': 'Last published',
  'catalog.publication.channel.draftMatches': 'Up to date',
  'catalog.publication.channel.draftDiffers': 'Draft differs',
  ...
  'catalog.priceList.assign.title': 'Assign “{name}”',
  'catalog.priceList.assign.scope.brand': 'Whole brand',
  'catalog.priceList.assign.scope.location': 'One branch',
  'catalog.priceList.assign.scope.channel': 'One channel',
  'catalog.priceList.assign.target': 'Target',
  'catalog.priceList.assign.selectTarget': 'Select…',
  'catalog.priceList.assign.priority': 'Priority',
  ...
  'catalog.taxProfile.denied': 'No access to this brand’s pricing',
  'catalog.taxProfile.jurisdictionCode': 'Jurisdiction code',
  'catalog.taxProfile.mode.inclusive': 'Inclusive',
  'catalog.taxProfile.mode.exclusive': 'Exclusive',
  'catalog.taxProfile.rate': 'Rate',
  ...
  'catalog.priceBulk.denied': 'No access to this branch’s pricing',
  'catalog.priceBulk.noPriceBook': 'No price book applies here — assign one in Prices.',
  'catalog.priceBulk.category': 'Category',
  'catalog.priceBulk.allCategories': 'All categories',
  'catalog.priceBulk.search': 'Search',
  'catalog.priceBulk.direction.increase': 'Increase',
  'catalog.priceBulk.direction.decrease': 'Decrease',
  'catalog.priceBulk.column.product': 'Product',
  'catalog.priceBulk.column.category': 'Category',
  'catalog.priceBulk.column.current': 'Current price',
  'catalog.priceBulk.column.new': 'New price',
  'catalog.priceBulk.column.status': 'Status',
  'catalog.priceBulk.preview': 'Preview (dry run)',
  'catalog.priceBulk.previewing': 'Previewing…',
  'catalog.priceBulk.apply': 'Apply',
  'catalog.priceBulk.applying': 'Applying…',
  'catalog.priceBulk.previewSummary': '{applied}/{total} would apply, {failed} would fail',
  'catalog.priceBulk.applySummary': '{applied}/{total} applied, {failed} failed',
  'catalog.priceBulk.status.wouldApply': 'Would apply',
  ...
  'kitchen.stopList.bulk.reason.outOfStock': 'Out of stock',
  ...
  'couriers.action.adjust': 'Record adjustment',
  ...
  'couriers.adjust.title': 'Record an adjustment for {reference}',
  'couriers.adjust.reasonCode': 'Reason',
  'couriers.adjust.amount': 'Amount (minor units)',
  'couriers.adjust.currency': 'Currency',
  'couriers.adjust.reason': 'Note (why)',
  'couriers.adjust.submit': 'Record',
  'couriers.dialog.cancel': 'Cancel',
  'couriers.column.vehicleClass': 'Vehicle',
  'couriers.action.open': 'Open',
  'couriers.vehicleClass.FOOT': 'On foot',
  'couriers.vehicleClass.BICYCLE': 'Bicycle',
  'couriers.vehicleClass.SCOOTER': 'Scooter',
  'couriers.vehicleClass.MOTORCYCLE': 'Motorcycle',
  'couriers.vehicleClass.CAR': 'Car',
  'couriers.detail.title': '{reference}',
  'couriers.detail.loading': 'Opening the courier',
  'couriers.detail.close': 'Close',
  'couriers.compliance.heading': 'Compliance file',
  'couriers.compliance.optional': 'Every field is optional and may be filed later.',
  'couriers.compliance.editHeading': 'Record or correct the file',
  'couriers.compliance.editHint':
    'A blank box changes nothing. Only what you type is written — the console never holds these documents, so it cannot send back the ones you did not read.',
  'couriers.compliance.onFile': 'On file',
  'couriers.compliance.missing': 'Not on file',
  'couriers.compliance.incomplete': '{count} document(s) still missing',
  'couriers.compliance.reveal': 'Show the documents',
  'couriers.compliance.hide': 'Hide the documents',
  'couriers.compliance.purpose': 'Why you need to read them',
  'couriers.compliance.purposeHint': 'Recorded against your name in the audit trail.',
  'couriers.compliance.reason': 'Reason',
  'couriers.compliance.save': 'Save the file',
  'couriers.compliance.edit': 'Record or correct the file',
  'couriers.compliance.fuelType': 'Fuel',
  'couriers.compliance.fuel.unset': 'Not stated',
  'couriers.compliance.fuel.PETROL': 'Petrol',
  'couriers.compliance.fuel.DIESEL': 'Diesel',
  'couriers.compliance.fuel.GAS': 'Gas',
  'couriers.compliance.fuel.ELECTRIC': 'Electric',
  'couriers.compliance.fuel.HYBRID': 'Hybrid',
  'couriers.compliance.fuel.NONE': 'None',
  'couriers.compliance.field.PASSPORT': 'Passport',
  'couriers.compliance.field.PINFL': 'PINFL',
  'couriers.compliance.field.DRIVING_LICENCE': 'Driving licence',
  'couriers.compliance.field.VEHICLE_REGISTRATION': 'Vehicle registration',
  'couriers.compliance.field.VEHICLE_PLATE': 'Number plate',
  'couriers.compliance.field.ADDRESS': 'Home address',
  'couriers.compliance.field.EMERGENCY_CONTACT': 'Emergency contact',
  'couriers.compliance.field.REFERRAL': 'Referred by',
  'couriers.compliance.field.NOTES': 'Remarks',
  'couriers.groups.heading': 'Groups',
  'couriers.groups.none': 'In no group',
  'couriers.groups.leave': 'Leave',
  'couriers.groups.leaveReason': 'Reason',
  'couriers.groups.leaveConfirm': 'Confirm',
  'couriers.groups.join.action': 'Add to a group',
  'couriers.groups.join.pick': 'Group',
  'couriers.groups.join.reason': 'Reason',
  'couriers.groups.join.submit': 'Add',
  'couriers.groups.create.action': 'New group',
  'couriers.groups.create.code': 'Code',
  'couriers.groups.create.displayName': 'Name',
  'couriers.groups.create.reason': 'Reason',
  'couriers.groups.create.submit': 'Create',
  'couriers.branches.heading': 'Branches',
  'couriers.branches.none': 'Bound to no branch',
  'couriers.branches.primary': 'main',
  'couriers.branches.unbind': 'Release',
  'couriers.branches.unbindReason': 'Reason',
  'couriers.branches.unbindConfirm': 'Confirm',
  'couriers.branches.bind.action': 'Bind to a branch',
  'couriers.branches.bind.pick': 'Branch',
  'couriers.branches.bind.primary': 'Main branch',
  'couriers.branches.bind.reason': 'Reason',
  'couriers.branches.bind.submit': 'Bind',
  ...
  'delivery.zones.column.name': 'Name',
  ...
  'delivery.zones.import.link': 'Bulk import',
  'delivery.zoneImport.title': 'Bulk geozone upload',
  'delivery.zoneImport.intro':
    'Upload a JSON export of legacy zone geometry. Every accepted row lands as a new DRAFT version, never activated automatically — activate it from the Zones tab once you have checked it against the source.',
  'delivery.zoneImport.loading': 'Loading',
  'delivery.zoneImport.denied': 'No access to import zones for this brand',
  'delivery.zoneImport.choose': 'Choose file',
  'delivery.zoneImport.clear': 'Clear',
  'delivery.zoneImport.parseError': 'Could not read this file as a JSON array of rows',
  'delivery.zoneImport.column.externalRef': 'Source ref',
  'delivery.zoneImport.column.code': 'Code',
  'delivery.zoneImport.column.role': 'Role',
  'delivery.zoneImport.column.outcome': 'Outcome',
  'delivery.zoneImport.column.warnings': 'Warnings',
  'delivery.zoneImport.accepted': 'Accepted (DRAFT)',
  'delivery.zoneImport.rejected': 'Rejected',
  'delivery.zoneImport.dryRun': 'Dry run',
  'delivery.zoneImport.commit': 'Import',
  'delivery.zoneImport.dryRunSummary':
    'Dry run: {accepted} of {total} rows would be accepted. Nothing was saved.',
  'delivery.zoneImport.commitSummary': 'Imported {accepted} of {total} rows as DRAFT zones.',
  ...
  'delivery.zones.draft.hint':
    'A circle around a branch. No map editor exists yet, so this is a straight-line radius. Drafting does not make it live — activate it from the version list.',
  ...
  'delivery.zones.draft.submit': 'Save draft',
  'delivery.zones.role.DELIVERY': 'Delivery',
  'delivery.zones.role.CATCHMENT': 'Catchment',
  'delivery.zones.free': 'free',
  ...
  'delivery.zones.draft.tariff': 'Tariff',
  'delivery.zones.draft.tariffNone':
    'None — fall through to the branch tariff, then the brand default',
  'delivery.zones.draft.tariffHint':
    'A zone tariff outranks the branch binding and the brand default. A zone bound to a tariff that charges nothing is a free geozone.',
  'delivery.zones.draft.catchmentHint':
    'A catchment zone carries no tariff and no thresholds — it decides candidacy, never price.',
  'delivery.zones.activate.action': 'Activate',
  'delivery.zones.deactivate.action': 'Deactivate',
  'delivery.zones.bind.action': 'Bind branch',
  'delivery.zones.bind.title': 'Bind this zone to a branch',
  'delivery.zones.bind.branch': 'Branch',
  'delivery.zones.bind.submit': 'Bind',
  'delivery.zones.unbind.action': 'Unbind',
  'delivery.zones.detail.free': 'Delivery in this zone is free',
  'delivery.zones.detail.branches': 'Branches this zone applies to',
  'delivery.zones.detail.noBranches': 'No branch bound — this zone covers nothing',
  'delivery.zones.detail.versions': 'Versions',
  'delivery.zones.detail.noVersions': 'No version drafted yet',
  'delivery.zones.version.number': 'Version',
  'delivery.zones.version.status': 'Status',
  'delivery.zones.version.shape': 'Shape',
  'delivery.zones.version.priority': 'Priority',
  'delivery.zones.version.area': 'Area (km²)',
  'delivery.zones.versionStatus.DRAFT': 'Draft',
  'delivery.zones.versionStatus.ACTIVE': 'Live',
  'delivery.zones.versionStatus.RETIRED': 'Retired',
  'delivery.zones.versionStatus.DISCARDED': 'Discarded',
  ...
  'delivery.tariffs.draft.title': 'New version of {code}',
  'delivery.tariffs.draft.hint':
    'Bands, peak windows and discounts. Drafting does not make it live: the band tiling is only checked when you activate.',
  ...
  'delivery.tariffs.feeSource.TARIFF': 'Own tariff',
  'delivery.tariffs.feeSource.PROVIDER_QUOTE': 'Provider quote',
  'delivery.tariffs.distanceMode.RADIUS': 'Straight line',
  'delivery.tariffs.distanceMode.ROAD': 'Road',
  'delivery.tariffs.accrual.STARTED_KILOMETRE': 'Every started km',
  'delivery.tariffs.accrual.PRORATED_METRE': 'Pro rata by metre',
  'delivery.tariffs.rounding.HALF_UP': 'Half up',
  'delivery.tariffs.rounding.HALF_EVEN': 'Half to even',
  'delivery.tariffs.discountKind.AMOUNT': 'Fixed amount',
  'delivery.tariffs.discountKind.DISTANCE_ALLOWANCE': 'Free distance',
  'delivery.tariffs.days.all': 'Every day',
  'delivery.tariffs.days.mon': 'Mon',
  'delivery.tariffs.days.tue': 'Tue',
  'delivery.tariffs.days.wed': 'Wed',
  'delivery.tariffs.days.thu': 'Thu',
  'delivery.tariffs.days.fri': 'Fri',
  'delivery.tariffs.days.sat': 'Sat',
  'delivery.tariffs.days.sun': 'Sun',
  'delivery.tariffs.draftPending': 'draft v{version}',
  'delivery.tariffs.activate.action': 'Activate draft',
  'delivery.tariffs.bind.action': 'Bind branch',
  'delivery.tariffs.bind.title': 'Bind this tariff to a branch',
  'delivery.tariffs.bind.hint':
    'A branch tariff outranks the brand default and is outranked by a zone tariff.',
  'delivery.tariffs.bind.branch': 'Branch',
  'delivery.tariffs.bind.submit': 'Bind',
  'delivery.tariffs.detail.currency': 'Currency',
  'delivery.tariffs.detail.distanceMode': 'Distance',
  'delivery.tariffs.detail.reach': 'Reach (m)',
  'delivery.tariffs.detail.minFee': 'Minimum fee',
  'delivery.tariffs.detail.maxFee': 'Maximum fee',
  ...
  'delivery.tariffs.rule.days': 'Days',
  'delivery.tariffs.rule.window': 'Window',
  'delivery.tariffs.rule.bandSet': 'Band set',
  'delivery.tariffs.rule.multiplier': 'Multiplier',
  'delivery.tariffs.rule.surcharge': 'Surcharge',
  'delivery.tariffs.discount.kind': 'Kind',
  'delivery.tariffs.discount.value': 'Value',
  'delivery.tariffs.draft.feeSource': 'Fee source',
  'delivery.tariffs.draft.distanceMode': 'Distance mode',
  'delivery.tariffs.draft.routingInstallation': 'Routing provider installation',
  ...
  'delivery.tariffs.draft.roundingRule': 'Rounding rule',
  'delivery.tariffs.draft.bandsHead': 'Distance bands',
  'delivery.tariffs.draft.bandsHint':
    'Bands accumulate: a band’s base is the charge for entering it, not for reaching it. Leave the set blank for the base table. They must cover 0 to the reach with no gap, which is checked when you activate.',
  'delivery.tariffs.draft.addBand': 'Add band',
  'delivery.tariffs.draft.timeRulesHead': 'Peak windows',
  'delivery.tariffs.draft.timeRulesHint':
    'Day mask: bit 0 is Monday, so weekdays is 31 and the whole week 127. A multiplier of 10000 is ×1.0.',
  'delivery.tariffs.draft.addTimeRule': 'Add window',
  'delivery.tariffs.draft.discountsHead': 'Discounts',
  'delivery.tariffs.draft.addDiscount': 'Add discount',
  'delivery.tariffs.draft.remove': 'Remove',

  'delivery.regions.title': 'Regions',
  'delivery.regions.hint':
    'A region is a code, a name and a south-west/north-east box. The box constrains the geocoder and is what a zone activation is checked against — the check that catches a transposed latitude, where the shape is valid and simply somewhere else.',
  'delivery.regions.loading': 'Loading regions',
  'delivery.regions.denied': 'No access to this tenant’s regions',
  'delivery.regions.empty': 'No region yet — a zone drawn now is checked against nothing',
  'delivery.regions.create.action': 'Add region',
  'delivery.regions.create.title': 'Add a region',
  'delivery.regions.edit.action': 'Edit',
  'delivery.regions.edit.title': 'Edit the region',
  'delivery.regions.archive.action': 'Archive',
  'delivery.regions.submit': 'Save',
  'delivery.regions.column.code': 'Code',
  'delivery.regions.column.name': 'Name',
  'delivery.regions.column.owner': 'Owner',
  'delivery.regions.column.box': 'SW → NE',
  'delivery.regions.column.status': 'Status',
  'delivery.regions.owner.platform': 'Platform',
  'delivery.regions.owner.tenant': 'Yours',
  'delivery.regions.owner.readOnly': 'Read-only',
  ...
  'delivery.regions.field.swLon': 'SW longitude',
  'delivery.regions.field.neLat': 'NE latitude',
  'delivery.regions.field.neLon': 'NE longitude',
  'delivery.regions.field.centreLat': 'Centre latitude',
  'delivery.regions.field.centreLon': 'Centre longitude',
  ...
  'delivery.liveMap.branchFilter.label': 'Branch',
  'delivery.liveMap.column.courier': 'Courier',
  'delivery.liveMap.column.position': 'Position',
  'delivery.liveMap.column.accuracy': 'Accuracy',
  'delivery.liveMap.column.heading': 'Heading',
  'delivery.liveMap.column.speed': 'Speed',
  ...
  'delivery.liveMap.column.reveal': 'Track',
  ...
  'delivery.liveMap.reveal.trigger': 'Reveal track',
  'delivery.liveMap.reveal.title': 'Reveal stored track',
  'delivery.liveMap.reveal.notice':
    'Opening a stored track is audited and requires a stated reason.',
  'delivery.liveMap.reveal.from': 'From',
  'delivery.liveMap.reveal.to': 'To',
  'delivery.liveMap.reveal.windowInvalid': 'The end must be after the start.',
  'delivery.liveMap.reveal.purpose': 'Purpose',
  'delivery.liveMap.reveal.purposePlaceholder': 'Why are you opening this track?',
  'delivery.liveMap.reveal.purposeTooShort': 'Say more — at least 12 characters.',
  'delivery.liveMap.reveal.dismiss': 'Cancel',
  'delivery.liveMap.reveal.confirm': 'Reveal',
  'delivery.liveMap.reveal.success': '{windows} window(s) revealed',
  'delivery.liveMap.reveal.resultTitle': 'Track for {courierId}',
  'delivery.liveMap.reveal.empty': 'No observations in this window',
  'delivery.liveMap.reveal.column.time': 'Time',
  ...
  'delivery.rates.edit': 'Edit',
  'delivery.rates.archive': 'Archive',
  'delivery.rates.confirm': 'Confirm',
  'delivery.rates.reason': 'Reason',
  'delivery.rates.archiveReasonPlaceholder': 'Why is this being archived?',
  'delivery.rates.types.title': 'Courier types',
  'delivery.rates.types.add': 'Add type',
  'delivery.rates.types.editTitle': 'Correct a courier type',
  'delivery.rates.types.empty': 'No courier types registered yet',
  'delivery.rates.types.showArchived': 'Show archived',
  ...
  'delivery.rates.types.column.maxDistance': 'Max. distance (m)',
  'delivery.rates.types.column.maxConcurrent': 'Max. concurrent',
  'delivery.rates.types.column.offerTtl': 'Offer TTL (s)',
  'delivery.rates.types.column.startingMinute': 'Starting minute',
  'delivery.rates.types.column.workMode': 'Work mode',
  'delivery.rates.types.column.status': 'Status',
  'delivery.rates.types.workMode.SHIFT': 'Shift',
  'delivery.rates.types.workMode.ON_DEMAND': 'On demand',
  'delivery.rates.types.notYetEnforcedHint':
    'Captured and shown on the type; not yet read by the pay calculator or by dispatch.',
  'delivery.rates.cards.title': 'Rate cards',
  'delivery.rates.cards.add': 'Draft rate card',
  'delivery.rates.cards.newVersion': 'New version',
  'delivery.rates.cards.showComponents': 'Show components',
  ...
  'delivery.rates.cards.column.version': 'Version',
  'delivery.rates.cards.column.effectiveFrom': 'Effective from',
  'delivery.rates.cards.column.effectiveTo': 'Effective to',
  'delivery.rates.cards.column.componentType': 'Component',
  'delivery.rates.cards.column.amount': 'Amount',
  'delivery.rates.cards.column.bandFrom': 'From (m)',
  ...
  'delivery.rates.cards.everyType': 'Every vehicle class',
  'delivery.rates.cards.amount': 'Amount',
  'delivery.rates.cards.bandFrom': 'From (m)',
  'delivery.rates.cards.bandToUnbounded': 'To (m), empty = unbounded',
  'delivery.rates.cards.minimumSeconds': 'Min. paid seconds',
  'delivery.rates.cards.removeComponent': 'Remove',
  'delivery.rates.cards.bandHint':
    'PER_KM_BAND rows must cover zero to unbounded with no gap and no overlap — checked when the card activates.',
  'delivery.rates.componentType.PER_ORDER': 'Per order',
  'delivery.rates.componentType.PER_SHIFT_FIXED': 'Per shift (fixed)',
  'delivery.rates.componentType.PER_KM_BAND': 'Per kilometre (band)',
  'delivery.rates.componentType.PER_ORDER_MINIMUM': 'Minimum per order',
  ...
  'delivery.rates.reasons.title': 'Bonus / penalty reasons',
  'delivery.rates.reasons.add': 'Define reason',
  'delivery.rates.reasons.empty': 'No adjustment reasons defined yet',
  'delivery.rates.reasons.manualOnly': 'Manual only',
  'delivery.rates.reasons.column.code': 'Code',
  'delivery.rates.reasons.column.kind': 'Kind',
  'delivery.rates.reasons.column.name': 'Name',
  'delivery.rates.reasons.column.rule': 'Rule',
  'delivery.rates.reasons.column.status': 'Status',
  'delivery.rates.reasons.kind.BONUS': 'Bonus',
  'delivery.rates.reasons.kind.PENALTY': 'Penalty',
  'delivery.rates.reasons.outcomeBasis': 'Delivery outcome',
  'delivery.rates.reasons.wireToRule': 'Apply automatically (wire to a rule)',
  'delivery.rates.reasons.notEvaluatedHint':
    'This outcome has no automatic evaluator yet — this reason can only be used for a manual entry.',
  'delivery.rates.reasons.amount': 'Amount (minor units)',
  'delivery.rates.reasons.comparator': 'Comparator',
  'delivery.rates.reasons.threshold': 'Threshold',
  'delivery.rates.reasons.window': 'Window',
  'delivery.rates.reasons.window.SHIFT': 'One shift',
  'delivery.rates.reasons.window.SETTLEMENT_PERIOD': 'Settlement period',
  ...
  'delivery.shifts.period.label': 'Period',
  'delivery.shifts.period.from': 'From',
  'delivery.shifts.period.to': 'To',
  'delivery.shifts.period.apply': 'Apply',
  'delivery.shifts.column.courier': 'Courier',
  'delivery.shifts.column.status': 'Status',
  'delivery.shifts.column.dutyState': 'Duty state',
  'delivery.shifts.column.openedAt': 'Opened',
  'delivery.shifts.column.closedAt': 'Closed',
  'delivery.shifts.column.break': 'On break (h:mm)',
  ...
  'delivery.shifts.dutyState.AVAILABLE': 'Available',
  'delivery.shifts.dutyState.ON_BREAK': 'On break',
  'delivery.shifts.dutyState.AT_CAPACITY': 'At capacity',
  'delivery.shifts.dutyState.UNREACHABLE': 'Unreachable',
  'delivery.shifts.roster.title': 'Roster',
  'delivery.shifts.roster.hint':
    'Planned shifts, and whether a courier actually opened one against each',
  'delivery.shifts.roster.plan': 'Plan a shift',
  'delivery.shifts.roster.empty': 'No shifts planned for this period',
  'delivery.shifts.roster.column.window': 'Planned window',
  'delivery.shifts.roster.column.status': 'Status',
  'delivery.shifts.roster.column.coverage': 'Coverage',
  'delivery.shifts.roster.status.DRAFT': 'Draft',
  'delivery.shifts.roster.status.PUBLISHED': 'Published',
  'delivery.shifts.roster.status.ACCEPTED': 'Accepted',
  'delivery.shifts.roster.status.DECLINED': 'Declined',
  'delivery.shifts.roster.status.CONSUMED': 'Consumed',
  'delivery.shifts.roster.status.MISSED': 'Missed',
  'delivery.shifts.roster.status.CANCELLED': 'Cancelled',
  'delivery.shifts.roster.coverage.COVERED': 'Covered',
  'delivery.shifts.roster.coverage.PENDING': 'Pending',
  'delivery.shifts.roster.coverage.UNCOVERED': 'Uncovered',
  'delivery.shifts.roster.publish': 'Publish',
  'delivery.shifts.roster.cancel': 'Cancel',
  'delivery.shifts.roster.planned': 'Shift planned',
  'delivery.shifts.roster.published': 'Shift published',
  'delivery.shifts.roster.cancelled': 'Planned shift cancelled',
  'delivery.shifts.roster.publishReason': 'Published from the roster grid',
  'delivery.shifts.roster.cancelReason': 'Cancelled from the roster grid',
  'delivery.shifts.plan.title': 'Plan a shift',
  'delivery.shifts.plan.courier.label': 'Courier',
  'delivery.shifts.plan.courier.placeholder': 'Choose a courier',
  'delivery.shifts.plan.courier.required': 'Choose a courier',
  'delivery.shifts.plan.start.label': 'Starts',
  'delivery.shifts.plan.end.label': 'Ends',
  'delivery.shifts.plan.window.invalid': 'Must end after it starts',
  'delivery.shifts.plan.reason.label': 'Reason',
  'delivery.shifts.plan.reason.required': 'A reason is required',
  'delivery.shifts.plan.dismiss': 'Cancel',
  'delivery.shifts.plan.confirm': 'Plan shift',
  ...
  'delivery.policy.scopeSelector.label': 'Resolution scope',
  'delivery.policy.scope.TENANT': 'Company',
  'delivery.policy.scope.BRAND': 'Brand',
  'delivery.policy.scope.LOCATION': 'Location',
  'delivery.policy.overridden': 'Overridden',
  'delivery.policy.inherited': 'Inherited: {value}',
  'delivery.policy.policyIdentity': 'Policy {id} · v{version}',
  ...
  'delivery.policy.consequence.shiftEnforcement':
    'Enforced blocks dispatch to a courier with no open shift; Advisory only warns; Off does not check at all.',
  'delivery.policy.cashCeiling': 'Cash ceiling per courier',
  'delivery.policy.consequence.cashCeiling':
    'A courier holding more cash than this is blocked from new cash-on-delivery orders until they settle.',
  'delivery.policy.penaltyThreshold': 'Penalty approval threshold',
  'delivery.policy.consequence.penaltyThreshold':
    'A penalty at or above this amount needs a second approver before it is applied.',
  'delivery.policy.reverificationDays': 'Reverification window (days)',
  'delivery.policy.consequence.reverificationDays':
    'A courier must re-verify their documents this often, or their account is suspended.',
  'delivery.policy.warningDays': 'Warning window (days)',
  'delivery.policy.consequence.warningDays':
    'A courier stays on the warning list for this many days after a violation before it lapses.',
  'delivery.policy.settlementPeriodDays': 'Settlement period (days)',
  'delivery.policy.consequence.settlementPeriodDays':
    'Cash and accrued pay must be settled within this many days of a shift closing.',
  ...
  'customers.search.createNew': 'Create customer “{query}”',
  ...
  'customers.tab.promos': 'Promo codes',
  'customers.tab.reviews': 'Reviews',
  'customers.tab.erasure': 'Data erasure',
  ...
  'customers.cashback.adjust.action': 'Adjust balance',
  'customers.cashback.adjust.direction': 'Direction',
  'customers.cashback.adjust.direction.CREDIT': 'Credit (add points)',
  'customers.cashback.adjust.direction.DEBIT': 'Debit (remove points)',
  'customers.cashback.adjust.amount': 'Amount',
  'customers.cashback.adjust.reasonCode': 'Reason code',
  'customers.cashback.adjust.reasonCode.placeholder': 'e.g. GOODWILL',
  'customers.cashback.adjust.reason': 'Reason',
  'customers.cashback.adjust.submit': 'Apply adjustment',
  'customers.cashback.adjust.result.applied': 'Adjustment applied.',
  'customers.cashback.adjust.result.pending': 'Above the threshold — pending a second approval.',
  'customers.cashback.adjust.result.declined': 'Adjustment declined.',
  'customers.cashback.ledger.type': 'Type',
  'customers.cashback.ledger.amount': 'Amount',
  'customers.cashback.ledger.balanceAfter': 'Balance after',
  'customers.cashback.ledger.reason': 'Reason code',
  'customers.cashback.ledger.order': 'Order',
  'customers.cashback.ledger.occurredAt': 'When',
  'customers.cashback.ledger.viewOrder': 'View order',

  'customers.blacklist.active': 'Blacklisted',
  'customers.blacklist.expiredNotLifted': 'Expired — not lifted',
  'customers.blacklist.notActive': 'Not blacklisted.',
  'customers.blacklist.since': 'since',
  ...
  'customers.blacklist.history.actor': 'By',
  'customers.blacklist.history.liftedAt': 'Lifted',
  'customers.blacklist.history.liftedBy': 'by',
  'customers.blacklist.history.liftReason': 'Lift reason:',

  'customers.promos.totalsRedeemed': 'Redeemed total:',
  'customers.promos.code': 'Code',
  'customers.promos.promotion': 'Promotion',
  'customers.promos.status': 'Status',
  'customers.promos.amount': 'Amount',
  'customers.promos.order': 'Order',
  'customers.promos.reservedAt': 'Reserved',
  'customers.promos.empty': 'No promo code redemptions for this customer.',
  'customers.promos.status.RESERVED': 'Reserved',
  'customers.promos.status.REDEEMED': 'Redeemed',
  'customers.promos.status.RELEASED': 'Released',

  'customers.detail.reviews.rating': 'Rating',
  'customers.detail.reviews.comment': 'Comment',
  'customers.detail.reviews.order': 'Order',
  'customers.detail.reviews.submittedAt': 'Submitted',
  'customers.detail.reviews.empty': 'No reviews from this customer.',

  'customers.erasure.lead':
    'A data-subject erasure request anonymises this account and overwrites its protected fields. Raising it only records intent — it does not erase anything by itself.',
  'customers.erasure.raise': 'Raise an erasure request',
  'customers.erasure.withdraw': 'Withdraw',
  'customers.erasure.execute': 'Execute',
  'customers.erasure.status': 'Status',
  'customers.erasure.requestedVia': 'Requested via',
  'customers.erasure.requestedAt': 'Requested',
  'customers.erasure.empty': 'No erasure requests for this customer.',
  'customers.erasure.status.PENDING': 'Pending',
  'customers.erasure.status.COMPLETED': 'Completed',
  'customers.erasure.status.CANCELLED': 'Withdrawn',
  ...
  'reports.filter.channel.label': 'Channel',
  'reports.filter.channel.placeholder': 'Any channel',
  'reports.filter.legalEntity.label': 'Legal entity',
  'reports.filter.legalEntity.placeholder': 'Any entity',
  'reports.filter.granularity.label': 'Granularity',
  'reports.filter.granularity.day': 'Day',
  'reports.filter.granularity.week': 'Week',
  'reports.filter.granularity.month': 'Month',
  ...
  'reports.overview.formula.excludes': 'Excludes',
  'reports.overview.formula.unit': 'Unit',
  ...
  'reports.overview.funnel.disposition': 'Stock',
  'reports.overview.funnel.liability': 'Cost borne by',
  'reports.overview.funnel.disposition.RELEASE': 'Released (never committed)',
  'reports.overview.funnel.disposition.RETURN_TO_STOCK': 'Returned to stock',
  'reports.overview.funnel.disposition.WRITE_OFF': 'Written off',
  'reports.overview.funnel.disposition.NO_EFFECT': 'No effect',
  ...
  'reports.orders.column.branch': 'Branch',
  'reports.orders.column.channel': 'Channel',
  'reports.orders.column.fulfilment': 'Type',
  'reports.orders.column.preorder': 'Pre-order',
  'reports.orders.column.preorder.yes': 'Pre-order',
  'reports.orders.column.status': 'Status',
  'reports.orders.column.confirm': 'Confirmed in',
  'reports.orders.column.ready': 'Prepared in',
  'reports.orders.column.accept': 'Branch accepted in',
  'reports.orders.column.cooking': 'Cooked in',
  ...
  'reports.couriers.loading': 'Loading…',
  'reports.couriers.empty': 'No deliveries in this range.',
  'reports.couriers.column.name': 'Courier',
  'reports.couriers.leaderboard.title': 'Courier leaderboard',
  'reports.couriers.column.deliveries': 'Deliveries',
  'reports.couriers.column.minDistance': 'Min. distance',
  'reports.couriers.column.avgDistance': 'Avg. distance',
  'reports.couriers.column.maxDistance': 'Max. distance',
  'reports.couriers.column.totalDistance': 'Total distance',
  'reports.couriers.column.avgTransit': 'Avg. transit',
  'reports.couriers.column.onTime': 'On-time',
  'reports.couriers.sla.title': 'Courier SLA time buckets',
  'reports.couriers.tariffAudit.title': 'Delivery-sum-by-tariff audit',
  'reports.couriers.column.tariff': 'Tariff',
  'reports.couriers.column.zone': 'Zone',
  'reports.couriers.column.band': 'Band',
  'reports.couriers.column.resolutions': 'Deliveries',
  'reports.couriers.column.totalFee': 'Total fee',
  'reports.couriers.externalCost.title': 'External-delivery cost',
  'reports.couriers.column.order': 'Order',
  'reports.couriers.column.provider': 'Provider',
  'reports.couriers.column.orderTotal': 'Order total',
  'reports.couriers.column.chargedDelivery': 'Charged delivery',
  'reports.couriers.column.providerBilled': 'Provider billed',
  'reports.couriers.column.variance': 'Variance',
  'reports.couriers.column.status': 'Status',
  'reports.couriers.externalCost.totalVariance': 'Total variance in range: {amount}',
  'reports.couriers.externalCost.reconcile': 'Reconcile',
  'reports.couriers.externalCost.reconcileConfirm.title': 'Reconcile this delivery?',
  'reports.couriers.externalCost.reconcileConfirm.body':
    'Order {order} will be marked matched against the provider invoice.',
  'reports.couriers.externalCost.reconcileConfirm.cancel': 'Cancel',
  'reports.couriers.externalCost.status.PENDING': 'Pending',
  'reports.couriers.externalCost.status.MATCHED': 'Matched',
  'reports.couriers.externalCost.status.VARIANCE': 'Variance',
  'reports.couriers.externalCost.status.UNBILLED': 'Unbilled',
  ...
  'finance.cash.filter.status': 'Status',
  'finance.cash.filter.allStatuses': 'All statuses',
  'finance.cash.filter.location': 'Branch',
  'finance.cash.filter.locationPlaceholder': 'Branch id',
  'finance.cash.totals.cash': 'Cash collected',
  'finance.cash.totals.nonCash': 'Non-cash deliveries',
  'finance.cash.totals.bonusPaid': 'Bonus paid this shift',
  'finance.cash.totals.deliveries': '{count} deliveries',
  'finance.cash.column.courier': 'Courier',
  'finance.cash.column.shift': 'Shift',
  'finance.cash.column.location': 'Branch',
  'finance.cash.column.declaredAt': 'Declared at',
  'finance.cash.column.byPaymentMethod': 'By payment method',
  'finance.cash.byPaymentMethod': '{cash} cash · {nonCash} non-cash',
  'finance.cash.column.bonusPaid': 'Bonus paid',
  ...
  'finance.deliveryCost.matchStatus.PENDING': 'Not yet matched',
  'finance.deliveryCost.matchStatus.MATCHED': 'Matched',
  'finance.deliveryCost.matchStatus.VARIANCE': 'Variance',
  'finance.deliveryCost.matchStatus.UNBILLED': 'Unbilled',
  'finance.deliveryCost.matchStatus.UNMATCHED_LINE': 'No matching shipment',
  'finance.deliveryCost.varianceResolution.ACCEPTED': 'Accepted',
  'finance.deliveryCost.varianceResolution.DISPUTED': 'Disputed',
  'finance.deliveryCost.margin': 'Charged vs. cost margin',
  'finance.deliveryCost.marginHint': 'Invoiced less accrued, same range',
  'finance.deliveryCost.chargeType.DELIVERY': 'Delivery',
  'finance.deliveryCost.chargeType.CANCELLATION': 'Cancellation',
  'finance.deliveryCost.chargeType.WAITING': 'Waiting',
  'finance.deliveryCost.chargeType.SURCHARGE': 'Surcharge',
  'finance.deliveryCost.chargeType.ADJUSTMENT': 'Adjustment',
  'finance.deliveryCost.import.action': 'Import invoice',
  'finance.deliveryCost.import.cancel': 'Cancel import',
  'finance.deliveryCost.import.title': 'Import a partner delivery invoice',
  'finance.deliveryCost.import.provider': 'Provider code',
  'finance.deliveryCost.import.reference': 'Invoice reference',
  'finance.deliveryCost.import.currency': 'Currency',
  'finance.deliveryCost.import.totalMinor': 'Total (minor units)',
  'finance.deliveryCost.import.periodStart': 'Period start',
  'finance.deliveryCost.import.periodEnd': 'Period end',
  'finance.deliveryCost.import.lines': 'Lines',
  'finance.deliveryCost.import.chargeType': 'Charge type',
  'finance.deliveryCost.import.addLine': '+ Add line',
  'finance.deliveryCost.import.removeLine': 'Remove',
  'finance.deliveryCost.import.reason': 'Reason',
  'finance.deliveryCost.import.submit': 'Import',
  'finance.deliveryCost.resolve.action': 'Resolve',
  'finance.deliveryCost.resolve.title': 'Resolve the unmatched line',
  'finance.deliveryCost.resolve.shipmentId': 'HorecaOS shipment id',
  'finance.deliveryCost.variance.accept': 'Accept',
  'finance.deliveryCost.variance.dispute': 'Dispute',
  'finance.deliveryCost.variance.acceptTitle': 'Accept the charge as invoiced',
  'finance.deliveryCost.variance.disputeTitle': 'Dispute this variance',
  'finance.deliveryCost.dispute.action': 'Dispute',
  'finance.deliveryCost.dispute.title': 'Dispute this invoice',
  ...
  'finance.payouts.column.hours': 'Hours',
  'finance.payouts.column.onTime': 'On time',
  'finance.payouts.column.bonus': 'Bonus',
  'finance.payouts.column.penalty': 'Penalty',
  'finance.payouts.column.payable': 'To pay',
  'finance.payouts.statement.download': 'Download statement',
  ...
  'finance.subscription.statements.title': 'Statements',
  'finance.subscription.statements.number': 'Number',
  'finance.subscription.statements.period': 'Period',
  'finance.subscription.statements.total': 'Total',
  'finance.subscription.statements.status': 'Status',
  'finance.subscription.statements.download': 'Download CSV',
  'finance.subscription.statements.empty': 'No statements have been issued yet.',
  'finance.subscription.statements.status.DRAFT': 'Preview',
  'finance.subscription.statements.status.ISSUED': 'Issued',
  'finance.subscription.statements.status.VOID': 'Void',
  'finance.subscription.statements.kind.PLAN': 'Plan',
  'finance.subscription.statements.kind.MODULE': 'Module',
  'finance.subscription.statements.kind.OVERAGE': 'Over the plan',
  'finance.subscription.statements.kind.DEPOSIT': 'Deposit',
  'finance.subscription.statements.kind.EARLY_EXIT': 'Term left early',
  'finance.subscription.statements.lineKind': 'Charge',
  'finance.subscription.statements.lineDescription': 'Description',
  ...
  'staff.activity.action.grantGranted': 'Role granted',
  'staff.activity.action.grantRevoked': 'Role revoked',
  'staff.activity.action.auditRead': 'Activity log viewed',
  'staff.activity.action.brandRevised': 'Brand details corrected',
  'staff.activity.action.brandActivated': 'Brand activated',
  'staff.activity.action.brandDeleted': 'Brand deleted',
  'staff.activity.action.locationRevised': 'Location details corrected',
  ...
  'staff.activity.filter.outcomeRejected': 'Rejected',
  'staff.activity.filter.outcomeFailed': 'Failed',
  'staff.activity.filter.scopeTypeAll': 'Any location',
  'staff.activity.filter.scopeId': 'Where (id)',
  'staff.activity.filter.target': 'What was changed (id)',
  'staff.activity.loadMore': 'Load more',
  'staff.activity.loadingMore': 'Loading…',
  'staff.activity.detail.partOfBulk': 'Part of a bulk action',
  'staff.activity.detail.viewBulk': 'See the whole batch',
  ...
  'staff.approvals.column.decidedBy': 'Decided by',
  'staff.approvals.column.decidedAt': 'Decided at',
  'staff.approvals.status.approved': 'Approved',
  'staff.approvals.status.declined': 'Declined',
  'staff.approvals.decided.empty': 'This tenant has not decided any request yet.',
  'staff.approvals.accessCheckLead': 'Wondering why somebody can’t do something?',
  'staff.approvals.accessCheckLink': 'Check their access',
  'staff.accessCheck.title': 'Access check',
  'staff.accessCheck.lead':
    'Can she do this, and why? Answered from the same grants a real request checks.',
  'staff.accessCheck.field.who': 'Who',
  'staff.accessCheck.field.what': 'What',
  'staff.accessCheck.field.where': 'Where',
  'staff.accessCheck.pick': 'Pick one',
  'staff.accessCheck.action.check': 'Check',
  'staff.accessCheck.answer.allowed': 'Yes, she can.',
  'staff.accessCheck.answer.denied': 'No, she can’t.',
  'staff.accessCheck.answer.entitlementRequired':
    'Her rights are enough. This tenant’s plan does not include this feature.',
  'staff.accessCheck.heldElsewhere.label': 'This job carries this capability at:',
  'staff.accessCheck.heldElsewhere.since': 'since',
  'staff.accessCheck.heldElsewhere.none': 'No active grant carries this capability at all.',
  ...
  'settings.dataPrivacy.retention.column.value': 'Current value',
  'settings.dataPrivacy.retention.column.enforcedBy': 'Enforced by',
  'settings.dataPrivacy.retention.unit.days': 'days',
  'settings.dataPrivacy.retention.unit.months': 'months',
  'settings.dataPrivacy.retention.abandonedCarts.enforcedBy': 'Deleted on a schedule',
  'settings.dataPrivacy.retention.courierLocation.enforcedBy': 'Partition dropped on a schedule',
  'settings.dataPrivacy.retention.courierApplicants.category': 'Unverified courier applicants',
  'settings.dataPrivacy.retention.courierApplicants.enforcedBy': 'Name erased on a schedule',
  'settings.dataPrivacy.retention.action.save': 'Save',
  'settings.dataPrivacy.retention.source.platformDefault':
    'Platform default — not set for this tenant',
  'settings.dataPrivacy.retention.source.tenant': 'Set for this tenant',
  'settings.dataPrivacy.retention.invalidValue': 'Enter a whole number greater than zero',
  'settings.dataPrivacy.retention.staleVersion':
    'Somebody else changed this value first — the current value is shown; change it again if you still want to.',
  ...
  'settings.dataPrivacy.consent.column.policyVersion': 'Policy version',
  'settings.dataPrivacy.consent.channelSpecific.yes': 'Yes',
  'settings.dataPrivacy.consent.channelSpecific.no': 'No',
  'settings.dataPrivacy.requests.title': 'Data subject requests',
  'settings.dataPrivacy.erasure.title': 'Erasure requests',
  'settings.dataPrivacy.erasure.lead':
    'Every data-subject erasure request across the whole tenant. Raise, execute, or cancel one from the customer’s own record.',
  'settings.dataPrivacy.erasure.filter.label': 'Status',
  'settings.dataPrivacy.erasure.filter.all': 'All',
  'settings.dataPrivacy.erasure.status.pending': 'Pending',
  'settings.dataPrivacy.erasure.status.completed': 'Completed',
  'settings.dataPrivacy.erasure.status.cancelled': 'Cancelled',
  'settings.dataPrivacy.erasure.column.status': 'Status',
  'settings.dataPrivacy.erasure.column.customer': 'Customer account',
  'settings.dataPrivacy.erasure.column.requestedVia': 'Requested via',
  'settings.dataPrivacy.erasure.column.requestedAt': 'Requested at',
  'settings.dataPrivacy.erasure.column.resolvedAt': 'Resolved at',
  'settings.dataPrivacy.erasure.empty': 'No erasure request has been raised in this tenant.',
  ...
  'orders.callCentre.screenPop.startOrder': 'Start order',
  ...
  'ui.liveBadge.live': 'Live',
  'ui.refreshIndicator.updated': 'Updated {time}',
  'ui.refreshIndicator.refresh': 'Refresh now',
  'ui.staleIndicator.stale': 'May be out of date',
  'ui.connectionState.reconnecting': 'Reconnecting…',
  'ui.connectionState.unavailable': 'Live updates unavailable — refreshing every 10 seconds',
  ...
  // X.29, X.32, X/X.5) --------------------------------------------------
  'ui.moneyInput.currencySuffix': 'UZS',
  'ui.moneyOrPercent.amount': 'Amount',
  'ui.moneyOrPercent.percent': 'Percent',
  'ui.dateRangePicker.preset.today': 'Today',
  'ui.dateRangePicker.preset.yesterday': 'Yesterday',
  'ui.dateRangePicker.preset.last7Days': 'Last 7 days',
  'ui.dateRangePicker.preset.thisMonth': 'This month',
  'ui.dateRangePicker.from': 'From',
  'ui.dateRangePicker.to': 'To',
  'ui.timeInput.label': 'Time',
  'ui.dayOfWeek.short.1': 'Mon',
  'ui.dayOfWeek.short.2': 'Tue',
  'ui.dayOfWeek.short.3': 'Wed',
  'ui.dayOfWeek.short.4': 'Thu',
  'ui.dayOfWeek.short.5': 'Fri',
  'ui.dayOfWeek.short.6': 'Sat',
  'ui.dayOfWeek.short.7': 'Sun',
  'ui.dayOfWeek.full.1': 'Monday',
  'ui.dayOfWeek.full.2': 'Tuesday',
  'ui.dayOfWeek.full.3': 'Wednesday',
  'ui.dayOfWeek.full.4': 'Thursday',
  'ui.dayOfWeek.full.5': 'Friday',
  'ui.dayOfWeek.full.6': 'Saturday',
  'ui.dayOfWeek.full.7': 'Sunday',
  'ui.scheduleGrid.weeklyTitle': 'Weekly hours',
  'ui.scheduleGrid.addWindow': 'Add window',
  'ui.scheduleGrid.remove': 'Remove',
  'ui.scheduleGrid.exceptionsTitle': 'Dated exceptions',
  ...
  // `q-mapping-pane` (ADR 0012/0026, gap-map row X.24) — the dual list, link/
  // unlink, unmapped filter, bulk auto-match and the two-sided conflict card
  // shared by the POS product mapping tab and the six-type integration pane.
  'ui.mappingPane.unmappedOnly': 'Show unmapped only',
  'ui.mappingPane.bulkAutoMatch': 'Bulk auto-match by name',
  'ui.mappingPane.loading': 'Loading the mapping…',
  'ui.mappingPane.horecaosColumn': 'HorecaOS',
  'ui.mappingPane.externalColumn': 'Provider',
  'ui.mappingPane.unmappedCount': '{count} unmapped',
  'ui.mappingPane.link': 'Link',
  'ui.mappingPane.unlink': 'Unlink',
  'ui.mappingPane.linkedTitle': 'Linked',
  'ui.mappingPane.linkedEmpty': 'Nothing linked yet',
  'ui.mappingPane.column.horecaos': 'HorecaOS',
  'ui.mappingPane.column.external': 'Provider code',
  'ui.mappingPane.column.status': 'Status',
  'ui.mappingPane.conflicts.title': 'Needs a person to decide',
  'ui.mappingPane.conflicts.sharedName':
    '“{name}” matches more than one candidate on at least one side',
  'ui.mappingPane.conflicts.horecaosSide': 'HorecaOS',
  'ui.mappingPane.conflicts.externalSide': 'Provider',
  'ui.mappingPane.conflicts.linkThisPair': 'Link this pair',
  'ui.mappingPane.conflicts.dismiss': 'Dismiss',
  ...
  'scopeBar.level.TENANT': 'COMPANY-WIDE',
  'scopeBar.level.BRAND': 'BRAND',
  'scopeBar.level.LOCATION': 'LOCATION',
  'scopeBar.tenantWide.groupLabel': 'Editing level: per-brand or company-wide',
  'scopeBar.tenantWide.perBrand': 'Per brand',
  'scopeBar.tenantWide.tenant': 'Company-wide default',
  ...
  // ADR 0012/0026, gap-map rows 10.8b/X.24: the «Соответствия» tab, shown for
  // a POS installation only — the five non-PRODUCT pairings. PRODUCT's own
  // mapping tab lives on the catalog import screen (4.5a) instead.
  'settings.integrations.detail.tab.details': 'Details',
  'settings.integrations.detail.mapping.tabTitle': 'Соответствия',
  'settings.integrations.detail.mapping.noBindings': 'No bindings yet — nothing to map.',
  'settings.integrations.detail.mapping.binding': 'Binding',
