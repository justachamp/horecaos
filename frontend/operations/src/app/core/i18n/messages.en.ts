...
export const messagesEn = {
  ...
  'catalog.menuSets.empty': 'No menus yet. Create one to start rolling an assortment out to branches.',
  ...
  'catalog.editor.photos.channel.empty': 'No override for this channel yet — it falls back to the universal photos.',
