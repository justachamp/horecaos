...
export const messagesUzLatn: MessageCatalogue = {
  ...
  'orders.dialog.outcome.stockDisposition.RELEASE': 'Rezerv bo‘shatildi',
  ...
  'orders.dialog.outcome.stockDisposition.NO_EFFECT': 'Omborga ta’sir yo‘q',
  ...
  'orders.dialog.outcome.customerRefund.FULL': 'To‘liq qaytarish',
  'orders.dialog.outcome.customerRefund.NONE': 'Qaytarilmaydi',
  'orders.dialog.outcome.customerRefund.DISCRETIONARY': 'Operator qaroriga ko‘ra',
  ...
  'orders.detail.outcome.kind.EXPIRED': 'Muddati o‘tdi',
  'orders.detail.outcome.category.CUSTOMER_CANCELLED': 'Mijoz bekor qildi',
  'orders.detail.outcome.category.CUSTOMER_UNREACHABLE': 'Mijozga bog‘lanib bo‘lmadi',
  ...
  'orders.detail.outcome.category.ITEM_UNAVAILABLE': 'Mahsulot yo‘q',
  ...
  'orders.detail.outcome.category.PAYMENT_NOT_RECEIVED': 'To‘lov tushmadi',
  ...
  'orders.detail.outcome.category.DELIVERED_OWN_COURIER': 'O‘z kuryeri yetkazdi',
  ...
  'orders.detail.outcome.category.SERVED_IN_HOUSE': 'Zalda xizmat ko‘rsatildi',
  ...
  'orders.detail.details.kitchenNote.none': 'Izoh yo‘q',
  'orders.detail.details.callback': 'Qayta qo‘ng‘iroq',
  ...
  'orders.detail.revisions.show': 'Revizialarni ko‘rsatish',
  'orders.detail.revisions.hide': 'Revizialarni yashirish',
  'orders.detail.revisions.error': 'Revizialarni yuklab bo‘lmadi',
  ...
  'orders.detail.revisions.column.delta': 'O‘zgarish',
  ...
  'orders.detail.handover.error': 'Topshirish holatini yuklab bo‘lmadi',
  'orders.detail.handover.none': 'Bu buyurtmada topshirish tekshiruvi yo‘q',
  ...
  'orders.detail.handover.status.BYPASSED': 'Supervayzer tomonidan qo‘lda tasdiqlandi',
  'orders.detail.handover.status.FAILED': 'Urinishlar tugadi',
  'orders.detail.handover.status.EXPIRED': 'Muddati o‘tdi',
  'orders.detail.handover.codeLabel': 'Kod',
  'orders.detail.handover.verify': 'Tasdiqlash',
  'orders.detail.handover.verified': 'Tasdiqlandi.',
  'orders.detail.handover.wrongCode': 'Noto‘g‘ri kod — {attemptsRemaining} ta urinish qoldi.',
  'orders.detail.handover.bypassOpen': 'Qo‘lda tasdiqlash',
  'orders.detail.handover.bypassReason': 'Sabab',
  'orders.detail.handover.bypassSupervisor': 'Supervayzer F.I.Sh.',
  'orders.detail.handover.bypassConfirm': 'Qo‘lda tasdiqlashni yakunlash',
  ...
  'settings.notifications.field.channel.hint':
    'Bugun faqat SMS va Telegram haqiqatda yuboradi. Email va Push sxema hamda shablon kalitida eʼlon qilingan, lekin ularni hech qanday adapter yetkazmaydi.',
  ...
  'catalog.import.start.priceReImport':
    'Narxlarni koʻrib chiqish uchun qayta import qilish (e’tiborsiz qoldirish oʻrniga)',
