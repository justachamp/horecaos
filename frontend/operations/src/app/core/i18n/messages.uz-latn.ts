...
export const messagesUzLatn: MessageCatalogue = {
  ...
  'reports.orders.commercial.piiNote':
    'Mijoz ismi, telefoni, operator va kuryer bu yerda koʻrsatilmaydi — hisobotda umuman shaxsiy maʻlumot saqlanmaydi (ADR 0029), bu jadval ochiq raqam emas, buyurtmaning ichki id sini oʻqiydi.',
