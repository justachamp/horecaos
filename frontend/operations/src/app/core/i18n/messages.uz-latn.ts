...
export const messagesUzLatn: MessageCatalogue = {
  ...
  'support.banner.view': 'HorecaOS yordami · faqat ko‘rish',
  ...
  'invite.lead': '{tenant} HorecaOS’dan foydalanadi va siz uning egasisiz.',
  ...
  'finance.paymentAttemptStatus.UNCERTAIN': 'Nomaʼlum — provayder javob bermadi',
  ...
  'catalog.nav.referenceData': 'Maʼlumotnomalar',
  ...
  'kitchen.capacity.noStations':
    'Bu filialda hali stansiyalar sozlanmagan. Stansiya yaratish uchun bu konsolda hali ekran yoʻq — oshxona stansiyalari API’siga qarang.',
  ...
  'delivery.tariffs.accrual.PRORATED_METRE': 'Metrlar bo‘yicha proporsional',
  ...
  'delivery.tariffs.draft.accrual': 'Km bo‘yicha hisoblash',
  ...
  'delivery.policy.shiftEnforcement.ENFORCED': 'Qatʼiy',
  ...
  'marketing.campaign.field.upperBoundHint':
    'yuqori chegara, vaʼda emas — joʻnatishda xuddi shu tekshiruvlar qayta oʻtkaziladi',
  'marketing.campaign.field.estimatedCost': 'Narx (taxminiy)',
  'marketing.campaign.field.rangeHint':
    'oraliq, vaʼda emas — shaxsiylashtirish xabar uzunligini oʻzgartiradi',
  'marketing.campaign.field.costUnknown':
    'Hali maʼlum emas — faol shablon yoʻq yoki narx belgilanmagan',
  'marketing.campaign.field.estimatedDelivery': 'Yetkazish oynasi (taxminiy)',
  'marketing.campaign.field.seconds': 'soniya',
  'marketing.campaign.field.deliveryHint': 'rejalashtirish uchun raqam, vaʼda emas',
  'marketing.campaign.field.deliveryUnknown':
    'Hali maʼlum emas — bu kanal uchun tezlik chegarasi sozlanmagan',
  ...
  'marketing.predicate.type.AUDIENCE_MEMBERSHIP': 'Auditoriya aʼzosi',
  ...
  'marketing.promoCodes.intro':
    'Mijoz savatiga kiritadigan kod. Yopiq uchta chegirma turi — buyurtmadan foiz, buyurtmadan qat’iy summa yoki bepul yetkazib berish — hech qachon mahsulot darajasidagi yoki vaqtga bog‘liq qoida emas (ADR 0072).',
  'marketing.promoCodes.loading': 'Yuklanmoqda',
  'marketing.promoCodes.denied': 'Ushbu brendning promokodlariga ruxsat yo‘q',
  ...
  'marketing.promoCodes.action.retire': 'To‘xtatish',
  'marketing.promoCodes.shape.PERCENTAGE_OFF_ORDER': 'Buyurtmadan foiz',
  'marketing.promoCodes.shape.FIXED_AMOUNT_OFF_ORDER': 'Buyurtmadan qat’iy summa',
  ...
  'marketing.promoCodes.status.ARCHIVED': 'To‘xtatilgan',
  'marketing.promoCodes.reveal.label': 'Ushbu kod:',
  'marketing.promoCodes.reveal.hint':
    'Faqat hozir, bir marta ko‘rsatiladi — kod faqat xesh sifatida saqlanadi, shuning uchun uni keyin qayta o‘qib bo‘lmaydi. Ushbu xabarni yopishdan oldin yozib oling.',
  ...
  'marketing.promoCodes.form.minBasket': 'Malakali bo‘lish uchun min. savat',
  ...
  'marketing.promoCodes.form.perCustomerLimit.hint':
    'Mehmon sifatida buyurtma berishda qo‘llanilmaydi — u yerda hisoblash uchun akkaunt yo‘q.',
  ...
  'orders.callCentre.link': 'Qo‘ng‘iroqlar markazi',
  'orders.callCentre.title': 'Qo‘ng‘iroqlar markazi',
  'orders.callCentre.denied': 'Bu filialning qo‘ng‘iroqlar markaziga ruxsat yo‘q',
  'orders.callCentre.notBuilt':
    'O‘z telefoningiz yoki softfoningizdan javob bering va qo‘ng‘iroq qiling — bu ekran ovozni uzatmaydi (ADR 0064).',
  'orders.callCentre.presence.title': 'Sizning holatingiz',
  'orders.callCentre.presence.state.ONLINE': 'Aloqada',
  'orders.callCentre.presence.state.PAUSED': 'To‘xtatilgan',
  ...
  'orders.callCentre.presence.reasonRequired': 'To‘xtatish uchun sabab kerak',
  'orders.callCentre.presence.save': 'Holatni yangilash',
  'orders.callCentre.presence.error': 'Holatni yangilab bo‘lmadi',
  'orders.callCentre.screenPop.title': 'Kiruvchi qo‘ng‘iroq',
  'orders.callCentre.screenPop.empty': 'Hozir qo‘ng‘iroq yo‘q',
  'orders.callCentre.screenPop.unknownCaller': 'Noma’lum raqam',
  'orders.callCentre.screenPop.createCustomer': 'Mijoz yaratish',
  'orders.callCentre.screenPop.recentOrders': 'So‘nggi buyurtmalar',
  ...
  'orders.callCentre.screenPop.error': 'Joriy qo‘ng‘iroqni yuklab bo‘lmadi',
  'orders.callCentre.callLog.title': 'So‘nggi qo‘ng‘iroqlar',
  'orders.callCentre.callLog.empty': 'Hali qo‘ng‘iroqlar yo‘q',
