 ...
 *
 * The issuer matches `QOIDA_OIDC_ISSUER_URI` in the platform's application.yml,
 * whose default is `http://localhost:8081/realms/qoida`. If the two disagree,
...
export const environment: Environment = {
  ...
  auth: {
    issuer: 'http://localhost:8081/realms/qoida',
