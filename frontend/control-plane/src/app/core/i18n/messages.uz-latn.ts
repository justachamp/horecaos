...
export const uzLatn: Messages = {
  ...
  'piiClassification.mayLeave': 'hodisa va jurnallarda bo‘lishi mumkin',
  'piiClassification.staysIn': 'ma’lumotlar bazasidan chiqmaydi',
  'piiClassification.retention': 'Saqlash muddatlari',
  'piiClassification.column.data': 'Ma’lumot',
  ...
  'piiClassification.class.PERSONAL': 'Shaxsiy',
  'piiClassification.class.PERSONAL_SENSITIVE': 'Nozik shaxsiy',
  'piiClassification.class.FINANCIAL': 'Moliyaviy',
  'piiClassification.class.SECRET': 'Maxfiy',
  'piiClassification.rule.AUDIT_EVENTS': 'Audit jurnali',
  'piiClassification.rule.COURIER_TRACKS': 'Kuryer harakati izlari',
  'piiClassification.rule.COURIER_CONFIRMATION_POINTS': 'Kuryer yetkazishni tasdiqlagan joylar',
  'piiClassification.rule.AUDIENCE_SNAPSHOTS': 'Marketing auditoriyasi tarkibi',
  'piiClassification.rule.CONVERSATION_MESSAGES': 'Mijozlar bilan yozishmalar',
  ...
  'notificationProviders.column.gateway': 'Shlyuz',
  'notificationProviders.column.sender': 'Yuboruvchi nomi',
  ...
  'notificationProviders.reference': 'Shlyuzdagi raqam',
  'notificationProviders.objection': 'Shlyuzga nima yoqmadi',
  'notificationProviders.save': 'Saqlash',
  'notificationProviders.recorded': '{template}: {state}.',
  'notificationProviders.review.PENDING': 'Shlyuzni kutmoqda',
  ...
  'platformApprovals.lead': 'Istalgan mijozdagi ikkinchi imzoni kutayotgan platforma qarorlari: mijoz mamlakatini o‘zgartirish, siyosat talab qilsa mijozni faollashtirish va HorecaOS mijoz hisobi bo‘yicha taklif qiladigan hamyon o‘zgarishlari — tuzatish, bonus berish, to‘langan pulni qaytarish yoki xato yozilgan depozitni qaytarish. «HorecaOS’ning o‘z qarori» deb belgilangan qator o‘sha mijoz hamyonidan pul chiqaradi; u o‘z mijozini atamaydi, chunki mijoz uni o‘qimaydi ham, imzolamaydi ham — hisob va summa qatorning o‘zida ko‘rsatilgan.',
  ...
  'platformApprovals.column.expires': 'Muddati tugaydi',
  'platformApprovals.action.tenant_country_change': 'Mamlakatni o‘zgartirish',
  ...
  'businessTypes.handover.PICKUP': 'olib ketish',
  'businessTypes.handover.DINE_IN': 'zalda',
  'businessTypes.change': 'O‘zgartirish',
  'businessTypes.save': 'Saqlash',
  'businessTypes.saved': '{tenant} «{type}» sifatida yozildi.',
  'businessTypes.none': 'Bu turdagi mijoz yo‘q.',
  'businessTypes.type.RESTAURANT': 'Restoran',
  'businessTypes.type.CAFE': 'Kafe',
  'businessTypes.type.FAST_FOOD': 'Fastfud',
  'businessTypes.type.BAKERY': 'Novvoyxona',
  'businessTypes.type.DARK_KITCHEN': 'Faqat yetkazib berish oshxonasi',
  'businessTypes.type.CATERING': 'Keytering',
  'businessTypes.type.COURIER_SERVICE': 'Kuryerlik xizmati',
  'businessTypes.type.PHARMACY': 'Dorixona',
  'businessTypes.type.FLORIST': 'Gul do‘koni',
  'nav.dunning': 'Qarzdorlik',
  ...
  'tenants.column.country': 'Mamlakat',
  'tenants.column.businessType': 'Biznes turi',
  'tenants.column.plan': 'Tarif',
  'tenants.column.health': 'Ochiq muammolar',
  'tenants.health.problems': '{count} kutmoqda',
  'tenants.health.clear': 'yo‘q',
  ...
  'onboarding.invitation.state.ACCEPTED': 'Qabul qilindi',
  'onboarding.invitation.state.NOT_NEEDED': 'Kerak emas',
  'onboarding.invitation.state.FAILED': 'Yetkazilmadi',
  'onboarding.invitation.state.EXPIRED': 'Havola muddati tugagan',
  'onboarding.invitation.queuedAt': 'Navbatga qo‘yildi',
  'onboarding.invitation.sentAt': 'Yuborildi',
  'onboarding.invitation.openedAt': 'Ochildi',
  'onboarding.invitation.acceptedAt': 'Hisob sozlandi',
  ...
  'alertsIncidents.class.COMMERCIAL_ARREARS_REVIEW': 'Mijoz juda uzoq to‘lamayapti',
  ...
  'entitlements.subscription.depositDue': 'To‘lanmagan faollashtirish depoziti',
  ...
  'referenceData.holiday.save': 'Qo‘shish',
  ...
  'planCatalog.termsLine.trial': '{days} kunlik sinov',
  'planCatalog.termsLine.deposit': '{amount} depozit',
  'planCatalog.termsLine.discount': '{months} oy −{percent}%',
  ...
  'moduleCatalog.draft.code': 'Kod',
  'moduleCatalog.draft.codeHint': 'Kichik harflar, raqamlar, - va _.',
  'moduleCatalog.draft.name': 'Nomi',
  'moduleCatalog.draft.unit': 'To‘lov birligi',
  'moduleCatalog.draft.price': 'Birlik narxi',
  'moduleCatalog.draft.description': 'Narxlar ro‘yxati uchun tavsif',
  'moduleCatalog.draft.features': 'Qaysi funksiyalarni yoqadi',
  'moduleCatalog.draft.featuresHint': 'Faqat funksiyalar: modul hech qachon limitni oshirmaydi.',
  'moduleCatalog.draft.submit': 'Qoralamani saqlash',
  'moduleCatalog.draft.done': 'Modul qoralamasi saqlandi. Uni sotuvga boshqa kishi chiqaradi.',
  'moduleCatalog.unit.PER_TENANT': 'Mijoz uchun',
  'moduleCatalog.unit.PER_BRAND': 'Brend uchun',
  'moduleCatalog.unit.PER_LOCATION': 'Filial uchun',
  'moduleCatalog.unit.PER_UNIT': 'Dona uchun',
  'moduleCatalog.unit.ONE_OFF': 'Bir martalik',
  'moduleCatalog.column.module': 'Modul',
  'moduleCatalog.column.unit': 'Birlik',
  'moduleCatalog.column.price': 'Narx',
  'moduleCatalog.column.features': 'Yoqadi',
  'moduleCatalog.column.status': 'Holat',
  'moduleCatalog.draftedBy': 'tuzgan: {who}',
  'moduleCatalog.activate.notYours': 'Qoralamangizni sotuvga boshqa kishi chiqaradi',
  'moduleCatalog.activate.open': 'Sotuvga chiqarish',
  'moduleCatalog.activate.submit': 'Butunlay sotuvga chiqarish',
  'moduleCatalog.activate.done': '{code} sotuvda.',
  'moduleCatalog.retire.open': 'Sotuvdan olish',
  'moduleCatalog.retire.submit': 'Sotuvdan olish',
  'moduleCatalog.retire.done': '{code} endi sotilmaydi. Unga ega mijozlarda qoladi.',
  'moduleCatalog.tenant.title': 'Mijoz modullari',
  'moduleCatalog.tenant.none': 'Bu mijozda modullar yo‘q.',
  'moduleCatalog.tenant.since': '{from} dan',
  'moduleCatalog.tenant.endedOn': '{from} – {to}',
  'moduleCatalog.tenant.end': 'O‘chirish',
  'moduleCatalog.tenant.ended': '{code} bu mijozda o‘chirildi.',
  'moduleCatalog.tenant.choose': 'Modulni tanlang',
  ...
  'statements.column.charge': 'Hisoblash',
  'statements.column.quantity': 'Soni',
  'statements.column.unitPrice': 'Narx',
  'statements.column.amount': 'Summa',
  'statements.column.number': 'Raqam',
  'statements.column.status': 'Holat',
  'statements.total': 'Jami',
  'statements.beforeTax': 'Soliqsiz. To‘lov va soliq HorecaOS’dan tashqarida rasmiylashtiriladi.',
  'statements.kind.PLAN': 'Tarif',
  'statements.kind.MODULE': 'Modul',
  'statements.kind.OVERAGE': 'Tarifdan ortiq',
  'statements.kind.DEPOSIT': 'Depozit',
  'statements.kind.EARLY_EXIT': 'Muddatdan oldin chiqish',
  'statements.status.DRAFT': 'Oldindan ko‘rish',
  ...
  'statements.issued.none': 'Bu mijozga hali hisob chiqarilmagan.',
  'statements.export': 'CSV yuklab olish',
  ...
  'statements.column.due': 'To‘lanishi kerak',
  'wallet.title': 'Hamyon',
  'wallet.lead': 'To‘langan pul va sovg‘a pul — alohida.',
  ...
  'wallet.approvals.link': 'Tasdiqlashlar',
  'wallet.approvedBy': '{approver} tasdiqlagan',
  'wallet.grants.title': 'Amaldagi bonuslar',
  'wallet.column.granted': 'Berilgan',
  'wallet.column.remaining': 'Qolgan',
  ...
  'wallet.entry.STATEMENT_PAYMENT': 'Hisob to‘landi',
  'wallet.entry.STATEMENT_REVERSAL': 'Hisob bekor qilindi, qaytarildi',
  'wallet.entry.ADJUSTMENT': 'Tuzatish',
  'wallet.entry.REFUND': 'Qaytarish',
  'wallet.entry.DEPOSIT_REVERSAL': 'Depozit qaytarildi',
  'platformApprovals.action.commercial_wallet_adjustment': 'Hamyon tuzatishi',
  'platformApprovals.action.commercial_wallet_bonus-grant': 'Bonus berish',
  'platformApprovals.action.commercial_wallet_refund': 'To‘langan pulni qaytarish',
  ...
  'dunning.column.lastStatement': 'Oxirgi hisob',
  'dunning.days': '{days} kun, {since} dan',
  'dunning.moveTo': 'O‘tkazish: {status}',
  'dunning.suspensionReason': 'To‘xtatish sababi',
  'dunning.confirm': 'Tasdiqlash',
  'dunning.moved': '{tenant}: endi {status}.',
  'planCatalog.you': 'siz',
