...
export const ru: Messages = {
  ...
  'entitlements.subscription.depositDue': 'Активационный депозит к оплате',
  ...
  'statements.column.due': 'К оплате',
  'wallet.title': 'Кошелёк',
  'wallet.lead': 'Оплаченные деньги и бонусные — по отдельности.',
  'wallet.paid': 'Оплаченный баланс',
  'wallet.paid.hint': 'Деньги, которые клиент заплатил HorecaOS. Не сгорают и могут быть возвращены.',
  'wallet.bonus': 'Бонусный баланс',
  'wallet.bonus.hint': 'Деньги, подаренные HorecaOS, и то, что счёт может взять прямо сейчас. Тратятся раньше оплаченных, сгорают в срок каждого начисления, не возвращаются.',
  'wallet.bonus.inLedger': 'В журнале — {amount}: начисление с прошедшим сроком считается там, пока обход не запишет, что оно сгорело.',
  'wallet.method': 'Способ оплаты',
  'wallet.method.hint': 'Чем гасится остаток счёта после того, как из кошелька взято всё, что в нём есть.',
  'wallet.method.INVOICE': 'Счёт и банковский перевод',
  'wallet.method.WALLET': 'Предоплаченный кошелёк',
  'wallet.method.CARD': 'Карта',
  'wallet.method.change': 'Изменить способ оплаты',
  'wallet.method.note': 'Записывается с причиной и в журнал аудита. Токен карты — это ссылка у провайдера; номер карты здесь не хранится никогда.',
  'wallet.method.submit': 'Изменить',
  'wallet.method.done': 'Теперь способ оплаты — {method}.',
  'wallet.card.notConnected': 'Списание с карты не подключено: у HorecaOS пока нет своего мерчант-аккаунта, поэтому остаток такого клиента остаётся к оплате так же, как по счёту.',
  'wallet.transfer.open': 'Записать банковский перевод',
  'wallet.transfer.note': 'Действие одного человека под аудитом, как выпуск счёта. Подтверждение — банковская ссылка. Перевод сразу гасит самый старый открытый счёт.',
  'wallet.transfer.submit': 'Записать перевод',
  'wallet.transfer.done': 'Перевод записан.',
  'wallet.deposit.open': 'Записать активационный депозит',
  'wallet.deposit.note': 'Гасит ровно тот депозит, который должна действующая подписка. Первый счёт затем оплачивается из него.',
  'wallet.deposit.submit': 'Записать депозит',
  'wallet.deposit.done': 'Активационный депозит записан.',
  'wallet.adjustment.open': 'Предложить корректировку',
  'wallet.adjustment.note': 'Любой вид денег, в плюс или в минус. Корректировка бонусов указывает начисление, которое правит; ни один баланс не может уйти ниже нуля.',
  'wallet.adjustment.noGrant': 'У этого клиента нет действующего бонусного начисления.',
  'wallet.adjustment.submit': 'Предложить корректировку',
  'wallet.grant.open': 'Предложить бонус',
  'wallet.grant.note': 'Бонус сгорает в указанную дату и тратится раньше оплаченных денег.',
  'wallet.grant.submit': 'Предложить бонус',
  'wallet.refund.open': 'Предложить возврат',
  'wallet.refund.note': 'Только оплаченные деньги, с указанием выплаты. Бонус не возвращается — он сгорает.',
  'wallet.refund.submit': 'Предложить возврат',
  'wallet.field.amount': 'Сумма',
  'wallet.field.signedAmount': 'Сумма, со знаком минус — чтобы убрать',
  ...
  'wallet.change.awaiting': 'Ждёт второй подписи. Ничего не изменилось; предложите то же самое ещё раз, когда кто-то другой одобрит.',
  'wallet.change.declined': 'Изменение отклонено. Ничего не изменилось.',
  'wallet.change.done': 'Изменение записано в журнал кошелька.',
  'wallet.approvals.note': 'Корректировка, бонус и возврат требуют второго человека.',
  'wallet.approvals.link': 'Согласования',
  'wallet.approvedBy': 'одобрил {approver}',
  'wallet.grants.title': 'Действующие бонусы',
  'wallet.column.granted': 'Начислено',
  'wallet.column.remaining': 'Осталось',
  'wallet.column.lapses': 'Сгорает',
  'wallet.ledger.title': 'Журнал',
  'wallet.ledger.none': 'В этом кошельке пока ничего не двигалось.',
  'wallet.ledger.appendOnly': 'Каждая запись пишется один раз. Здесь ничего не правят и не удаляют, а баланс выше — сумма этих записей.',
  'wallet.ledger.appendOnlyTruncated': 'Каждая запись пишется один раз. Здесь ничего не правят и не удаляют. Это последние {count} записей более длинного журнала, поэтому баланс выше — сумма всего журнала, а не показанных строк.',
  'wallet.column.when': 'Когда',
  ...
  'wallet.entry.STATEMENT_PAYMENT': 'Оплата счёта',
  'wallet.entry.STATEMENT_REVERSAL': 'Счёт аннулирован, возврат в кошелёк',
  'wallet.entry.ADJUSTMENT': 'Корректировка',
  'wallet.entry.REFUND': 'Возврат',
  'wallet.entry.DEPOSIT_REVERSAL': 'Депозит возвращён',
  'platformApprovals.action.commercial_wallet_adjustment': 'Корректировка кошелька',
  'platformApprovals.action.commercial_wallet_bonus-grant': 'Начисление бонуса',
  'platformApprovals.action.commercial_wallet_refund': 'Возврат оплаченных денег',
