...
export const ru: Messages = {
  ...
  'platformApprovals.lead': 'Решения платформы, ожидающие второй подписи, у любых клиентов: смена страны клиента, активация клиента, если её требует политика, и изменения кошелька, которые HorecaOS предлагает по счёту клиента — корректировка, начисление бонуса, возврат оплаченных денег или возврат ошибочно записанного депозита. Строка с пометкой «Собственное решение HorecaOS» выводит деньги из кошелька этого клиента; своего клиента она не называет, потому что клиент её не читает и не подписывает, — счёт и сумма указаны в самой строке.',
