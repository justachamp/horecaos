...
export const en = {
  ...
  'nav.tenants': 'Tenants',
  'nav.ownerInvitations': 'Owner invitations',
  ...
  // IA 2.9 Owner invitations -- onboarding's last mile across every tenant (ADR 0100).
  'ownerInvitations.title': 'Owner invitations',
  'ownerInvitations.lead':
    'Every tenant whose owner has not set up an account yet, and what was sent to them. A tenant linked to an owner before invitations existed shows as never invited.',
  'ownerInvitations.loading': 'Loading invitations…',
  'ownerInvitations.empty': 'No tenant matches this filter.',
  'ownerInvitations.outstanding': '{count} still waiting on an owner.',
  'ownerInvitations.resent': 'Sent again.',
  'ownerInvitations.cancel': 'Cancel',
  'ownerInvitations.filter.OUTSTANDING': 'Still waiting',
  'ownerInvitations.filter.ALL': 'All',
  'ownerInvitations.filter.NONE': 'Never invited',
  'ownerInvitations.filter.FAILED': 'Not delivered',
  'ownerInvitations.filter.EXPIRED': 'Link expired',
  'ownerInvitations.filter.QUEUED': 'Waiting to be sent',
  'ownerInvitations.filter.SENT': 'Sent',
  'ownerInvitations.filter.ACCEPTED': 'Accepted',
  'ownerInvitations.state.NONE': 'Never invited',
  'ownerInvitations.column.tenant': 'Tenant',
  'ownerInvitations.column.recipient': 'Sent to',
  'ownerInvitations.column.state': 'State',
  'ownerInvitations.column.sentAt': 'Sent',
  'ownerInvitations.column.openedAt': 'Opened',
  ...
  'onboarding.invitation.attempt': 'attempt {number}',
  'onboarding.invitation.event.QUEUED': 'Queued',
  'onboarding.invitation.event.RESENT': 'Sent again',
  'onboarding.invitation.event.SENT': 'Emailed',
  'onboarding.invitation.event.SEND_DEFERRED': 'Delivery deferred',
  'onboarding.invitation.event.SEND_FAILED': 'Delivery given up',
  'onboarding.invitation.event.OPENED': 'Link opened',
  'onboarding.invitation.event.ACCEPTED': 'Account set up',
  'onboarding.invitation.event.NOT_NEEDED': 'Already had a password',
  'onboarding.invitation.actor.SYSTEM_JOB': 'the platform',
  'onboarding.invitation.actor.USER': 'operator',
  'onboarding.invitation.actor.OWNER': 'the owner',
