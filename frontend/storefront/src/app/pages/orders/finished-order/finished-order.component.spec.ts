...
function setUp() {
  ...
  TestBed.configureTestingModule({
    imports: [FinishedOrderComponent],
    providers: [
      provideRouter([]),
  ...
  const fixture = TestBed.createComponent(FinishedOrderComponent);
  return { fixture, comp: fixture.componentInstance, ordersService };
}

describe('FinishedOrderComponent: never fabricates an item count or distance', () => {
